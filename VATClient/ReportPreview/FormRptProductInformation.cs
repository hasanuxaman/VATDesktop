...
{
    public partial class FormRptProductInformation : Form
    {
        public FormRptProductInformation()
        {
            InitializeComponent();       
        ...
        private void FormRptProductInformation_Load(object sender, EventArgs e)
        {
        ...
        private void backgroundWorkerPreview_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                ...
                ProductReport _report = new ProductReport();
                reportDocument = _report.ProductNew(txtItemNo.Text.Trim(), txtPGroupId.Text.Trim(), cmbProductTypeText,connVM);
                //ReportResult = new DataSet();

                //ReportDSDAL reportDsdal = new ReportDSDAL();
                //ReportResult = reportDsdal.ProductNew(txtItemNo.Text.Trim(), txtPGroupId.Text.Trim(), cmbProductTypeText);
                #endregion
            }
            #endregion
        ...
        private void backgroundWorkerPreview_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            try
            {
                ...
                //reportDocument.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.Excel, @"D:\test1.xls");
