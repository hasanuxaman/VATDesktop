...
{
    public class AdjustmentHistoryDAL : IAdjustmentHistory
    {
        ...
        , decimal AdjInputAmount, decimal AdjInputPercent, string AdjReferance, string Post, string AdjHistoryNo, SysDBInfoVMTemp connVM = null)
        {
            ...
            retResults[0] = "Fail";
            retResults[1] = "Fail";
            retResults[2] = AdjHistoryID;
            retResults[3] = AdjHistoryNo;
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(AdjHistoryID))
                {
                ...
                cmdIdExist.Parameters.AddWithValue("@AdjHistoryID", AdjHistoryID);
                ...
                cmdUpdate.Parameters.AddWithValue("@LastModifiedBy", LastModifiedBy);
                cmdUpdate.Parameters.AddWithValue("@LastModifiedOn", LastModifiedOn);
                cmdUpdate.Parameters.AddWithValue("@AdjHistoryID", AdjHistoryID);
                ...
                cmdIPS.Parameters.AddWithValue("@AdjHistoryNo", AdjHistoryNo);
            ...
            catch (SqlException sqlex)
            {
                ...
                FileLogger.Log("AdjustmentHistoryDAL", "PostAdjustmentHistory", sqlex.ToString() + "\n" + sqlText);
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("AdjustmentHistoryDAL", "PostAdjustmentHistory", ex.ToString() + "\n" + sqlText);
        ...
        //
        public DataTable SearchAdjustmentHistory(string AdjHistoryNo, string AdjReferance, string AdjType, string Post, string AdjFromDate, string AdjToDate, int BranchId = 0, SysDBInfoVMTemp connVM = null)
        {
            #region Objects & Variables
...
,isnull(ah.AdjInputPercent,0)AdjInputPercent
,ah.Post
,isnull(ah.BranchId, 0) BranchId
,isnull(ah.IsAdjSD, 'N') IsAdjSD
...
and ah.AdjType not in ('Cash Payable')
                ...
                if (BranchId > 0)
                {
                    sqlText = sqlText + @" and ah.BranchId = @BranchId";
                }
                ...
                if (BranchId > 0)
                {
                    objCommProductType.Parameters.AddWithValue("@BranchId", BranchId);
                }
            ...
            {
                FileLogger.Log("AdjustmentHistoryDAL", "SearchAdjustmentHistory", sqlex.ToString() + "\n" + sqlText);
            ...
            {
                FileLogger.Log("AdjustmentHistoryDAL", "SearchAdjustmentHistory", ex.ToString() + "\n" + sqlText);
...
WHERE 	(ah.AdjHistoryNo= @AdjHistoryNo)	";
            ...
            {
                FileLogger.Log("AdjustmentHistoryDAL", "SearchAdjustmentHistoryForDeposit", sqlex.ToString() + "\n" + sqlText);
            ...
            {
                FileLogger.Log("AdjustmentHistoryDAL", "SearchAdjustmentHistoryForDeposit", ex.ToString() + "\n" + sqlText);
        ...
        public string[] InsertAdjustmentHistory(AdjustmentHistoryVM vm, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                newID = commonDal.TransactionCode("Adjustment", "Both", "AdjustmentHistorys", "AdjHistoryNo",
                                              "AdjDate", vm.AdjDate, vm.BranchId.ToString(), currConn, transaction);
                ...
                cmdInsert.Parameters.AddWithValue("@AdjHistoryID", vm.AdjHistoryID);
                cmdInsert.Parameters.AddWithValue("@AdjId", vm.AdjId ?? Convert.DBNull);
                cmdInsert.Parameters.AddWithValue("@AdjDate", OrdinaryVATDesktop.DateToDate(vm.AdjDate));
                ...
                cmdInsert.Parameters.AddWithValue("@IsAdjSD", vm.IsAdjSD);
...
WHERE AdjHistoryID = @AdjHistoryID

";

                SqlCommand cmdUpdate = new SqlCommand(sqlText, currConn, transaction);
                cmdUpdate.Parameters.AddWithValue("@AdjHistoryID", vm.AdjHistoryID);
            ...
            catch (SqlException sqlex)
            {
                ...
                FileLogger.Log("AdjustmentHistoryDAL", "InsertAdjustmentHistory", sqlex.ToString() + "\n" + sqlText);
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("AdjustmentHistoryDAL", "InsertAdjustmentHistory", ex.ToString() + "\n" + sqlText);
        ...
        public string[] UpdateAdjustmentHistory(AdjustmentHistoryVM vm, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                cmdNameExist.Transaction = transaction;
                cmdNameExist.Parameters.AddWithValue("@AdjId", vm.AdjId);
                cmdNameExist.Parameters.AddWithValue("@AdjDate", OrdinaryVATDesktop.DateToDate(vm.AdjDate));
                cmdNameExist.Parameters.AddWithValue("@AdjType", vm.AdjType);
                ...
                cmdUpdate.Parameters.AddWithValue("@IsAdjSD", vm.IsAdjSD ?? Convert.DBNull);
...
";
            ...
            catch (SqlException sqlex)
            {
                ...
                FileLogger.Log("AdjustmentHistoryDAL", "UpdateAdjustmentHistory", sqlex.ToString() + "\n" + sqlText);
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("AdjustmentHistoryDAL", "UpdateAdjustmentHistory", ex.ToString() + "\n" + sqlText);
        ...
        public string[] PostAdjustmentHistory(AdjustmentHistoryVM vm, SysDBInfoVMTemp connVM = null)
        {
            #region Objects & Variables
...
";
                ...
                while (dr.Read())
                {
                    ...
                    vm.IsAdjSD = dr["IsAdjSD"].ToString();
            ...
            {
                FileLogger.Log("AdjustmentHistoryDAL", "SelectAll", sqlex.ToString() + "\n" + sqlText);
            ...
            {
                FileLogger.Log("AdjustmentHistoryDAL", "SelectAll", ex.ToString() + "\n" + sqlText);
...
";
            ...
            {
                FileLogger.Log("AdjustmentHistoryDAL", "SelectAllCashPayable", sqlex.ToString() + "\n" + sqlText);
            ...
            {
                FileLogger.Log("AdjustmentHistoryDAL", "SelectAllCashPayable", ex.ToString() + "\n" + sqlText);
