...
namespace VATClient
{
    public partial class FormIssueImportSQR : Form
    {
        #region Variables
        ...
        {
            FormIssueImportSQR form = new FormIssueImportSQR();


            form.preSelectTable = "Issue";
            ...
            else
            {
                try
                {
                    ...
                    if (branchCode != "UEN")
                    {
                        ...
                        dtTableResult = importDal.GetIssueSQRData(param);
                    }
                    else
                    {
                        dtTableResult = importDal.GetRupshiIssueSQRData(param);
                    }
        ...
        private void bgwBigData_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                sqlResults = IssueDAL.SaveToTempIssue(issueData, transactionType, Program.CurrentUserID, Program.BranchId, () => { }, null, null, connVM);
