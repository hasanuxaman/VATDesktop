...
namespace VATServer.Library
{
    public class VAT7DAL
    {
        ...
        public DataTable SearchVat7HeaderDT(string Vat7No, string VAT7DateFrom, string VAT7DateTo, string Post, SysDBInfoVMTemp connVM = null)
        {
            #region Variables
        ...
        public DataTable SearchVat7DetailDT(string Vat7No, SysDBInfoVMTemp connVM = null)
        {
            #region Variables
      ...
      ,isnull(VAT7.UOMn,'N/A') UOMn
       ...
       WHERE (Vat7No = @Vat7No ) 
        ...
        #region web methods
        public List<VAT7VM> SelectAll(string Id = null, string[] conditionFields = null, string[] conditionValues = null, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, SysDBInfoVMTemp connVM = null)
        {
            #region Variables
            SqlConnection currConn = null;
...
";
        ...
        public string[] Vat7Insert(VAT7VM Master, List<VAT7VM> Details, SysDBInfoVMTemp connVM = null)
        {
            #region Initializ
            ...
            try
            {
             ...
             currConn = _dbsqlConnection.GetConnection(connVM);
                ...
                newID = commonDal.TransactionCode("VAT7", "VAT7", "VAT7", "VAT7No", "Vat7Date", Master.Vat7DateTime, Master.BranchId.ToString(), currConn, transaction);
                ...
                foreach (var Item in Details.ToList())
                {
                    #region Find Transaction Exist
                    sqlText = "";
                    sqlText += "select COUNT(VAT7No) from VAT7 WHERE VAT7No='" + newID + "' ";
                    ...
                    cmdInsDetail.Parameters.AddWithValueAndNullHandle("@MasterVat7DateTime", Master.Vat7DateTime);
                    cmdInsDetail.Parameters.AddWithValueAndNullHandle("@ItemFinishItemNo", Item.FinishItemNo);
                    cmdInsDetail.Parameters.AddWithValueAndNullHandle("@ItemFinishUOM", Item.FinishUOM);
                    cmdInsDetail.Parameters.AddWithValueAndNullHandle("@ItemVat7LineNo", Item.Vat7LineNo);
                    cmdInsDetail.Parameters.AddWithValueAndNullHandle("@ItemItemNo", Item.ItemNo);
                    cmdInsDetail.Parameters.AddWithValueAndNullHandle("@ItemItemUOM", Item.ItemUOM);
        ...
        public string[] Vat7update(VAT7VM Master, List<VAT7VM> Details, SysDBInfoVMTemp connVM = null)
        {
            #region Initializ
            string[] retResults = new string[4];
            retResults[0] = "Fail";
            ...
            try
            {
             ...
             currConn = _dbsqlConnection.GetConnection(connVM);
                ...
                cmdFindIdUpd.Parameters.AddWithValueAndNullHandle("@MasterVAT7No", Master.VAT7No);
                ...
                foreach (var Item in Details.ToList())
                {
                    ...
                    SqlCommand cmdFindId = new SqlCommand(sqlText, currConn);
                    cmdFindId.Transaction = transaction;
                    cmdFindId.Parameters.AddWithValueAndNullHandle("@MasterVAT7No", Master.VAT7No);
                    cmdFindId.Parameters.AddWithValueAndNullHandle("@ItemFinishItemNo", Item.FinishItemNo);
                    ...
                    if (IDExist <= 0)
                    {
                        ...
                        cmdInsDetail.Parameters.AddWithValueAndNullHandle("@MasterVAT7No", Master.VAT7No);
                        cmdInsDetail.Parameters.AddWithValueAndNullHandle("@MasterVat7DateTime", Master.Vat7DateTime);
                        cmdInsDetail.Parameters.AddWithValueAndNullHandle("@ItemFinishItemNo", Item.FinishItemNo);
                        cmdInsDetail.Parameters.AddWithValueAndNullHandle("@ItemFinishUOM", Item.FinishUOM);
                        cmdInsDetail.Parameters.AddWithValueAndNullHandle("@ItemVat7LineNo", Item.Vat7LineNo);
                ...
                foreach (DataRow pItem in dt.Rows)
                {
                    ...
                    if (itemCount == 0)
                    {
                        ...
                        cmdInsDetail.Parameters.AddWithValueAndNullHandle("@MasterVAT7No", Master.VAT7No);
                        cmdInsDetail.Parameters.AddWithValueAndNullHandle("@fItemNo", fItemNo);
        ...
        public string[] VAT7Post(VAT7VM Master, List<VAT7VM> Details, SysDBInfoVMTemp connVM = null)
        {
            #region Initializ
            string[] retResults = new string[4];
            retResults[0] = "Fail";
             ...
             currConn = _dbsqlConnection.GetConnection(connVM);
                ...
                foreach (var Item in Details.ToList())
                {
                    ...
                    else
                    {
                        ...
                        cmdInsDetail.Parameters.AddWithValue("@MasterVAT7No", Master.VAT7No);
                        cmdInsDetail.Parameters.AddWithValue("@ItemFinishItemNo", Item.FinishItemNo);
