...
namespace VATClient
{
    public partial class FormSaleImportLink3 : Form
    {
        #region Variables
        ...
        {
            FormSaleImportLink3 form = new FormSaleImportLink3();
            ...
            try
            {
                ...
                for (var index = 0; index < loopCounter; index++)
                {
                    try
                    {
                        ...
                        DataTable dtsale = GetTableFromXML(file);

                        #region Sales Middleware
                        ...
                        if (dtsale != null && dtsale.Rows.Count > 0)
                        {
                            try
                            {
                                ...
                                dtBulk = dtsale.Copy();
                                var column = new DataColumn("ProcessTime") { DefaultValue = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") };
                                dtBulk.Columns.Add(column);

                                CommonDAL commonDal = new CommonDAL();
                                commonDal.BulkInsert("SalesMiddleware", dtBulk, null, null, 0, null, connVM);

                            }
                            catch (Exception e)
                            {
                                FileLogger.Log("FormSaleImportLink3", "Sales Middleware Bulk Insert", fileName + "\n" + e.Message + "\n" + e.StackTrace);
                        ...
                        dtsale = OrdinaryVATDesktop.FormatSaleData(dtsale);

                        TableValidation(dtsale);

                        SaleDAL saleDal = new SaleDAL();


                        dtsale.Columns.Add(new DataColumn() { ColumnName = "OtherRef", DefaultValue = fileName });
                        saleDal.SaveAndProcess(dtsale, () => { }, Program.BranchId);
                    ...
                    catch (Exception e)
                    {
                        ...
                        FileLogger.Log("FormSaleImportLink3", "Getfiles", fileName + "\n" + e.Message + "\n" + e.StackTrace);
                    }
                }
        ...
        private async void MoveFile(string sourceFile, string destinationFile)
        {
            ...
            {
                FileLogger.Log("FormSaleImportLink3", "Getfiles", e.Message + "\n" + e.StackTrace);
        ...
        private void UpdateOtherDB(DataTable salesData)
        {
            if (sqlResults[0].ToLower() == "success" && selectedType == CONST_DATABASE)
            {
                ...
                if (results[0].ToLower() != "success")
                {
                    ...
                    FileLogger.Log("FormSaleImportLink3", "UpdateOtherDB", message);
        ...
        private void btnBulk_Click(object sender, EventArgs e)
        {
            ...
            //timer.Elapsed += GetFiles(rootPath);
            //timer.Enabled = true;
            try
            {
                ...
                //ibsWatcher = new FileSystemWatcher(rootPath);
                ...
                rootPath = @"D:\SharePath\FromMIS";


                Directory.CreateDirectory(Directory.GetParent(rootPath).FullName + "\\Hold");
                Directory.CreateDirectory(Directory.GetParent(rootPath).FullName + "\\Debug");
                Directory.CreateDirectory(Directory.GetParent(rootPath).FullName + "\\Posted");
                Directory.CreateDirectory(Directory.GetParent(rootPath).FullName + "\\Skipped");
        ...
        {
            FormSaleImportDHL form = new FormSaleImportDHL();
        ...
        {
            RptVAT6_3_DHL2_V12V2 objrpt = null;
            ReportDocument RptVAT6_7_V12V2 = null;
            ReportDocument RptVAT6_8_V12V2 = null;
            ...
            try
            {
                ...
                RptVAT6_7_V12V2 = new RptVAT6_7_V12V2();

                RptVAT6_7_V12V2.DataDefinition.FormulaFields["CompanyName"].Text =
                    "'" + OrdinaryVATDesktop.CompanyName + "'";
                RptVAT6_7_V12V2.DataDefinition.FormulaFields["Address1"].Text = "'" + OrdinaryVATDesktop.Address1 + "'";
                RptVAT6_7_V12V2.DataDefinition.FormulaFields["Address2"].Text = "'" + OrdinaryVATDesktop.Address2 + "'";
                RptVAT6_7_V12V2.DataDefinition.FormulaFields["Address3"].Text = "'" + OrdinaryVATDesktop.Address3 + "'";
                RptVAT6_7_V12V2.DataDefinition.FormulaFields["TelephoneNo"].Text =
                    "'" + OrdinaryVATDesktop.TelephoneNo + "'";
                RptVAT6_7_V12V2.DataDefinition.FormulaFields["FaxNo"].Text = "'" + OrdinaryVATDesktop.FaxNo + "'";
                RptVAT6_7_V12V2.DataDefinition.FormulaFields["VatRegistrationNo"].Text =
                    "'" + OrdinaryVATDesktop.VatRegistrationNo + "'";
                //FormulaFieldDefinitions crFormulaF;
                FormulaFieldDefinitions crFormulaFCredit = RptVAT6_7_V12V2.DataDefinition.FormulaFields;
                CommonFormMethod _vCommonFormMethodCredit = new CommonFormMethod();
                _vCommonFormMethodCredit.FormulaField(RptVAT6_7_V12V2, crFormulaFCredit, "PrintDate",
                    DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
                _vCommonFormMethodCredit.FormulaField(RptVAT6_7_V12V2, crFormulaFCredit, "InEnglish", VAT6_7English);
                _vCommonFormMethodCredit.FormulaField(RptVAT6_7_V12V2, crFormulaFCredit, "FontSize", FontSize6_7);

                RptVAT6_7_V12V2.DataDefinition.FormulaFields["Trial"].Text = "'" + OrdinaryVATDesktop.Trial + "'";
                RptVAT6_7_V12V2.DataDefinition.FormulaFields["Preview"].Text = "''";

                RptVAT6_8_V12V2 = new RptVAT6_8_V12V2();

                RptVAT6_8_V12V2.DataDefinition.FormulaFields["CompanyName"].Text =
                    "'" + OrdinaryVATDesktop.CompanyName + "'";
                RptVAT6_8_V12V2.DataDefinition.FormulaFields["Address1"].Text = "'" + OrdinaryVATDesktop.Address1 + "'";
                RptVAT6_8_V12V2.DataDefinition.FormulaFields["Address2"].Text = "'" + OrdinaryVATDesktop.Address2 + "'";
                RptVAT6_8_V12V2.DataDefinition.FormulaFields["Address3"].Text = "'" + OrdinaryVATDesktop.Address3 + "'";
                RptVAT6_8_V12V2.DataDefinition.FormulaFields["TelephoneNo"].Text =
                    "'" + OrdinaryVATDesktop.TelephoneNo + "'";
                RptVAT6_8_V12V2.DataDefinition.FormulaFields["FaxNo"].Text = "'" + OrdinaryVATDesktop.FaxNo + "'";
                RptVAT6_8_V12V2.DataDefinition.FormulaFields["VatRegistrationNo"].Text =
                    "'" + OrdinaryVATDesktop.VatRegistrationNo + "'";
                //FormulaFieldDefinitions crFormulaF;
                FormulaFieldDefinitions crFormulaDebit = RptVAT6_8_V12V2.DataDefinition.FormulaFields;
                CommonFormMethod _vCommonFormMethodDebit = new CommonFormMethod();
                _vCommonFormMethodDebit.FormulaField(RptVAT6_8_V12V2, crFormulaDebit, "PrintDate",
                    DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
                _vCommonFormMethodDebit.FormulaField(RptVAT6_8_V12V2, crFormulaDebit, "InEnglish", VAT6_7English);
                _vCommonFormMethodDebit.FormulaField(RptVAT6_8_V12V2, crFormulaDebit, "FontSize", FontSize6_7);

                RptVAT6_8_V12V2.DataDefinition.FormulaFields["Trial"].Text = "'" + OrdinaryVATDesktop.Trial + "'";
                RptVAT6_8_V12V2.DataDefinition.FormulaFields["Preview"].Text = "''";
                ...
                int ibsCounter = dal.GetDHLLoopCounter();
                int iasCounter = dal.GetDHLLoopCounter("IAS");

                FileLogger.Log("PDF", "Gen PDF", ibsCounter + "" + iasCounter);
                ...
                if (ibsCounter > 0)
                {
                    string source = "IBS";
                    string PdfFlag = "N";
                    dtSales = IBSPdfGeneration(fileDirectory, ibsCounter, reportDsdal, source, PdfFlag, dtSales, branch,
                        _vCommonFormMethod, objrpt, crFormulaF, RptVAT6_7_V12V2, RptVAT6_8_V12V2, pathRoot, dal);
                }
                ...
                else if (iasCounter > 0)
                {

                    string source = "IAS";
                    string PdfFlag = "N";

                    dtSales = IASPDFGeneration(fileDirectory, iasCounter, reportDsdal, source, PdfFlag, dtSales, branch,
                        _vCommonFormMethod, objrpt, crFormulaF, pathRoot, dal);
                }
                ...
                else
                {
                    ...
                    int iasCounterError = dal.GetDHLLoopCounter("IAS", "E");
                    int ibsCounterError = dal.GetDHLLoopCounter("IBS", "E");

                    if (iasCounterError > 0)
                    {

                        string source = "IAS";
                        string PdfFlag = "E";

                        dtSales = IASPDFGeneration(fileDirectory, iasCounterError, reportDsdal, source, PdfFlag, dtSales, branch,
                            _vCommonFormMethod, objrpt, crFormulaF, pathRoot, dal);
                    }
                    else if (ibsCounterError > 0)
                    {
                        string source = "IBS";
                        string PdfFlag = "E";
                        dtSales = IBSPdfGeneration(fileDirectory, ibsCounterError, reportDsdal, source, PdfFlag, dtSales, branch,
                            _vCommonFormMethod, objrpt, crFormulaF, RptVAT6_7_V12V2, RptVAT6_8_V12V2, pathRoot, dal);
                    }
            ...
            finally
            {
                ...
                if (RptVAT6_7_V12V2 != null)
                {
                    RptVAT6_7_V12V2.Close();
                    RptVAT6_7_V12V2.Dispose();
                }


                if (RptVAT6_8_V12V2 != null)
                {
                    RptVAT6_8_V12V2.Close();
                    RptVAT6_8_V12V2.Dispose();
                }
            }
        }
        ...
        private DataTable IBSPdfGeneration(string fileDirectory, int ibsCounter, ReportDSDAL reportDsdal, string source,
            string PdfFlag, DataTable dtSales, DataTable branch, CommonFormMethod _vCommonFormMethod,
            RptVAT6_3_DHL2_V12V2 objrpt, FormulaFieldDefinitions crFormulaF, ReportDocument RptVAT6_7_V12V2,
            ReportDocument RptVAT6_8_V12V2, string pathRoot, ImportDAL dal)
        {
            DataTable result;
            DataTable tempBranch;
            DataTable tempResult;
            ...
            for (int i = 0; i < ibsCounter; i++)
            {
                ...
                foreach (DataRow dtSalesRow in dtSales.Rows)
                {
                    ...
                    else if (dtSalesRow["TransactionType"].ToString().ToLower() == "credit")
                    {
                        // group by 

                        tempResult = CNDNGroupBy(tempResult);

                        RptVAT6_7_V12V2.SetDataSource(tempResult);
                        ...
                        ExportPDf(RptVAT6_7_V12V2, fileDirectory, fileName);
                    }
                    else if (dtSalesRow["TransactionType"].ToString().ToLower() == "debit")
                    {
                        // group by 

                        tempResult = CNDNGroupBy(tempResult);

                        RptVAT6_8_V12V2.SetDataSource(tempResult);

                        string fileName = tempResult.Rows[0]["FileName"].ToString();
                        fileName = fileName.Replace("@gendate", DateTime.Now.ToString("yyyyMMdd"))
                            .Replace("@gentime", DateTime.Now.ToString("hhmmss"));

                        ExportPDf(RptVAT6_8_V12V2, fileDirectory, fileName);
                    }
                }

                // movie to IBS folder
                //MoveToFolder(fileDirectory, pathRoot + "\\6.3 Files\\" + "IBS");
                MoveToFolder(fileDirectory, "D:\\invoice");
                //MoveToFolder(pathRoot + "\\6.3 Files\\" + "IBS", "D:\\invoice");
        ...
        {
            string path = "";
            path = chkIBS.Checked ? rootPath : iasPath;
            ...
            try
            {
                ...
                for (var index = 0; index < files.Length; index++)
                {
                                ...
                                using (ZipArchive archive = new ZipArchive(zipFile))
                                {
                                    ...
                                    using (MemoryStream memory = new MemoryStream())
                                    {
                                        ...
                                        foreach (string id in ids)
                                        {
                                            if (xml.Contains(id))
                                            {
                                                FileLogger.Log("FormSaleImportLink3", "Getfiles", name + "---" + id + "\n");
                                                foundCount++;
                                            }
                                        }
                    ...
                    catch (Exception ex)
                    {
                        ...
                        FileLogger.Log("FormSaleImportLink3", "Getfiles", ex.Message + "\n" + ex.StackTrace);
                    }
                }
        ...
        private void SaveAirport()
        {
            ...
            if (salesData != null && salesData.Rows.Count != 0)
            {
                ...
                sqlResults = salesDal.SaveAndProcess(salesData, () => { }, Program.BranchId, "", connVM, param, null, null, Program.CurrentUserID);
        ...
        private void bgwAirport_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            if (e.Error != null)
            {
                FileLogger.Log(e.ToString(), "CheckfilesIAS", DateTime.Now.ToString());
