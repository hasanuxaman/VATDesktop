...
namespace SymphonySofttech.Reports.Report {
    ...
    public class RptStockMovement4 : ReportClass {
        
        public RptStockMovement4() {
        }
        
        public override string ResourceName {
            get {
                return "RptStockMovement4.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymphonySofttech.Reports.Report.RptStockMovement4.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptStockMovement4 : Component, ICachedReport {
        
        public CachedRptStockMovement4() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptStockMovement4 rpt = new RptStockMovement4();
            rpt.Site = this.Site;
            return rpt;
        }
