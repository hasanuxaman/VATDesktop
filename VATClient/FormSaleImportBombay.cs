...
namespace VATClient
{
    public partial class FormSaleImportBombay : Form
    {
        #region Variables
        ...
        private const string CONST_CSV = "CSV";
        ...
        private string BombayPath;
        private bool isProcessRunning;
        private string result;

        #endregion

        public FormSaleImportBombay()
        {
            InitializeComponent();
        ...
        {
            FormSaleImportBombay form = new FormSaleImportBombay();
        ...
        private void typeLoad()
        {
            ...
            cmbImportType.Items.Add(CONST_CSV);
        ...
        private void LoadDataGrid()
        {
            try
            {
                ...
                else if (selectedType == CONST_CSV)
                {
                    ds = LoadFromCSV();
                    FormatBombayTable();
        ...
        private void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    //if (chkOldDb.Checked)
                    //{
                    //    dtTableResult = importDal.GetSaleCDNData(txtId.Text.Trim(), cmbDBList.Text.Trim('[', ']'));
                    //    loadedTable = CONST_SALETYPE;
                    //    dgvLoadedTable.DataSource = dtTableResult;
                    ...
                    dtTableResult = importDal.GetSaleOtherDbData(txtId.Text.Trim(), connVM);
                    dgvLoadedTable.DataSource = dtTableResult;
        ...
        //private void FormatBombayTable()
        //{
        //    #region try
        //    try
        //    {
        //        dtTableResult = ds.Tables[0];
        //        //  dtTableResult = OrdinaryVATDesktop.DtDateCheck(dtTableResult, new string[] { "Delivery_Date_Time", "Invoice_Date_Time" });

        //        dtTableResult = OrdinaryVATDesktop.DtColumnNameChange(dtTableResult, "Customer", "Customer_Code");
        //        dtTableResult = OrdinaryVATDesktop.DtColumnNameChange(dtTableResult, "Invoice No", "ID");
        //        dtTableResult = OrdinaryVATDesktop.DtColumnNameChange(dtTableResult, "Invoice Item", "Item_Name");
        //        dtTableResult = OrdinaryVATDesktop.DtColumnNameChange(dtTableResult, "Site", "Branch_Code");
        //        dtTableResult = OrdinaryVATDesktop.DtColumnNameChange(dtTableResult, "Price Qty", "Quantity");
        //        dtTableResult = OrdinaryVATDesktop.DtColumnNameChange(dtTableResult, "Sales Price", "NBR_Price");
        //        dtTableResult = OrdinaryVATDesktop.DtColumnNameChange(dtTableResult, "Invoice Date", "Invoice_Date");
        //        dtTableResult = OrdinaryVATDesktop.DtColumnNameChange(dtTableResult, "Order No", "Reference_No");
        //        dtTableResult = OrdinaryVATDesktop.DtColumnNameChange(dtTableResult, "Vehicle No", "Vehicle_No");

        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "VehicleType", DefaultValue = "" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Customer_Name", DefaultValue = "-" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Invoice_Time", DefaultValue = DateTime.Now.ToString("HH:mm:ss") });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "UOM", DefaultValue = "" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Item_Code", DefaultValue = "-" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Weight", DefaultValue = "" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "SubTotal", DefaultValue = "0" });
        //        // dtTableResult.Columns.Add(new DataColumn() { ColumnName = "CustomerGroup", DefaultValue = "" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Delivery_Address", DefaultValue = "" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Comments", DefaultValue = "-" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Sale_Type", DefaultValue = "New" });
        //        //dtTableResult.Columns.Add(new DataColumn() { ColumnName = "TransactionType", DefaultValue = "Other" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Is_Print", DefaultValue = "N" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Tender_Id", DefaultValue = "0" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Post", DefaultValue = "N" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "LC_Number", DefaultValue = "0" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Currency_Code", DefaultValue = "BDT" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "SD_Rate", DefaultValue = "0" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "VAT_Rate", DefaultValue = "0" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "VAT_Amount", DefaultValue = "0" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Non_Stock", DefaultValue = "N" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Trading_MarkUp", DefaultValue = "0" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Type", DefaultValue = "" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Discount_Amount", DefaultValue = "0" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Promotional_Quantity", DefaultValue = "0" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "VAT_Name", DefaultValue = "VAT 4.3" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "ProductDescription", DefaultValue = "NA" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Previous_Invoice_No", DefaultValue = "0" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "PreviousInvoiceDateTime", DefaultValue = "1900/01/01 00:00:00" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "PreviousNBRPrice", DefaultValue = "0" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "PreviousQuantity", DefaultValue = "0" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "PreviousSubTotal", DefaultValue = "0" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "PreviousSD", DefaultValue = "0" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "PreviousSDAmount", DefaultValue = "0" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "PreviousVATRate", DefaultValue = "0" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "PreviousVATAmount", DefaultValue = "0" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "PreviousUOM", DefaultValue = "-" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "ReasonOfReturn", DefaultValue = "-" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "ExpDescription", DefaultValue = "-" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "ExpQuantity", DefaultValue = "-" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "ExpGrossWeight", DefaultValue = "-" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "ExpNetWeight", DefaultValue = "-" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "ExpNumberFrom", DefaultValue = "-" });
        //        //   dtTableResult.Columns.Add(new DataColumn() { ColumnName = "ExpNumberFrom", DefaultValue = "-" });
        //        dtTableResult.Columns.Add(new DataColumn() { ColumnName = "ExpNumberTo", DefaultValue = "-" });

        //        dgvLoadedTable.DataSource = dtTableResult;

        //        foreach (DataRow row in dtTableResult.Rows)
        //        {
        //            string vehicleName = row["Vehicle_No"].ToString();

        //            if (vehicleName.ToLower()[0] == 'v')
        //            {
        //                row["VehicleType"] = "Cover Van";
        //            }
        //            else if (vehicleName.ToLower()[0] == 't')
        //            {
        //                row["VehicleType"] = "Truck";
        //            }
        //            else if (vehicleName.ToLower()[0] == 'p')
        //            {
        //                row["VehicleType"] = "Push Cart";
        //            }


        //            row["Vehicle_No"] = vehicleName.TrimStart('V', 'T', 'P', '-');
        ...
        //        }
        //        MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        //        FileLogger.Log(this.Name, "TableResult", exMessage);
        //    }

        //    #endregion
        //}

        private DataTable FormatBombayTable()
        {
            #region try
            try
            {
                ...
                dtTableResult = OrdinaryVATDesktop.DtColumnNameChange(dtTableResult, "Customer", "Customer_Code");
                dtTableResult = OrdinaryVATDesktop.DtColumnNameChange(dtTableResult, "Invoice No", "ID");
                dtTableResult = OrdinaryVATDesktop.DtColumnNameChange(dtTableResult, "Invoice Item", "Item_Code");
                dtTableResult = OrdinaryVATDesktop.DtColumnNameChange(dtTableResult, "Site", "Branch_Code");
                dtTableResult = OrdinaryVATDesktop.DtColumnNameChange(dtTableResult, "Price Qty", "Quantity");
                dtTableResult = OrdinaryVATDesktop.DtColumnNameChange(dtTableResult, "Sales Price", "NBR_Price");
                dtTableResult = OrdinaryVATDesktop.DtColumnNameChange(dtTableResult, "Invoice Date", "Invoice_Date");
                ...
                dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Invoice_Time", DefaultValue = DateTime.Now.ToString("HH:mm:ss") });
                dtTableResult.Columns.Add(new DataColumn() { ColumnName = "UOM", DefaultValue = "" });
                dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Item_Name", DefaultValue = "-" });
                // dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Weight", DefaultValue = "" });
                dtTableResult.Columns.Add(new DataColumn() { ColumnName = "SubTotal", DefaultValue = "0" });
                // dtTableResult.Columns.Add(new DataColumn() { ColumnName = "CustomerGroup", DefaultValue = "" });
                dtTableResult.Columns.Add(new DataColumn() { ColumnName = "Delivery_Address", DefaultValue = "" });
                ...
                // dtTableResult.Columns.Add(new DataColumn() { ColumnName = "ExpNumberFrom", DefaultValue = "-" });
                // dtTableResult.Columns.Add(new DataColumn() { ColumnName = "ExpNumberTo", DefaultValue = "-" });
                //dtTableResult.Columns.Add(new DataColumn() { ColumnName = "IsProcessed", DefaultValue = false });
        ...
        private DataSet LoadFromCSV()
        {
            ...
            try
            {
                ImportVM paramVm = new ImportVM();
                //paramVm.FilePath = Program.ImportFileName;
                DataTable dt = OrdinaryVATDesktop.ConvertCSVtoDataTable(Program.ImportFileName);
                ds.Tables.Add(dt);
        ...
        private void bgwBigData_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                foreach (DataRow row in salesData.Rows)
                {
                    ...
                    //////ProductVM productVM = productDAl.SelectAll("0", new[] { "Pr.ProductCode" }, new[] { ItemCode }, null, null, null, connVM).FirstOrDefault();
                    ProductVM productVM = productDAl.SelectAllWithProductMapping("0", ItemCode, null, null, null, null, null, connVM).FirstOrDefault();
                    ...
                    {
                        throw new Exception("Product Not Found in the System -- " + ItemCode);
                    }
        ...
        private void UpdateOtherDB(SaleDAL salesDal)
        {
            ...
            {
                var table = salesDal.GetInvoiceNoFromTemp(connVM);
                ...
                if (results[0].ToLower() != "success")
                {
                    ...
                    FileLogger.Log("FormSaleImport", "bgwBigData_DoWork", message);
                }
            }
        }
        ...
        private void TableValidation(DataTable salesData)
        {
            ...
            //if (salesData.Columns.Contains("SL")==null)
            //{
            //    var column = new DataColumn("SL") { DefaultValue = "" };
            //    salesData.Columns.Add(column);     
            //}
            if (salesData.Columns.Contains("TransactionType") == null)
            {
        ...
        private void btnbulk_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                BombayPath = @"D:\IBS_IAS_Invoice\IBS_Files\Work";

                Directory.CreateDirectory(Directory.GetParent(BombayPath).FullName + "\\Hold");
                //  Directory.CreateDirectory(Directory.GetParent(ibsPath).FullName + "\\Debug");
                Directory.CreateDirectory(Directory.GetParent(BombayPath).FullName + "\\Posted");
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!isProcessRunning)
                {
                    int BombayFiles = Directory.EnumerateFiles(BombayPath).Count();

                    //ImportDAL importDal = new ImportDAL();
                    //BranchProfileDAL branchProfileDal = new BranchProfileDAL();

                    //DataTable dtBranchInfo = branchProfileDal.SelectAll(Program.BranchId.ToString(), null, null, null, null, true, connVM);
                    //DataTable salesData = importDal.GetSaleDHLAirportDbData("", dtBranchInfo);
        ...
        private void bgwBombay_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                GetFiles(BombayPath);
        ...
        private void bgwBombay_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            FileLogger.Log("End default IBS Process", "CheckfilesIAS", DateTime.Now.ToString());
        ...
        public void GetFiles(string directoryPath)
        {
            ...
            //  ibsPath = @"D:\IBS_IAS_Invoice\IBS_Files\Work";
            string BombayPath = @"D:\IBS_IAS_Invoice\IBS_Files\Work";
            BombayPath = directoryPath;
            DataTable DtResult = new DataTable();
            DataTable saleMwareDataTable = new DataTable();
            ...
            try
            {
                ...
                string[] files = Directory.GetFiles(BombayPath);
                ...
                for (var index = 0; index < loopCounter; index++)
                {
                    try
                    {
                        ...
                        DtResult = FormatBombayTable();
                        //BombayMiddlewaredata
                        saleMwareDataTable = salesDal.BombayMiddlewaredata(DtResult);

                        foreach (DataRow row in saleMwareDataTable.Rows)
                        {
                            string productName = row["Item_Name"].ToString();

                            ProductVM productVM = productDAl.SelectAll("0", new[] { "Pr.ProductName" }, new[] { productName }, null, null, null, connVM).FirstOrDefault();
                            ...
                            {
                                throw new Exception("Product Not Found in the System -- " + productName);
                            }

                        }

                        TableValidation(saleMwareDataTable);

                        sqlResults = salesDal.SaveAndProcess(saleMwareDataTable, () => { }, Program.BranchId, "", connVM, null, null, null, Program.CurrentUserID);


                        if (sqlResults[0].ToLower() == "success")
                        {
                            // Update middleware data isprocessd Y
                            salesDal.BombayUpdateMwareData();
                        }


                        string destinationFile = Directory.GetParent(BombayPath).FullName + "\\Posted\\" + fileName;
                    ...
                    catch (Exception e)
                    {
                        ...
                        {
                            MoveFile(currentFilePath, Directory.GetParent(BombayPath).FullName + "\\Debug\\" + fileName);
                        }
                        else
                        {
                            MoveFile(currentFilePath, Directory.GetParent(BombayPath).FullName + "\\Hold\\" + fileName);
                        }


                        FileLogger.Log("Bombay", "Getfiles", fileName + "\n" + e.Message + "\n" + e.StackTrace);
                    }
                }
        ...
        private void btnBSMwareSearch_Click(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                FormSaleBombaySearch frm = new FormSaleBombaySearch();
