...
namespace VATServer.Library
{
    public class UserGroupDAL
    {
        ...
        public string[] InsertToUserGroup(string GroupID, string GroupName, string Comments, string ActiveStatus, string CreatedBy, DateTime CreatedOn, string LastModifiedBy, DateTime LastModifiedOn, string databaseName, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
               ...
               currConn = _dbsqlConnection.GetConnection(connVM);
                ...
                if (!string.IsNullOrEmpty(GroupID))
                {
                    ...
                    cmdIdExist.Parameters.AddWithValueAndNullHandle("@GroupID", GroupID);
                ...
                cmdNameExist.Parameters.AddWithValueAndNullHandle("@GroupName", GroupName);
                ...
                cmdInsert.Parameters.AddWithValueAndNullHandle("@GroupName", GroupName);
                cmdInsert.Parameters.AddWithValueAndNullHandle("@Comments", Comments);
        ...
        public string[] UpdateUserGroup(string GroupID, string GroupName, string Comments, string ActiveStatus, string UpdatedBy, DateTime CreatedOn, string LastModifiedBy, DateTime LastModifiedOn, string databaseName, SysDBInfoVMTemp connVM = null)
        {
            string[] retResults = new string[3];
            retResults[0] = "Fail";
            retResults[1] = "Fail";
            ...
            try
            {
               ...
               currConn = _dbsqlConnection.GetConnection(connVM);
                ...
                cmdInsert.Parameters.AddWithValueAndNullHandle("@LastModifiedBy", LastModifiedBy);
                cmdInsert.Parameters.AddWithValueAndNullHandle("@LastModifiedOn", LastModifiedOn);
                cmdInsert.Parameters.AddWithValueAndNullHandle("@GroupID", GroupID);
        ...
        public string[] DeleteUserGroup(string GroupID, string databaseName, SysDBInfoVMTemp connVM = null)
        {
            string[] retResults = new string[3];
            retResults[0] = "Fail";
            retResults[1] = "Fail";
            ...
            try
            {
               ...
               currConn = _dbsqlConnection.GetConnection(connVM);
                ...
                cmdExist.Parameters.AddWithValueAndNullHandle("@GroupID", GroupID);
                ...
                cmdDelete.Parameters.AddWithValueAndNullHandle("@GroupID", GroupID);
        ...
        public DataTable SearchUserGroupNew(string GroupName, string ActiveStatus, SysDBInfoVMTemp connVM = null)
        {
