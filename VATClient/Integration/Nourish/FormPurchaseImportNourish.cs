...
namespace VATClient
{
    public partial class FormPurchaseImportNourish : Form
    {
        #region Variables
        ...
        public FormPurchaseImportNourish()
        {
            InitializeComponent();
        ...
        {
            FormPurchaseImportNourish form = new FormPurchaseImportNourish();
        ...
        private void bgwBigData_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                ResultVM resultvm = integrationDal.SavePurchase(integrationParam, connVM);
        ...
        private void bgwSaleLoad_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                dtTableResult = nourishIntegrationDal.GetPurchaseMaster(param, connVM);
