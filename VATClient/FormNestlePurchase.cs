...
namespace VATClient
{
    public partial class FormNestlePurchase : Form
    {

        public FormNestlePurchase()
        {
            InitializeComponent();
        ...
        private void FormPurchase_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                ToolTip1.SetToolTip(this.btnRemove, "Remove Item from Details");
        ...
        private void SelectproductGroupType()
        {
            ...
            else if (rbtnInputService.Checked || rbtnInputServiceImport.Checked)
            {
                ItemNoParam = string.Empty;
                CategoryIDParam = string.Empty;
                IsRawParam = "Overhead";
        ...
        public void ClearAllFields()
        {
            ...
            if (rbtnInputService.Checked || rbtnInputServiceImport.Checked || rbtnServiceNS.Checked || rbtnServiceNSImport.Checked)
            {
                txtQuantity.Text = "1";
            }
             ...
             || rbtnCommercialImporter.Checked
                ...
                for (int i = 0; i < dgvPurchase.RowCount; i++)
                {
                    ...
                    if (CompanyCode.ToLower() == "nestle")
                    {
                        ...
                        purchaseDetailVm.ProductType = "R";
                    }
                    else
                    {
             ...
             || rbtnCommercialImporter.Checked
                 )
                {
                    ...
                    for (int i = 0; i < dgvDuty.RowCount; i++)
                    {
                        ...
                        //purchaseDuty.Quantity = Convert.ToDecimal(dgvDuty.Rows[i].Cells["QuantityDuty"].Value.ToString());
                        purchaseDuty.Quantity = Convert.ToDecimal(dgvPurchase.Rows[i].Cells["Quantity"].Value.ToString());
                        purchaseDuty.CnFInp = Convert.ToDecimal(dgvDuty.Rows[i].Cells["CnFInp"].Value.ToString());
                        purchaseDuty.CnFRate = Convert.ToDecimal(dgvDuty.Rows[i].Cells["CnFRate"].Value.ToString());
                        purchaseDuty.CnFAmount = Convert.ToDecimal(dgvDuty.Rows[i].Cells["CnFAmount"].Value.ToString());
        ...
        private void btnPost_Click(object sender, EventArgs e)
        {
            ...
            || rbtnCommercialImporter.Checked
                ...
                string settingValue = new CommonDAL().settingValue("Purchase", "BankingChannelPayRange",null,null,null);
        ...
        private void PriceLoad()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(searchText) && searchText != "select")
                {
                    ...
                    {
                        pdt = _pdal.ProductDTByItemNo(vItemNo, "",null,null,connVM);
                    }
       ...
       || (rbtnServiceNSImport.Checked == true && dutyCalculate == true))
        ...
        private void cmbProduct_Leave(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    //BugsBD
                    string VATRateInput = OrdinaryVATDesktop.SanitizeInput(cmbVATRateInput.Text.Trim());
                    ...
                    else
                    {
                        ...
                        cmbType.SelectedValue = VATTypeCal(VATRateInput).ToLower();
                    }
                }
                #endregion
        ...
        private void btnImport_Click(object sender, EventArgs e)
        {
            ...
            else if (value.ToUpper() == "NESTLE")
            {
              ...
              {
                  ImportID = FormPurchaseImportNESTLE.SelectOne(transactionType, false);

              }
              else
              {
                  ImportID = FormPurchaseReturnsImportNESTLE.SelectOne(transactionType, false);
        ...
        private void TDSCalc()
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(txtVendorID.Text.Trim()))
                {
                    ...
                    tdsVm = pDal.TDSCalculation(tdsVm,connVM);
        ...
        public void TDSPreveiw(string[] conditionFields = null, string[] conditionValues = null,string FormNumeric="2")
        {
            try
            {
                DataSet ds = new DataSet();
        ...
        private void bgwPurchaseDetailTemp_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                PurchaseDetailResult = purchaseDal.SelectPurchaseDetailFromTemp(PurchaseDetailData, new[] { "pd.UserId" }, new[] { Program.CurrentUserID });
                PurchaseDutyResult = purchaseDal.SearchPurchaseDutyDTNewFromTemp(PurchaseDetailData,connVM);
                // End DoWork
