...
namespace VATClient
{
    public partial class FormSaleImportNourish : Form
    {
        #region Variables
        ...
        {
            FormSaleImportNourish form = new FormSaleImportNourish();
        ...
        private void bgwBigData_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                ResultVM resultvm = integrationDal.SaveSale(integrationParam, connVM);
        ...
        private void bgwSaleLoad_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                dtTableResult = nourishIntegrationDal.GetSaleMaster(param, connVM);
