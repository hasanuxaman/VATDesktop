...
namespace SymphonySofttech.Reports.Report.Rpt63 {
    ...
    public class RptVAT6_3_ACIG : ReportClass {
        
        public RptVAT6_3_ACIG() {
        }
        
        public override string ResourceName {
            get {
                return "RptVAT6_3_ACIG.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymphonySofttech.Reports.Report.Rpt63.RptVAT6_3_ACIG.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptVAT6_3_ACIG : Component, ICachedReport {
        
        public CachedRptVAT6_3_ACIG() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptVAT6_3_ACIG rpt = new RptVAT6_3_ACIG();
            rpt.Site = this.Site;
            return rpt;
        }
