...
namespace VATViewModel.DTOs
{
    ...
    public class PurchaseDetailVM
    {
        ...
        ////    get { return (SubTotal + CDAmount + RDAmount + TVBAmount + SDAmount + VATAmount + ATVAmount + OthersAmount + OthersAmount + TVAAmount + InsuranceAmount + CnFAmount); }
        ////    set;
        ////}
    ...
    public class PurchasePopUp
    {
        ...
        public string ProductName { get; set; }
        public string ProductCode { get; set; }
        public string ExpireDateTracking { get; set; }
        public string TransactionType { get; set; }
        public string CPCName { get; set; }
        public string ExpireDate { get; set; }
        public string ItemNo { get; set; }
    ...
    public class TrackingVM
    {
        ...
        public bool chkHeading1 { get; set; }
        public bool chkHeading2 { get; set; }
        public List<TrackingVM> IDs { get; set; }
    ...
    public class TransferIssueTrackingVM
    {
        public string ItemNo { get; set; }
        public string TrackingLineNo { get; set; }
        public string Heading1 { get; set; }
