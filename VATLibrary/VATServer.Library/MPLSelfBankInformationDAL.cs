...
namespace VATServer.Library
{
    ...
    public class MPLSelfBankInformationDAL : IMPLBankInformation
    {
...
";
            ...
            catch (SqlException sqlex)
            {
                ...
                FileLogger.Log("MPLSelfBankInformationDAL", "DropDownAll", sqlex.ToString() + "\n" + sqlText);
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("MPLSelfBankInformationDAL", "DropDownAll", ex.ToString() + "\n" + sqlText);
...
af.BankID
,af.BankName
FROM MPLSelfBankInformations af
...
";
            ...
            catch (SqlException sqlex)
            {
                ...
                FileLogger.Log("MPLSelfBankInformationDAL", "DropDown", sqlex.ToString() + "\n" + sqlText);
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("MPLSelfBankInformationDAL", "DropDown", ex.ToString() + "\n" + sqlText);
        ...
        public List<MPLBankInformationVM> SelectAllList(int Id = 0, string[] conditionFields = null, string[] conditionValues = null, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, SysDBInfoVMTemp connVM = null)
        {
            ...
            catch (SqlException sqlex)
            {
                ...
                FileLogger.Log("MPLSelfBankInformationDAL", "SelectAllList", sqlex.ToString() + "\n" + sqlText);
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("MPLSelfBankInformationDAL", "SelectAllList", ex.ToString() + "\n" + sqlText);
...
";
            ...
            {
                FileLogger.Log("MPLSelfBankInformationDAL", "SelectAll", sqlex.ToString() + "\n" + sqlText);
            ...
            {
                FileLogger.Log("MPLSelfBankInformationDAL", "SelectAll", ex.ToString() + "\n" + sqlText);
        ...
        public string[] InsertToMPLBankInformation(MPLBankInformationVM vm, SysDBInfoVMTemp connVM = null, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, bool IsIntegrationAutoCode = false)
        {
            ...
            try
            {
                ...
                sqlText = "select isnull(max(cast(BankID as int)),0)+1 FROM  MPLSelfBankInformations";
                ...
                if (Auto == false)
                {
                    ...
                    {
                        sqlText = "select count(BankID) from MPLSelfBankInformations where  BankCode=@bankCode";
                ...
                sqlText = "";
                sqlText += "insert into MPLSelfBankInformations";
                sqlText += "(";
                sqlText += "BankID,";
                sqlText += "BankName,";
                sqlText += "BranchName,";
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("MPLSelfBankInformationDAL", "InsertToBankInformation", ex.ToString() + "\n" + sqlText);
        ...
        public string[] UpdateMPLBankInformation(MPLBankInformationVM vm, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                sqlText = "select count(BankID) from MPLSelfBankInformations where  BankID=@BankID";
                ...
                sqlText = "";
                sqlText = "update MPLSelfBankInformations set";
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("MPLSelfBankInformationDAL", "UpdateMPLBankInformation", ex.ToString() + "\n" + sqlText);
        ...
        public string[] Delete(MPLBankInformationVM vm, string[] ids, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, SysDBInfoVMTemp connVM = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("MPLSelfBankInformationDAL", "Delete", ex.ToString() + "\n" + sqlText);
