    ...
    public partial class FormSupperAdministrator : Form
    {
        ...
        private void bgwLogin_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            try
            {
                ...
                // Start DoWork
                SuperLoginName = string.Empty;
                SuperLoginPWD = string.Empty;
                SuperAdministrator = false;
                SymphonyUser = false;
                SuperNameResult = new DataTable();
                CommonDAL commonDal= new CommonDAL();
                SuperNameResult = commonDal.SuperAdministrator();
                //done
                // End DoWork
            ...
            {
                FileLogger.Log(this.Name, "bgwLogin_DoWork", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void bgwLogin_RunWorkerCompleted(object sender, System.ComponentModel.RunWorkerCompletedEventArgs e)
        {
            try
            {
                #region Statement
                    ...
                    if (txtUserName.Text.Trim().ToUpper() == "ADMINISTRATOR")
                    {
                        foreach (DataRow row in SuperNameResult.Rows)
                        {
                            if (row["user"].ToString() == "zTvrNxNvP08=")
                            {
                                SuperLoginPWD = Converter.DESDecrypt(PassPhrase, EnKey, row["pwd"].ToString());
                                if (txtUserName.Text.Trim().ToUpper() == "ADMINISTRATOR" &
                                txtUserPassword.Text.Trim().ToUpper() == SuperLoginPWD.ToUpper())
                                {
                                    MessageBox.Show("Thanks for login as Super Administrator", this.Text,
                                ...
                                {
                                    MessageBox.Show("Sorry you are not Super Administrator", this.Text,
                    ...
                    else if (txtUserName.Text.Trim().ToUpper() == "SYMPHONY")
                    {
                        foreach (DataRow row in SuperNameResult.Rows)
                        {
                            if (row["user"].ToString().Trim() == "hV9vFF0OUsptxqpZlnEhrA==")
                            {
                                SuperLoginPWD = Converter.DESDecrypt(PassPhrase, EnKey, row["pwd"].ToString());
                                if (txtUserName.Text.Trim().ToUpper() == "SYMPHONY" &
                                txtUserPassword.Text.Trim().ToUpper() == SuperLoginPWD.ToUpper())
                                {
                                    MessageBox.Show("Thanks for login as Symphony User", this.Text, MessageBoxButtons.OK,
                                ...
                                {
                                    MessageBox.Show("Sorry you are not Symphony User", this.Text, MessageBoxButtons.OKCancel,
                                                    MessageBoxIcon.Stop);
                                    SymphonyUser = false;
                    ...
                    else
                    {
                            ...
                            MessageBox.Show("Sorry you are not Super Administrator", this.Text, MessageBoxButtons.OKCancel, MessageBoxIcon.Stop);
                            SuperAdministrator = false;
                            SymphonyUser = false;
            ...
            {
                FileLogger.Log(this.Name, "bgwLogin_RunWorkerCompleted", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void btnNewCompany_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (SymphonyUser == true)
                {
                    FormCompanyProfile frmCompanyProfile = new FormCompanyProfile();

                    frmCompanyProfile.btnNewCompany.Visible = true;
                    frmCompanyProfile.btnUpdate.Visible = false;
                    frmCompanyProfile.btnPrintList.Visible = false;
                    frmCompanyProfile.Show();
                }
                else
                {
                    MessageBox.Show("Sorry you are not a Symphony User");
                    return;
                }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (SuperAdministrator != true)
                {
                    MessageBox.Show("Sorry you are not a Super Administrator");
                    return;
                }
                FormDBLogin frmDBLogin = new FormDBLogin();
                frmDBLogin.Show();
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (SuperAdministrator != true && SymphonyUser != true)
                {
                    MessageBox.Show("Sorry you are not a Super Administrator");
                    return;
                }
                if (TxtChangeUserName.Text.Trim() == "")
                {
                    MessageBox.Show("Please enter user name");
                    return;
                }
                if (TxtChangePWD.Text.Trim() == "")
                {
                    MessageBox.Show("Please enter password");
                    return;
                }
                if (TxtChangePWD.Text.Trim() != TxtChangePWD1.Text.Trim())
                {
                ...
                LoginPWD = Converter.DESEncrypt(PassPhrase, EnKey, TxtChangePWD.Text.Trim());
                LoginName = Converter.DESEncrypt(PassPhrase, EnKey, TxtChangeUserName.Text.Trim());
        ...
        private void bgwUpdate_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            try
            {
                ...
                CommonDAL commonDal = new CommonDAL();
                sqlResults = commonDal.SuperAdministratorUpdate(TxtChangeUserName.Text.Trim(), LoginPWD);
        ...
        private void FormSupperAdministrator_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                FormConfigChange frmConfigChange = new FormConfigChange();

                frmConfigChange.Show();
        ...
        private void btnSuperInfo_Click(object sender, EventArgs e)
        {
            if (SuperAdministrator == true)
            {
                FormSuperInfo frmSuperInfo = new FormSuperInfo();
                frmSuperInfo.Show();
            }
            else if (SymphonyUser == true)
            {
        ...
        {
            TxtChangeUserName.Text = txtUserName.Text.Trim().ToUpper();
            ChangeData = true;
        ...
        private void btnDBBackup_Click(object sender, EventArgs e)
        {
            //if (SuperAdministrator == true)
            //{
            //    FormDBBackupRestore frmDbBancupRestore = new FormDBBackupRestore();
            //    frmDbBancupRestore.Show();
            //}
            //else if (SymphonyUser == true)
            //{
            //    FormDBBackupRestore frmDbBancupRestore = new FormDBBackupRestore();
        ...
        private void btnSysDBCreate_Click(object sender, EventArgs e)
        {
        ...
        private bool LoadExist()
        {
            try
            {
                ...
                if (System.IO.File.Exists(Program.AppPath + "/SuperInformation.xml"))
                {
                    ...
                    uName = Converter.DESDecrypt(PassPhrase, EnKey, ds.Tables[0].Rows[0]["Tom"].ToString());
                    pwd = Converter.DESDecrypt(PassPhrase, EnKey, ds.Tables[0].Rows[0]["jery"].ToString());
                    DbSource = Converter.DESDecrypt(PassPhrase, EnKey, ds.Tables[0].Rows[0]["mini"].ToString());
                    ds.Clear();
                }
                else
                {
        ...
        public static bool SelectOne()
        {
            bool isSymphonyUser;
            SymphonyUser = false;
            FormSupperAdministrator frmSupper=new FormSupperAdministrator();
            frmSupper.ShowDialog();

            isSymphonyUser = SymphonyUser;
