...
namespace VATClient
{
    public partial class FormPReceiveImportACI : Form
    {
        #region Variables
        ...
        {
            FormPReceiveImportACI form = new FormPReceiveImportACI();
        ...
        private void FormMasterImport_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Text = "Receive Return Import";
        ...
        private void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    //dtTableResult = importDal.GetReceiveACIDbData(invoiceNo, transactionType, FromDate, ToDate, dt);
                    //dgvLoadedTable.DataSource = dtTableResult;
        ...
        private void bgwBigData_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                //sqlResults = receiveDal.SaveTempReceive(dtTableResult, transactionType, Program.CurrentUser,
                ...
                sqlResults = receiveDal.SaveReceive_Split(param,connVM);

                //UpdateOtherDB(receiveData);
            }
            catch (Exception ex)
            {
                //MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void UpdateOtherDB(DataTable table)
        {
            try
            {
                if (sqlResults[0].ToLower() == "success" && selectedType == CONST_DATABASE)
                {
                    ...
                    string[] results = importDal.UpdateACITransactions(table, settingVM.BranchInfoDT,null, "Receives");
        ...
        private void dgvLoadedTable_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (cmbImportType.Text == CONST_DATABASE)
            {
                ...
                string date = dgvLoadedTable.CurrentRow.Cells["Receive_DateTime"].Value.ToString();
        ...
        private void bgwReceiveLoad_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                dtTableResult = importDal.GetReceiveACIDbData(param,connVM);
        ...
        private void bgwReceiveLoad_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                dgvLoadedTable.DataSource = dtTableResult;
