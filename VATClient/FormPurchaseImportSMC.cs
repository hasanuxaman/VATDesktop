...
namespace VATClient
{
    public partial class FormPurchaseImportSMC : Form
    {
        ...
        {
            FormPurchaseImportSMC form = new FormPurchaseImportSMC();
        ...
        private void bgwBigData_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                {
                    BranchCode = Program.BranchCode, CurrentUser = Program.CurrentUser
                };

                sqlResults = purchaseDal.SaveSMCPurchase(purchaseData, BulkCallBack, Program.BranchId, "",connVM, param,
