...
namespace VATClient
{
    public partial class FormPurchaseImportSQR  : Form
    {
        #region Variables
        ...
        {
            FormPurchaseImportSQR form = new FormPurchaseImportSQR();
        ...
        private void typeLoad()
        {
            ...
            cmbSearch.Items.Add("GRN_NO");
            cmbSearch.Items.Add("BE_Number");
            BranchProfileDAL _dal = new BranchProfileDAL();
            DataTable dt = _dal.SelectAll(Program.BranchId.ToString(), null, null, null, null, true, connVM);
            ...
            if (branchCode == "SFBL_BOG")
            {
                cmbProductType.Items.Add("RMB");
            }
            ...
            else
            {
                try
                {
                    ...
                    if (branchCode != "UEN")
                    {
                        ...
                        dtTableResult = importDal.GetPurchaseSQRData(invoiceNo, dt, rmPmFlag, searchField, vendorName, chkWildCard.Checked, FromDate, ToDate);
                    }
                    else
                    {
                        dtTableResult =
                            importDal.GetPurchaseSQRRupshiData(invoiceNo, dt, rmPmFlag, soapFlag, searchField, vendorName, chkWildCard.Checked, FromDate, ToDate);
                    }
        ...
        private void bgwBigData_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                //sqlResults = purchaseDal.SaveTempPurchase(dtTableResult, Program.BranchCode,transactionType, Program.CurrentUser,
                    //Program.BranchId, () => { });
