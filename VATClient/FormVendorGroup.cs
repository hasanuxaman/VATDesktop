...
namespace VATClient 
{
    public partial class FormVendorGroup : Form
    {
        public FormVendorGroup()
        {
            InitializeComponent();
        ...
        public string VFIN = "121";
        private bool IsUpdate = false;
        string NextID;

        private SysDBInfoVMTemp connVM = new SysDBInfoVMTemp();

        string VendorGroupData;
        ...
        private void picVendorGroup_Click(object sender, EventArgs e)
        {
        ...
        private int ErrorReturn()
        {
            try
            {
                if (txtVendorGroupName.Text.Trim() == "")
                {
                    MessageBox.Show("Please enter Vendor Group Name.", this.Text);
                    txtVendorGroupName.Focus();
                    return 1;
                }
                if (txtVendorGroupDescription.Text == "")
                {
                    txtVendorGroupDescription.Text = "-";
                }
                if (txtComments.Text == "")
                {
                    txtComments.Text = "-";
        ...
        private void btnClose_Click(object sender, EventArgs e)
        {
            //if (ChangeData == true)
            //{
            //    if (MessageBox.Show("Do you Want to Save the Change?", "Vendor Group Information", MessageBoxButtons.YesNoCancel) == DialogResult.Yes)
            //    {
            //        return;
            //    }
            //}
        ...
        private void txtVendorGroupDescription_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode.Equals(Keys.Enter)) { SendKeys.Send("{TAB}"); }
        }
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            try
            {
                FormRptVendorGroup frmRptVendorGroup = new FormRptVendorGroup();
                //frmRptVendorGroup.txtVGroupId.Text = txtVendorGroupID.Text.Trim();
                //frmRptVendorGroup.txtVGroup.Text = txtVendorGroupName.Text.Trim();
                frmRptVendorGroup.Show();
            }
            #region Catch
            catch (ArgumentNullException ex)
            {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else //if (result == ""){return;}else//if (result != "")
                {
                    ...
                    txtVendorGroupDescription.Text = VendorGroupInfo[2];
                    txtComments.Text = VendorGroupInfo[3];

                    if (VendorGroupInfo[4] == "Y")
                    {
                    ...
                    cmbType.Text = VendorGroupInfo[5];
        ...
        private void txtVendorGroupDescription_TextChanged(object sender, EventArgs e)
        {
        ...
        private void FormVendorGroup_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
        ...
        private void FormVendorGroup_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Please input Vendor Group Type first", this.Text);
                    //this.Close();
                    return;
                }
                ClearAll();
            ...
            {
                FileLogger.Log(this.Name, "FormVendorGroup_Load", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            catch (SoapHeaderException ex)
            {
                ...
                FileLogger.Log(this.Name, "FormVendorGroup_Load", exMessage);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                NextID = IsUpdate == false ? string.Empty : txtVendorGroupID.Text.Trim();
        ...
        private void backgroundWorkerAdd_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                // Start DoWork
                //VendorGroupDAL vendorDAL = new VendorGroupDAL();
                IVendorGroup vendorDAL = OrdinaryVATDesktop.GetObject<VendorGroupDAL, VendorGroupRepo, IVendorGroup>(OrdinaryVATDesktop.IsWCF);
                #region //Commentted
                //sqlResults = vendorDAL.InsertToVendorGroup(NextID.ToString(), txtVendorGroupName.Text.Trim(),
                //                                           txtVendorGroupDescription.Text.Trim(), txtComments.Text.Trim(),
                //                                           activeStatus, Program.CurrentUser,
                //                                            DateTime.Now.ToString("yyyy-MMM-dd HH:mm:ss"),
                //                                           Program.CurrentUser,DateTime.Now.ToString("yyyy-MMM-dd HH:mm:ss"),
                //                                           type, Program.DatabaseName);
                #endregion

                #region model binding
                VendorGroupVM nvm = new VendorGroupVM();
                nvm.VendorGroupID = NextID.ToString();
                nvm.VendorGroupName = txtVendorGroupName.Text.Trim();
                nvm.VendorGroupDescription = txtVendorGroupDescription.Text.Trim();
                nvm.Comments = txtComments.Text.Trim();
                nvm.ActiveStatus = activeStatus.ToString();
                nvm.LastModifiedBy = Program.CurrentUser.ToString();
                nvm.LastModifiedOn = DateTime.Now.ToString("yyyy-MMM-dd HH:mm:ss");
                nvm.GroupType = type;
            
                #endregion
                sqlResults = vendorDAL.InsertToVendorGroup(nvm,connVM);
            ...
            {
                FileLogger.Log(this.Name, "backgroundWorkerAdd_DoWork",
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                FileLogger.Log(this.Name, "btnUpdate", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            catch (SoapHeaderException ex)
            {
                ...
                FileLogger.Log(this.Name, "btnUpdate", exMessage);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void backgroundWorkerUpdate_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                IVendorGroup vendorDAL = OrdinaryVATDesktop.GetObject<VendorGroupDAL, VendorGroupRepo, IVendorGroup>(OrdinaryVATDesktop.IsWCF);
                #region //Commented
                //sqlResults = vendorDAL.UpdateToVendorGroup(NextID.ToString(),
                //                                           txtVendorGroupName.Text.Trim(),
                //                                           txtVendorGroupDescription.Text.Trim(),
                ...
                #endregion
                sqlResults = vendorDAL.UpdateToVendorGroup(nvm,connVM);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                if (Program.CheckLicence(DateTime.Now) == true)
                {
                    MessageBox.Show("Fiscal year not create or your system date not ok, Transaction not complete",this.Text);
                    return;
                }
                else if (txtVendorGroupID.Text.Trim() == "")
                {
                    MessageBox.Show("No data deleted." + "\n" + "Please select existing information first", this.Text,
                                    MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return;
                }
                else if (txtVendorGroupID.Text.Trim() == "0")
                {
        ...
        private int DataAlreadyUsed()
        {
            ...
            try
            {
                ...
                if (commonDal.DataAlreadyUsed("Vendors", "VendorGroupID", txtVendorGroupID.Text.Trim(), null, null,connVM) != 0)
                {
                    MessageBox.Show(MessageVM.msgDataAlreadyUsed + " Vendors" + MessageVM.msgDeleteOperationterminated, this.Text);
                    return 1;
                }
            }
            #endregion
        ...
        private void backgroundWorkerDelete_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                var ids = new string[] { txtVendorGroupID.Text.Trim(), "" };
                sqlResults = vendorGroupDAL.Delete(vm, ids,null,null,connVM);

                //sqlResults = vendorGroupDAL.DeleteVendorGroup(txtVendorGroupID.Text.Trim(), Program.DatabaseName);
