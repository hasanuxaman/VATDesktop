...
namespace SymphonySofttech.Reports
{
   public class CustomerGroupReport
    {
       public ReportDocument CustomerGroupNew(string CustomerGroupID, SysDBInfoVMTemp connVM = null)
       {
           try
           {
               ...
               ReportResult = reportDsdal.CustomerGroupNew(CustomerGroupID,connVM);
