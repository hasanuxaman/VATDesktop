...
namespace VATClient
{
    public partial class FormFiscalYear : Form
    {
        ...
        private DataTable yearResult;
        List<FiscalYearVM> fiscalyears = new List<FiscalYearVM>();
        ...
        private void bgwSelectYear_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            try
            {
                #region Statement
        ...
        private void bgwSelectYear_RunWorkerCompleted(object sender, System.ComponentModel.RunWorkerCompletedEventArgs e)
        {
            try
            {
                #region Statement
        ...
        private void dtpFYearStart_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                FileLogger.Log(this.Name, "dtpFYearStart_ValueChanged", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            catch (SoapHeaderException ex)
            {
                ...
                FileLogger.Log(this.Name, "dtpFYearStart_ValueChanged", exMessage);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void cmbFiscalYear_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
                {
                //dtpFYearStart.Value = Convert.ToDateTime(dtpFYearStart.Value.ToString("dd/MMM/") + cmbFiscalYear.Text.Trim()).AddYears(-1);
                dtpFYearStart.Value = (Convert.ToDateTime(dtpFYearEnd.Value.ToString("dd/MMM/") + cmbFiscalYear.Text.Trim()).AddYears(-1)).AddDays(1);
                dtpFYearEnd.Value = Convert.ToDateTime(dtpFYearEnd.Value.ToString("dd/MMM/") + cmbFiscalYear.Text.Trim());
                ChangeData = true;
            ...
            {
                FileLogger.Log(this.Name, "cmbFiscalYear_SelectedIndexChanged", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            catch (SoapHeaderException ex)
            {
                ...
                FileLogger.Log(this.Name, "cmbFiscalYear_SelectedIndexChanged", exMessage);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void Search()
        {
            ...
            try
            {
                CurrentYear = cmbFiscalYear.Text.Trim();
        ...
        private void backgroundWorkerSearch_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            try
            {
                ...
                //FiscalYearDAL fiscalYearDal = new FiscalYearDAL();
                IFiscalYear fiscalYearDal = OrdinaryVATDesktop.GetObject<FiscalYearDAL, FiscalYearRepo, IFiscalYear>(OrdinaryVATDesktop.IsWCF);
                yearResult = fiscalYearDal.LoadYear(CurrentYear,connVM);
        ...
        private void backgroundWorkerSearch_RunWorkerCompleted(object sender, System.ComponentModel.RunWorkerCompletedEventArgs e)
        {
            try
            {
                ...
                int j = 0;
                dgvFYear.Rows.Clear();
                foreach (DataRow item in yearResult.Rows)
                {
                    DataGridViewRow NewRow = new DataGridViewRow();
                    dgvFYear.Rows.Add(NewRow);
                    dgvFYear.Rows[j].Cells["LineNo"].Value = Convert.ToString(j + 1);
                    dgvFYear.Rows[j].Cells["MonthName"].Value = item["PeriodName"].ToString();// YearFields[3];
                    dgvFYear.Rows[j].Cells["PeriodStart"].Value = Convert.ToDateTime(item["PeriodStart"]).ToString("dd/MMM/yyyy");//Convert.ToDateTime(YearFields[4]).ToString("dd/MMM/yyyy");
                    dgvFYear.Rows[j].Cells["PeriodEnd"].Value = Convert.ToDateTime(item["PeriodEnd"]).ToString("dd/MMM/yyyy");// Convert.ToDateTime(YearFields[5]).ToString("dd/MMM/yyyy");
                    dgvFYear.Rows[j].Cells["Lock"].Value = true ? item["PeriodLock"].ToString() == "Y" : item["PeriodLock"].ToString() == "N";
                    if (j == 11)
                    {
                        chkYearLock.Checked = true ? item["GLLock"].ToString() == "Y" : item["GLLock"].ToString() == "N";
                    }
                    j = j + 1;
                } //complete
                #endregion
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dgvFYear.RowCount > 0)
                {
                    for (int i = 0; i < 12; i++)
                    {
                        if (chkYearLock.Checked == true)
                        {
                            dgvFYear.Rows[i].Cells["Lock"].Value = true;
                        }
                    }
                }
                ...
                for (int i = 0; i < dgvFYear.RowCount; i++)
                {
                    ...
                    detail.PeriodLock = Convert.ToString(Convert.ToBoolean(dgvFYear.Rows[i].Cells["Lock"].Value) == true ? "Y" : "N");
                    detail.GLLock = Convert.ToString(chkYearLock.Checked ? "Y" : "N");
        ...
        private void bgwSave_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            try
            {
                ...
                //FiscalYearDAL fiscalYearDal = new FiscalYearDAL();
                IFiscalYear fiscalYearDal = OrdinaryVATDesktop.GetObject<FiscalYearDAL, FiscalYearRepo, IFiscalYear>(OrdinaryVATDesktop.IsWCF);
                sqlResults = fiscalYearDal.FiscalYearInsert(fiscalyears,connVM);
        ...
        private void dgvFYear_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void AddFiscalYear()
        {
            ...
            try
            {
                ...
                {
                    //DateTime a =                        Convert.ToDateTime(dtpFYearStart.Value.ToString("MMMM-") + cmbFiscalYear.Text.Trim()).AddMonths(j);
                    DataGridViewRow NewRow = new DataGridViewRow();
                    dgvFYear.Rows.Add(NewRow);
                    ...
                    //dgvFYear.Rows[j].Cells["MonthName"].Value =Convert.ToDateTime(dtpFYearStart.Value.ToString("MMMM-") + cmbFiscalYear.Text.Trim()).AddMonths(j);
                    //dgvFYear.Rows[j].Cells["PeriodStart"].Value =Convert.ToDateTime(dtpFYearStart.Value.ToString("dd/MMM/") + cmbFiscalYear.Text.Trim()).AddMonths(j);
                    //dgvFYear.Rows[j].Cells["PeriodEnd"].Value =Convert.ToDateTime(dtpFYearStart.Value.ToString("dd/MMM/") + cmbFiscalYear.Text.Trim()).AddMonths(j + 1).AddDays(-1);
                    //return;
                }
            }
            #endregion
            ...
            {
                FileLogger.Log(this.Name, "AddFiscalYear", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            catch (SoapHeaderException ex)
            {
                ...
                FileLogger.Log(this.Name, "AddFiscalYear", exMessage);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void chkYearLock_CheckedChanged(object sender, EventArgs e)
        {
            //if (dgvFYear.RowCount > 0)
            //{
            //    for (int i = 0; i < 12; i++)
            ...
            //        else
            //        {
            //            dgvFYear.Rows[i].Cells["Lock"].Value = false;
            //        }
            //    }
            //}
        }
        ...
        private void chkAll_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                FileLogger.Log(this.Name, "chkAll_CheckedChanged", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            catch (SoapHeaderException ex)
            {
                ...
                FileLogger.Log(this.Name, "chkAll_CheckedChanged", exMessage);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void bgwUpdate_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                //FiscalYearDAL fiscalYearDal = new FiscalYearDAL();
                IFiscalYear fiscalYearDal = OrdinaryVATDesktop.GetObject<FiscalYearDAL, FiscalYearRepo, IFiscalYear>(OrdinaryVATDesktop.IsWCF);
                sqlResults = fiscalYearDal.FiscalYearUpdate(fiscalyears, Program.CurrentUserID,connVM);
        ...
        private void FormFiscalYear_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
