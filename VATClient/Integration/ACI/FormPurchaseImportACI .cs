...
namespace VATClient
{
    public partial class FormPurchaseImportACI  : Form
    {
        #region Variables
        ...
        {
            FormPurchaseImportACI form = new FormPurchaseImportACI();
        ...
        private void FormMasterImport_Load(object sender, EventArgs e)
        {
            ...
            //dgvLoadedTable.Columns["Select"].ReadOnly = false;
            typeLoad();
        ...
        private void typeLoad()
        {
            ...
            cmbSearchField.Items.Add("GRN_No");
            cmbSearchField.Items.Add("BE_No");
            cmbSearchField.Items.Add("Po_No");
            cmbSearchField.Items.Add("Vendor_Name");
            cmbSearchField.Items.Add("BIN");

            cmbSearchField.Text = "BE_No";
            ...
            try
            {
                ...
                if (selectedType == CONST_EXCEL)
                {
                   ...
                   // dgvLoadedTable.DataSource = dtTableResult;
                    ...
                    bgwExcelUploadACI.RunWorkerAsync();
                    // dtTableResult = OrdinaryVATDesktop.DtDateCheck(dtTableResult, new string[] { "Delivery_Date_Time", "Invoice_Date_Time" });
                    //SelectAll();
                }
                #endregion
        ...
        private void bgwBigData_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                sqlResults = purchaseDal.SaveTempPurchase(purchaseData, Program.BranchCode, transactionType, Program.CurrentUser,
                    Program.BranchId, () => { }, null, null, connVM, Program.CurrentUserID, true);
        ...
        private void bgwExcelUploadACI_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
            ...
            {
                FileLogger.Log(this.Name, "bgwExcelUploadACI_DoWork", ex.ToString());
                throw;
            }
        ...
        private void bgwExcelUploadACI_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
            ...
            {
                FileLogger.Log(this.Name, "bgwExcelUploadACI_RunWorkerCompleted", ex.ToString());
                throw;
            }
            finally
            {
