...
namespace VATClient
{
    public partial class FormReceiveImportSQR : Form
    {
        #region Variables
        ...
        {
            FormReceiveImportSQR form = new FormReceiveImportSQR();
            form.preSelectTable = "Receives";
        ...
        private void typeLoad()
        {
            ...
            cmbSearch.Items.Add("Batch_No");

            cmbProductType.Items.Add("RM");
            cmbProductType.Items.Add("PM");

            cmbRup.Items.Add("Senora");
            cmbRup.Items.Add("Soap");
            ...
            cmbProductType.Text = "RM";
            cmbSearch.Text = "BE_Number";
            cmbRup.Text = "Soap";
        ...
        void NullCheck()
        {
            ...
            FromDate = dtpFromDate.Checked == false ? "" : dtpFromDate.Value.ToString("yyyy-MM-dd");
            ToDate = dtpToDate.Checked == false ? "" : dtpToDate.Value.ToString("yyyy-MM-dd");
        ...
        private void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    string searchField = cmbSearch.Text.ToLower();
                    string rmPmFlag = cmbProductType.Text.ToLower();
                    string soapFlag = cmbRup.Text.ToLower();
                    string vendorName = txtVendorName.Text.ToLower();

                    IntegrationParam param = new IntegrationParam();

                    param.dtConnectionInfo = dt;
                    param.RefNo = invoiceNo;
                    param.rmPmFlag = rmPmFlag;
                    param.FromDate = FromDate;
                    param.ToDate = ToDate;
                    param.rupshiFlag = soapFlag;
                    param.SearchField = searchField;


                    if (branchCode != "UEN")
                    {
                        dtTableResult = importDal.GetProductionReceiveSQR(param);
                    }
                    else
                    {
                        dtTableResult = importDal.GetProductionReceiveSQRRupshi(param);
                ...
                {
                    FileLogger.Log("SQRProductionReceiveImport", "btnLoad_Click", ex.Message + "\n" + ex.StackTrace);
        ...
        private void bgwBigData_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                DataTable dataTable = dtTableResult.Copy();


                sqlResults = receiveDal.SaveTempReceiveImport(dataTable, transactionType, Program.CurrentUserID, Program.BranchId, () => { },null,null,connVM);
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("SQRProductionReceiveImport", "bgwBigData_DoWork", ex.Message + "\n" + ex.StackTrace);
        ...
        private void bgwBigData_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show(sqlResults[1].ToString(), sqlResults[0].ToString());
            ...
            {
                FileLogger.Log("SQRProductionReceiveImport", "bgwBigData_RunWorkerCompleted", ex.Message + "\n" + ex.StackTrace);
        ...
        private void btnSaveTemp_Click(object sender, EventArgs e)
        {
            ...
            {
                FileLogger.Log("SQRProductionReceiveImport", "btnSaveTemp_Click", exception.Message + "\n" + exception.StackTrace);
        ...
        private void dgvLoadedTable_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (cmbImportType.Text == CONST_DATABASE)
            {
                ...
                //_saleRow = Convert.ToDateTime(_saleRow).ToString("ddMMyyyy");
