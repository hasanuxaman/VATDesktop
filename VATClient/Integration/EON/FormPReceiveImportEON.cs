...
namespace VATClient
{
    public partial class FormPReceiveImportEON : Form
    {
        #region Variables
        string IsProcess;
        ...
        {
            FormPReceiveImportEON form = new FormPReceiveImportEON();
        ...
        private void bgwSaleLoad_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                dtTableResult = eonIntegrationDal.GetPReceiveData(param,connVM,null,null,IsProcess);

            }
            catch (Exception exception)
            {
                FileLogger.Log("FormPReceiveImportEON", "bgwSaleLoad_DoWork", exception.ToString());
