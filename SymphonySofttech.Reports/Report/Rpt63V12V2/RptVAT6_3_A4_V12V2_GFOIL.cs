...
namespace SymphonySofttech.Reports.Report.Rpt63V12V2 {
    ...
    public class RptVAT6_3_A4_V12V2_GFOIL : ReportClass {
        
        public RptVAT6_3_A4_V12V2_GFOIL() {
        }
        
        public override string ResourceName {
            get {
                return "RptVAT6_3_A4_V12V2_GFOIL.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymphonySofttech.Reports.Report.Rpt63V12V2.RptVAT6_3_A4_V12V2_GFOIL.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptVAT6_3_A4_V12V2_GFOIL : Component, ICachedReport {
        
        public CachedRptVAT6_3_A4_V12V2_GFOIL() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptVAT6_3_A4_V12V2_GFOIL rpt = new RptVAT6_3_A4_V12V2_GFOIL();
            rpt.Site = this.Site;
            return rpt;
        }
