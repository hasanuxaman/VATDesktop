...
namespace SymphonySofttech.Reports.Report {
    ...
    public class RptStockMovement2 : ReportClass {
        
        public RptStockMovement2() {
        }
        
        public override string ResourceName {
            get {
                return "RptStockMovement2.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymphonySofttech.Reports.Report.RptStockMovement2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptStockMovement2 : Component, ICachedReport {
        
        public CachedRptStockMovement2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptStockMovement2 rpt = new RptStockMovement2();
            rpt.Site = this.Site;
            return rpt;
        }
