...
namespace VATClient
{
    public partial class FormIssueImportNourish : Form
    {
        #region Variables
        ...
        {
            FormIssueImportNourish form = new FormIssueImportNourish();
        ...
        private void bgwBigData_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                ResultVM resultvm = integrationDal.SaveIssue(integrationParam, connVM);
        ...
        private void bgwSaleLoad_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                dtTableResult = nourishIntegrationDal.GetIssueMaster(param, connVM);
