...
{
   public class ProductCategoryInformationReport
    {
       public ReportDocument ProductCategoryNew(string cgID, SysDBInfoVMTemp connVM = null)
       {
           try
           {
               ...
               ReportResult = reportDsdal.ProductCategoryNew(cgID, connVM);
