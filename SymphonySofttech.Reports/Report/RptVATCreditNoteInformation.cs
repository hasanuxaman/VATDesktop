...
namespace SymphonySofttech.Reports.Report {
    ...
    public class RptVATCreditNoteInformation : ReportClass {
        
        public RptVATCreditNoteInformation() {
        }
        
        public override string ResourceName {
            get {
                return "RptVATCreditNoteInformation.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymphonySofttech.Reports.Report.RptVATCreditNoteInformation.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptVATCreditNoteInformation : Component, ICachedReport {
        
        public CachedRptVATCreditNoteInformation() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptVATCreditNoteInformation rpt = new RptVATCreditNoteInformation();
            rpt.Site = this.Site;
            return rpt;
        }
