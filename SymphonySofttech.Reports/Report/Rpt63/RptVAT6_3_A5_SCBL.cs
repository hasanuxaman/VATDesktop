...
namespace SymphonySofttech.Reports.Report.Rpt63 {
    ...
    public class RptVAT6_3_A5_SCBL : ReportClass {
        
        public RptVAT6_3_A5_SCBL() {
        }
        
        public override string ResourceName {
            get {
                return "RptVAT6_3_A5_SCBL.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymphonySofttech.Reports.Report.Rpt63.RptVAT6_3_A5_SCBL.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptVAT6_3_A5_SCBL : Component, ICachedReport {
        
        public CachedRptVAT6_3_A5_SCBL() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptVAT6_3_A5_SCBL rpt = new RptVAT6_3_A5_SCBL();
            rpt.Site = this.Site;
            return rpt;
        }
