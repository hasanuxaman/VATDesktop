...
namespace SymphonySofttech.Reports.Report {
    ...
    public class RptVAT6_1_NewRegister : ReportClass {
        
        public RptVAT6_1_NewRegister() {
        }
        
        public override string ResourceName {
            get {
                return "RptVAT6_1_NewRegister.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymphonySofttech.Reports.Report.RptVAT6_1_NewRegister.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptVAT6_1_NewRegister : Component, ICachedReport {
        
        public CachedRptVAT6_1_NewRegister() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptVAT6_1_NewRegister rpt = new RptVAT6_1_NewRegister();
            rpt.Site = this.Site;
            return rpt;
        }
