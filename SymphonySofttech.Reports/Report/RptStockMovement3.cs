...
namespace SymphonySofttech.Reports.Report {
    ...
    public class RptStockMovement3 : ReportClass {
        
        public RptStockMovement3() {
        }
        
        public override string ResourceName {
            get {
                return "RptStockMovement3.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymphonySofttech.Reports.Report.RptStockMovement3.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptStockMovement3 : Component, ICachedReport {
        
        public CachedRptStockMovement3() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptStockMovement3 rpt = new RptStockMovement3();
            rpt.Site = this.Site;
            return rpt;
        }
