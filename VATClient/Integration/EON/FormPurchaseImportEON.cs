...
namespace VATClient
{
    public partial class FormPurchaseImportEON : Form
    {
        #region Variables
        string IsProcess;
        ...
        {
            FormPurchaseImportEON form = new FormPurchaseImportEON();
        ...
        private void bgwPost_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                sqlResults = importDal.PostACISaleData(dtTableResult);
            }
            catch (Exception exception)
            {
                sqlResults[0] = "fail";
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    ResultVM result = saleDal.BulkInsertMasterTemp(dtTableResult);
        ...
        private void bgwSaleLoad_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                dtTableResult = eonIntegrationDal.GetPurchaseData(param,connVM,null,null,IsProcess);
        ...
        private void cmbIsProcessed_SelectedIndexChanged(object sender, EventArgs e)
        {
