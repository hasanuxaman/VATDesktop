...
namespace SymphonySofttech.Reports.Report {
    ...
    public class RptScblImportData : ReportClass {
        
        public RptScblImportData() {
        }
        
        public override string ResourceName {
            get {
                return "RptScblImportData.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymphonySofttech.Reports.Report.RptScblImportData.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptScblImportData : Component, ICachedReport {
        
        public CachedRptScblImportData() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptScblImportData rpt = new RptScblImportData();
            rpt.Site = this.Site;
            return rpt;
        }
