...
namespace VATClient
{
    public partial class FormSaleImportBTSL : Form
    {
        #region Variables
        ...
        {
            FormSaleImportBTSL form = new FormSaleImportBTSL();
        ...
        private void bgwBigData_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (transactionType.ToLower() == "other" || transactionType.ToLower() == "credit" || transactionType.ToLower() == "debit")
                    {
                        //saleDataSet.Tables.Add(salesData);
                        ...
                        //------------------------------------------------------------------------------------------------------------------------
                        //sqlResults = salesDal.SaveAndProcess(salesData, BulkCallBack, Program.BranchId, Program.GetAppVersion());
                        ...
                        IntegrationParam param = new IntegrationParam
                        {
                            ...
                            BranchCode = Program.BranchCode,
                            DefaultBranchCode = Program.BranchCode,
                        ...
                        resultVm = importDal.SaveSale(param,connVM);
        ...
        private void bgwBigData_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                ...
                if (sqlResults[0] != null && sqlResults[0].ToLower() == "success")
                {
                    FileLogger.Log(this.Name, "End Time", DateTime.Now.ToString("HH:mm:ss tt"));
            ...
            {
                FileLogger.Log(this.Name, "SaveSale", ex.Message + "\n" + ex.StackTrace);
        ...
        private void btnSaveTemp_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                FileLogger.Log(this.Name, "Start Time", DateTime.Now.ToString("HH:mm:ss tt"));
