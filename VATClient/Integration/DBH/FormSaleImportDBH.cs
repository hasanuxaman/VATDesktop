...
namespace VATClient
{
    public partial class FormSaleImportDBH : Form
    {
        #region Variables
        ...
        {
            FormSaleImportDBH form = new FormSaleImportDBH();
        ...
        private void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    IBranchProfile dal =
                        OrdinaryVATDesktop
                            .GetObject<BranchProfileDAL, BranchProfileRepo, IBranchProfile>(Program.IsWCF);

                    DataTable dt = dal.SelectAll(Program.BranchId.ToString(), null, null, null, null, true, connVM);

                    dtTableResult = importDal.GetSaleDBHDbData(ids, dt, FromDate, ToDate, transactionType);
                    dgvLoadedTable.DataSource = dtTableResult;
                    lblRecord.Text = "Record Count: " + dtTableResult.Rows.Count;
        ...
        private void bgwBigData_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                sqlResults = salesDal.SaveAndProcess(salesData, BulkCallBack, Program.BranchId, "",connVM,
                    new IntegrationParam() {InvoiceTime = DateTime.Now.ToString(" HH:mm:ss")}, null,
                    null, Program.CurrentUserID);
                ...
                FileLogger.Log("ImportDAL", "GetSaleSQRDbData", "END");
        ...
        private void bgwBigData_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            finally
            {
                ...
                FileLogger.Log("ImportDAL", "GetSaleSQRDbData", "Finally");
        ...
        {
            FormSaleImportDBH_AutoPrint frm = new FormSaleImportDBH_AutoPrint();

            string ImportId = FormSaleImportDBH_AutoPrint.SelectOne(transactionType, IsCDN);
