...
namespace VATClient.Integration.DHL
{
    public partial class FormSaleImportDHLAirport : Form
    {
        #region Variables
        ...
        public FormSaleImportDHLAirport()
        {
            InitializeComponent();
        ...
        {
            FormSaleImportDHLAirport form = new FormSaleImportDHLAirport();
        ...
        private void bgwBigData_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                //#region Get Sale DHL Airport DbData
                ...
                //dtTableResult = importDal.GetSaleDHLAirportDbData("", dtBranchInfo,"",connVM);//, uVm.FullName
                ...
                //        //string[] cValues = { "N", Program.BranchId.ToString(),Program.CurrentUser };
            ...
            catch (Exception exception)
            {
                ...
                FileLogger.Log("SaleImportDHLAirport", "bgwBigData_DoWork", exception.Message);
            }
        }
        ...
        private void bgwBigData_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            catch (Exception exception)
            {
                ...
                FileLogger.Log("SaleImportDHLAirport", "bgwBigData_RunWorkerCompleted", exception.Message);
