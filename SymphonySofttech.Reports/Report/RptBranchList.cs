...
namespace SymphonySofttech.Reports.Report {
    ...
    public class RptBranchList : ReportClass {
        
        public RptBranchList() {
        }
        
        public override string ResourceName {
            get {
                return "RptBranchList.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymphonySofttech.Reports.Report.RptBranchList.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptBranchList : Component, ICachedReport {
        
        public CachedRptBranchList() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptBranchList rpt = new RptBranchList();
            rpt.Site = this.Site;
            return rpt;
        }
