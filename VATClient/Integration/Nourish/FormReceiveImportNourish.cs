...
namespace VATClient
{
    public partial class FormReceiveImportNourish : Form
    {
        #region Variables
        ...
        public FormReceiveImportNourish()
        {
            InitializeComponent();
        ...
        {
            FormReceiveImportNourish form = new FormReceiveImportNourish();

            form.preSelectTable = "Receive";
        ...
        private void bgwBigData_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                ResultVM resultvm = integrationDal.SaveReceive(integrationParam, connVM);
        ...
        private void dgvLoadedTable_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (cmbImportType.Text == CONST_DATABASE)
            {
                ...
                string branch_code = dgvLoadedTable.CurrentRow.Cells["Branch_Code"].Value.ToString();
        ...
        private void bgwSaleLoad_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                dtTableResult = nourishIntegrationDal.GetReceiveMaster(param, connVM);
        ...
        private void bgwDetails_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            DataTable dtResult = integrationDal.GetDetails(param);
        ...
        private void bgwDetails_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                ...
                dt = dt.DefaultView.ToTable(false, "Item_Code", "Item_Name", "Quantity", "NBR_Price");
