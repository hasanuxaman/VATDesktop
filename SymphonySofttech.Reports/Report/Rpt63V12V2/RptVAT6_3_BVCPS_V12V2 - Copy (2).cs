...
namespace SymphonySofttech.Reports.Report.Rpt63V12V2 {
    ...
    public class RptVAT6_3_BVCPS_V12V2___Copy_2 : ReportClass {
        
        public RptVAT6_3_BVCPS_V12V2___Copy_2() {
        }
        
        public override string ResourceName {
            get {
                return "RptVAT6_3_BVCPS_V12V2 - Copy (2).rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymphonySofttech.Reports.Report.Rpt63V12V2.RptVAT6_3_BVCPS_V12V2 - Copy (2).rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptVAT6_3_BVCPS_V12V2___Copy_2 : Component, ICachedReport {
        
        public CachedRptVAT6_3_BVCPS_V12V2___Copy_2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptVAT6_3_BVCPS_V12V2___Copy_2 rpt = new RptVAT6_3_BVCPS_V12V2___Copy_2();
            rpt.Site = this.Site;
            return rpt;
        }
