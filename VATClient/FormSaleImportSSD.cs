...
namespace VATClient
{
    public partial class FormSaleImportSSD : Form
    {
        #region Variables
        ...
        {
            FormSaleImportSSD form = new FormSaleImportSSD();
        ...
        private void typeLoad()
        {
            ...
            string value = dal.settingsDesktop("Import", "SaleImportSelection");
        ...
        private void LoadDataGrid()
        {
            try
            {
                ...
                else if (selectedType == CONST_TEXT)
                {
                    ...
                    var flag = new CommonDAL().settingValue(CONST_SINGLEIMPORT, "SaleImport");
        ...
        private void SaveSale()
        {
            ...
            try
            {
                ...
                sqlResults = saleDal.ImportData(dtSaleM, dtSaleD, dtSaleE, CommercialImporter);
            }
        ...
        private void bgwBigData_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                sqlResults = saleDal.ImportExcelIntegrationDataTable(salesData,
                    saleMasterVm);

                DataSet dataSet = importDal.GetSaleNewProcData("", null, "", "");

                DataTable master = dataSet.Tables[0].Copy();

                master.Columns.Remove("Customer_Code");
                master.Columns.Remove("Customer_Name");
                master.Columns.Remove("Invoice_Date_Time");
                master.Columns.Remove("TotalQuantity");
                master.Columns.Remove("TotalValue");
                master.Columns.Remove("TotalSD");
                master.Columns.Remove("TotalVAT");
                master.Columns.Remove("Post");
                master.Columns.Remove("TotalValueDiff");

                sqlResults = importDal.SaveSaleWithSteps(master, BulkCallBack, Program.BranchId,
                    Program.BranchCode, Program.GetAppVersion(), transactionType, true, "", SetSteps);
