...
{
    public partial class FormRptDepositTDS : Form
    {
        public FormRptDepositTDS()
        {
            InitializeComponent();       
        ...
        private void ShowVDS()
        {
            try
            {
                ...
                ReportResult = reportDsdal.TDSDepositDetail_MISReport(txtDepositNo.Text.Trim(), DepositFromDate, DepositToDate,
                    txtBankID.Text.Trim(), cmbPostText, transactionType,connVM);
        ...
        private void backgroundWorkerPreview_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                ...
                ReportResult = reportDsdal.TDSDeposit_MISReport(txtDepositNo.Text.Trim(), DepositFromDate, DepositToDate,
                    txtBankID.Text.Trim(), cmbPostText, transactionType,connVM);
