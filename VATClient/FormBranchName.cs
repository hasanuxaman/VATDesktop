...
namespace VATClient
{
    public partial class FormBranchName : Form
    {

        public FormBranchName()
        {
            InitializeComponent();
        ...
        private DataTable BrNameResult;
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                branchVM = VMLoad();
                sqlResults = branchDal.InsertBranchName(branchVM,connVM);
                //sqlResults = branchDal.InsertBranchName(NextID.ToString(), txtName.Text.Trim(), txtDBName.Text.Trim(), txtAddress.Text.Trim());
        ...
        private void FormBranchName_Load(object sender, EventArgs e)
        {
        ...
        private void searchDT()
        {
            try
            {
                ...
                BrNameResult = _dal.SearchBranchName(txtName.Text.Trim(),connVM);

                dgvBranchHistory.Rows.Clear();
                int j = 0;
                foreach (DataRow item in BrNameResult.Rows)
                {
                    ...
                    dgvBranchHistory.Rows[j].Cells["BrAddress"].Value = item["BrAddress"].ToString();
                    j = j + 1;
                }
            }
            #region catch
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                BranchVM branchVM = new BranchVM();
                branchVM = VMLoad();
                sqlResults = _dal.UpdateBranchName(branchVM,connVM);
        ...
        private void FormBranchName_FormClosing(object sender, FormClosingEventArgs e)
        {
            #region Try
            try
            {
            ...
            {
                FileLogger.Log(this.Name, "FormBranchName_FormClosing", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            catch (SoapHeaderException ex)
            {
                ...
                FileLogger.Log(this.Name, "FormBranchName_FormClosing", exMessage);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        {
            FormBranchName frm = new FormBranchName();
            frm.Show();
        }
