...
namespace VATClient
{
    ...
    public partial class FormTDSs : Form
    {
        ...
        {
            if (txtTDSCode.Text.Trim() == "")
            {
                MessageBox.Show("Please enter TDS Code.", this.Text);
                txtTDSCode.Focus();
                return 1;
            }
        ...
        private void backgroundWorkerAdd_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                vm.Section = txtSection.Text.Trim();
                ...
                sqlResults = TDSDAL.InsertToTDSsNew(vm,false,null,null,connVM);
        ...
        private void backgroundWorkerUpdate_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                vm.IsArchive = chkIsArchive.Checked;
                sqlResults = TDSDAL.UpdateToTDSsNew(vm,connVM);
        ...
        private void btnPrev_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ds = ReportDSdal.TDSReport(connVM);
        ...
        private void backgroundWorkerDelete_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                ...
                sqlResults = TDSDAL.Delete(vm, ids,null,null,connVM);
                // End DoWork
