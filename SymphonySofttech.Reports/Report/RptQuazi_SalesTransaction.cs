...
namespace SymphonySofttech.Reports.Report {
    ...
    public class RptQuazi_SalesTransaction : ReportClass {
        
        public RptQuazi_SalesTransaction() {
        }
        
        public override string ResourceName {
            get {
                return "RptQuazi_SalesTransaction.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymphonySofttech.Reports.Report.RptQuazi_SalesTransaction.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptQuazi_SalesTransaction : Component, ICachedReport {
        
        public CachedRptQuazi_SalesTransaction() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptQuazi_SalesTransaction rpt = new RptQuazi_SalesTransaction();
            rpt.Site = this.Site;
            return rpt;
        }
