...
{
    public class BureauSaleDAL : IBureauSale
    {
        ...
        public string[] SalesInsert(SaleMasterVM Master, List<BureauSaleDetailVM> Details, SqlTransaction Vtransaction, SqlConnection VcurrConn, SysDBInfoVMTemp connVM = null)
        {
            var tt = "";
            #region Initializ
            ...
            try
            {
                ...
                if (Master.TransactionType == "Other")
                {
                    newID = commonDal.TransactionCode("Sale", "Other", "SalesInvoiceHeaders", "SalesInvoiceNo",
                                              "InvoiceDateTime", Master.InvoiceDateTime, Master.BranchId.ToString(), currConn, transaction);
                }
                ...
                cmdInsert.Parameters.AddWithValue("@BranchId", Master.BranchId);
                cmdInsert.Parameters.AddWithValueAndNullHandle("@MasterPreviousSalesInvoiceNo", Master.PreviousSalesInvoiceNo ?? Convert.DBNull);
                cmdInsert.Parameters.AddWithValueAndNullHandle("@MasterTrading", Master.Trading ?? Convert.DBNull);
                cmdInsert.Parameters.AddWithValue("@MasterIsPrint", Master.IsPrint);
                cmdInsert.Parameters.AddWithValueAndNullHandle("@MasterTenderId", Master.TenderId);
                ...
                cmdInsert.Parameters.AddWithValueAndNullHandle("@MasterImportID", Master.ImportIDExcel ?? Convert.DBNull);
                ...
                foreach (var Item in Details.ToList())
                {
                    ...
                    cmdInsDetail.Parameters.AddWithValue("@MasterCustomerID", Master.CustomerID);
                    ...
                    cmdInsDetail.Parameters.AddWithValue("@BranchId",Master.BranchId);
                    ...
                    cmdInsDetail.Parameters.AddWithValue("@ItemType",Master.Type ?? Convert.DBNull);
                    ...
                    cmdInsDetail.Parameters.AddWithValue("@ItemBureauId", Item.BureauId ?? Convert.DBNull);
                    ...
                    //cmdInsDetail.Parameters.AddWithValue("@CPCName", Item.CPCName);
                    //cmdInsDetail.Parameters.AddWithValue("@HSCode", Item.HSCode);
...
";
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("BureauSaleDAL", "SalesInsert", ex.ToString() + "\n" + sqlText);
            ...
            try
            {
                ...
                foreach (var Item in Details.ToList())
                {
                    ...
                    if (IDExist <= 0)
                    {
                        ...
                        cmdInsDetail.Parameters.AddWithValue("@ItemInvoiceCurrency", Item.InvoiceCurrency);
                        cmdInsDetail.Parameters.AddWithValue("@ItemCConversionDate", Item.CConversionDate);
                        cmdInsDetail.Parameters.AddWithValue("@PreviousInvoiceDateTime", Item.PreviousInvoiceDateTime);
                        cmdInsDetail.Parameters.AddWithValue("@PreviousNBRPrice", Item.PreviousNBRPrice);
                        cmdInsDetail.Parameters.AddWithValue("@PreviousQuantity", Item.PreviousQuantity);
                        cmdInsDetail.Parameters.AddWithValue("@PreviousSubTotal", Item.PreviousSubTotal);
                        cmdInsDetail.Parameters.AddWithValue("@PreviousVATAmount", Item.PreviousVATAmount);
                        cmdInsDetail.Parameters.AddWithValue("@CPCName", Item.CPCName);
                        cmdInsDetail.Parameters.AddWithValue("@HSCode", Item.HSCode);
                        cmdInsDetail.Parameters.AddWithValue("@ItemReturnTransactionType", Item.ReturnTransactionType ?? Convert.DBNull);
                        cmdInsDetail.Parameters.AddWithValue("@ItemPreviousSalesInvoiceNo", Item.PreviousSalesInvoiceNo ?? Convert.DBNull);
                    ...
                    else
                    {
                        ...
                        sqlText += " Post           =@MasterPost,";
                        //sqlText += " CPCName        =@CPCName,";
                        //sqlText += " HSCode         =@HSCode,";
                        sqlText += " CConversionDate=@ItemCConversionDate,";
                        sqlText += " PreviousInvoiceDateTime=@PreviousInvoiceDateTime,";
                        sqlText += " PreviousNBRPrice=@PreviousNBRPrice,";
                        sqlText += " PreviousQuantity=@PreviousQuantity,";
                        sqlText += " PreviousSubTotal=@PreviousSubTotal,";
                        sqlText += " PreviousVATAmount=@PreviousVATAmount";
                        ...
                        cmdInsDetail.Parameters.AddWithValue("@ItemCConversionDate", Item.CConversionDate);
                        cmdInsDetail.Parameters.AddWithValue("@ItemReturnTransactionType", Item.ReturnTransactionType ?? Convert.DBNull);
                        cmdInsDetail.Parameters.AddWithValue("@MasterPreviousSalesInvoiceNo", Item.PreviousSalesInvoiceNo ?? Convert.DBNull);
                        cmdInsDetail.Parameters.AddWithValue("@MasterSalesInvoiceNo", Master.SalesInvoiceNo ?? Convert.DBNull);
                        cmdInsDetail.Parameters.AddWithValue("@ItemInvoiceName", Item.InvoiceName ?? Convert.DBNull);
                        cmdInsDetail.Parameters.AddWithValue("@PreviousInvoiceDateTime", Item.PreviousInvoiceDateTime);
                        cmdInsDetail.Parameters.AddWithValue("@PreviousNBRPrice", Item.PreviousNBRPrice);
...
";
            ...
            catch (SqlException sqlex)
            {
                ...
                transaction.Rollback();
                FileLogger.Log("BureauSaleDAL", "SalesUpdate", sqlex.ToString() + "\n" + sqlText);
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("BureauSaleDAL", "SalesUpdate", ex.ToString() + "\n" + sqlText);
        ...
        public string[] SalesPost(SaleMasterVM Master, List<BureauSaleDetailVM> Details, SysDBInfoVMTemp connVM = null)
        {
            ...
            catch (SqlException sqlex)
            {
                ...
                FileLogger.Log("BureauSaleDAL", "SalesPost", sqlex.ToString() + "\n" + sqlText);
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("BureauSaleDAL", "SalesPost", ex.ToString() + "\n" + sqlText);
        ...
        public DataTable SearchSaleDetailDTNew(string SalesInvoiceNo, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                sqlText = @"
                           ...
                           -- isnull(BureauSalesInvoiceDetails.CPCName,'-')CPCName,
                           -- isnull(BureauSalesInvoiceDetails.HSCode,'-')HSCode,

                            convert (varchar,isnull(BureauSalesInvoiceDetails.CConversionDate,'01/01/1900'),120) CConversionDate,

                            isnull(BureauSalesInvoiceDetails.PreviousInvoiceDateTime,'01/01/1900')PreviousInvoiceDateTime,
                            isnull(BureauSalesInvoiceDetails.PreviousNBRPrice,'0')PreviousNBRPrice,
                            isnull(BureauSalesInvoiceDetails.PreviousQuantity,'0')PreviousQuantity,
                            isnull(BureauSalesInvoiceDetails.PreviousSubTotal,'0')PreviousSubTotal,
                            isnull(BureauSalesInvoiceDetails.PreviousVATAmount,'0')PreviousVATAmount,
                            isnull(BureauSalesInvoiceDetails.PreviousVATRate,'0')PreviousVATRate,
                            isnull(BureauSalesInvoiceDetails.PreviousSD,'0')PreviousSD,
                            isnull(BureauSalesInvoiceDetails.PreviousSDAmount,'0')PreviousSDAmount,
                            isnull(BureauSalesInvoiceDetails.PreviousUOM,'-')PreviousUOM,
                            isnull(BureauSalesInvoiceDetails.ReasonOfReturn,'-')ReasonOfReturn
            ...
            {
                FileLogger.Log("BureauSaleDAL", "SearchSaleDetailDTNew", sqlex.ToString() + "\n" + sqlText);
            ...
            {
                FileLogger.Log("BureauSaleDAL", "SearchSaleDetailDTNew", ex.ToString() + "\n" + sqlText);
        ...
        private int UpdatIssueAvgPrice(string invoiceNo, string itemNo, decimal avgPrice, SysDBInfoVMTemp connVM = null)
        {
            ...
            {
                FileLogger.Log("BureauSaleDAL", "UpdatIssueAvgPrice", sqlex.ToString() + "\n" + sqlText);
            ...
            {
                FileLogger.Log("BureauSaleDAL", "UpdatIssueAvgPrice", ex.ToString() + "\n" + sqlText);
        ...
        public string[] ImportInspectionData(DataTable dtSaleM, string noOfSale, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                BranchId = Convert.ToInt32(dtSaleM.Rows[0]["BranchId"].ToString());
                Type = dtSaleM.Rows[0]["Type"].ToString().Trim();
                ...
                //challanDate = InvoiceDate; // 20240201
                ...
                foreach (DataRow buItem in dtBuIds.Rows)
                {
                    ...
                    DataTable dtCustomers = dtIndivisualBuIds.DefaultView.ToTable(true, "CLIENT", "MONTH");
                    ...
                    foreach (DataRow custRows in dtCustomers.Rows)
                    {
                        ...
                        if (dtIndivisualBuIds.Select("[CLIENT] ='" + custRows["CLIENT"].ToString() + "'").Length > 0)
                        {
                            dtCustomerInfos = dtIndivisualBuIds.Select("[CLIENT] ='" + custRows["CLIENT"].ToString() + "' and " +
                                             "[MONTH] ='" + custRows["MONTH"].ToString() + "' and "
                        ...
                        foreach (DataRow detailRow in dtDistinctInvoices.Rows)
                        {
                            ...
                            //// add 20240201
                            if (!string.IsNullOrEmpty(dtRepeatedInvoices.Rows[0]["Month"].ToString().Trim()))
                            {
                                try
                                {
                                    if (!string.IsNullOrEmpty(dtRepeatedInvoices.Rows[0]["Month"].ToString().Trim()))
                                    {
                                        InvoiceDate = Convert.ToDateTime(dtRepeatedInvoices.Rows[0]["Month"].ToString().Trim()).ToString("yyyy-MM-dd");
                                    }
                                }
                                catch (Exception ex)
                                {
                            ...
                            //DataTable dtRepeatedInvoices = dtAllInvoices.Select("[INVOICE NO] ='" + detailRow["INVOICE NO"].ToString() + "'").CopyToDataTable(); // 20240201
                            ...
                            saleMaster.Type = Type;
                            saleMaster.BranchId = BranchId;
                            //saleMaster.Type = BranchId;
                ...
                if (dtCreditRow.Length > 0)
                {
                    var result = UpdatePreviousCreditNo(currConn, transaction);
                    retResults[0] = result[0];
                }
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("BureauSaleDAL", "ImportInspectionData", ex.ToString());
            }
            finally
            {
                if (currConn.State == ConnectionState.Open)
        ...
        //currConn to VcurrConn 25-Aug-2020
        public string[] InsertCreditInfo(DataTable dtCredit, SqlConnection VcurrConn, SqlTransaction Vtransaction, SysDBInfoVMTemp connVM = null)
        {
            #region variable
            string[] retResults = new string[4];
            retResults[0] = "Fail";
            ...
            try
            {
                ...
                foreach (DataRow buItem in dtBuIds.Rows)
                {
                    ...
                    foreach (DataRow custRows in dtCustomers.Rows)
                    {
                        ...
                        saleMaster.BranchId = Convert.ToInt32(dr["BranchId"]);
            ...
            catch (SqlException sqlex)
            {
                ...
                FileLogger.Log("BureauSaleDAL", "InsertCreditInfo", sqlex.ToString());
            ...
            {
                retResults[0] = "Fail";
                retResults[1] = aeg.Message;

                FileLogger.Log("BureauSaleDAL", "InsertCreditInfo", aeg.ToString());
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("BureauSaleDAL", "InsertCreditInfo", ex.ToString());
...
Drop Table TempCredit
            ...
            {
                FileLogger.Log("BureauSaleDAL", "UpdateCreditNo", sqlex.ToString() + "\n" + sqlText);
            ...
            {
                FileLogger.Log("BureauSaleDAL", "UpdateCreditNo", ex.ToString() + "\n" + sqlText);
        ...
        public string [] UpdatePreviousCreditNo(SqlConnection VcurrConn, SqlTransaction Vtransaction, SysDBInfoVMTemp connVM = null)
        {
            #region Initializ
            string[] retResults = new string[4];
            retResults[0] = "Fail";
...
;with cte as
(
select * from (select *, ROW_NUMBER() over(partition by InvoiceName order by invoiceName)Row_no from BureauSalesInvoiceDetails
where TransactionType = 'ServiceNS')tempsale where Row_no = 1
)

update BureauSalesInvoiceDetails 
set 
PreviousNBRPrice = sale.SalesPrice
,PreviousInvoiceDateTime = sale.InvoiceDateTime
,PreviousSalesInvoiceNo = sale.SalesInvoiceNo
,PreviousQuantity = sale.Quantity
,PreviousSubTotal = sale.SubTotal
,PreviousVATAmount = sale.VATAmount
,PreviousVATRate = sale.VATRate
,PreviousSD = sale.SD
,PreviousSDAmount = sale.SDAmount
,ReasonOfReturn = 'NA'
,PreviousUOM = sale.UOM

from 

BureauSalesInvoiceDetails bd

join 

cte as Sale

on bd.InvoiceName = sale.InvoiceName and bd.ItemNo = sale.ItemNo

where bd.TransactionType = 'credit' and bd.PreviousQuantity is null
                        ";
            ...
            {
                FileLogger.Log("BureauSaleDAL", "UpdatePreviousCreditNo", ex.ToString() + "\n" + sqlText);
            ...
            {
                if (currConn != null && Vtransaction==null)
                {
                    if (currConn.State == ConnectionState.Open)
                    {
                        currConn.Close();
        ...
        public DataTable SearchSaleExportDTNew(string SalesInvoiceNo, string databaseName, SysDBInfoVMTemp connVM = null)
        {
            ...
            catch (SqlException sqlex)
            {
                ...
                FileLogger.Log("BureauSaleDAL", "SearchSaleExportDTNew", sqlex.ToString() + "\n" + sqlText);
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("BureauSaleDAL", "SearchSaleExportDTNew", ex.ToString() + "\n" + sqlText);
        ...
        public string[] UpdatePrintNew(string InvoiceNo, int PrintCopy, SysDBInfoVMTemp connVM = null)
        {
            ...
            catch (SqlException sqlex)
            {
                ...
                FileLogger.Log("BureauSaleDAL", "UpdatePrintNew", sqlex.ToString() + "\n" + sqlText);
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("BureauSaleDAL", "UpdatePrintNew", ex.ToString() + "\n" + sqlText);
        ...
        public DataTable SearchSalesHeaderDTNew(string SalesInvoiceNo, string CustomerName, string CustomerGroupName, string VehicleType, string VehicleNo, string SerialNo, string InvoiceDateFrom, string InvoiceDateTo, string SaleType, string Trading, string IsPrint, string transactionType, string Post, SysDBInfoVMTemp connVM = null)
        {
            ...
            {
                FileLogger.Log("BureauSaleDAL", "SearchSalesHeaderDTNew", sqlex.ToString() + "\n" + sqlText);
            ...
            {
                FileLogger.Log("BureauSaleDAL", "SearchSalesHeaderDTNew", ex.ToString() + "\n" + sqlText);
        ...
        public int LoadIssueItems(SysDBInfoVMTemp connVM = null,string UserId="")
        {
            ...
            {
                FileLogger.Log("BureauSaleDAL", "LoadIssueItems", sqlex.ToString() + "\n" + sqlText);
            ...
            {
                FileLogger.Log("BureauSaleDAL", "LoadIssueItems", ex.ToString() + "\n" + sqlText);
        ...
        //currConn to VcurrConn 25-Aug-2020
        public string[] SalesInsertImport(SaleMasterVM Master, List<SaleDetailVm> Details, List<SaleExportVM> ExportDetails, SqlTransaction Vtransaction, SqlConnection VcurrConn, SysDBInfoVMTemp connVM = null, string UserId = "")
        {
            #region Initializ
            string[] retResults = new string[4];
            retResults[0] = "Fail";
            ...
            try
            {
                ...
                cmdInsert.Parameters.AddWithValue("@commonDaldecimalMasterCurrencyRateFromBDT", commonDal.decimal259(Master.CurrencyRateFromBDT));
                cmdInsert.Parameters.AddWithValue("@MasterImportID", Master.ImportIDExcel);
                ...
                foreach (var Item in Details.ToList())
                {
                    ...
                    decimal AvgRate = 0;
                    DataTable priceData = productDal.AvgPriceNew(Item.ItemNo, Master.InvoiceDateTime, currConn, transaction, false,true,true,true,null,UserId);
                    ...
                    if (Master.TransactionType == "InternalIssue")
                    {
                        ...
                        decimal NBRPrice = productDal.GetLastNBRPriceFromBOM_VatName(Item.ItemNo, "VAT 4.3 (Internal Issue)", Master.InvoiceDateTime, currConn, transaction);
            ...
            catch (SqlException sqlex)
            {
                ...
                FileLogger.Log("BureauSaleDAL", "SalesInsertImport", sqlex.ToString() + "\n" + sqlText);
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("BureauSaleDAL", "SalesInsertImport", ex.ToString() + "\n" + sqlText);
        ...
        public decimal ReturnSaleQty(string saleReturnId, string itemNo, SysDBInfoVMTemp connVM = null)
        {
            ...
            catch (SqlException sqlex)
            {
                ...
                FileLogger.Log("BureauSaleDAL", "ReturnSaleQty", sqlex.ToString() + "\n" + sqlText);
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("BureauSaleDAL", "ReturnSaleQty", ex.ToString() + "\n" + sqlText);
        ...
        public string[] CurrencyInfo(string salesInvoiceNo, SysDBInfoVMTemp connVM = null)
        {
            ...
            catch (SqlException sqlex)
            {
                ...
                FileLogger.Log("BureauSaleDAL", "CurrencyInfo", sqlex.ToString() + "\n" + sqlText);
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("BureauSaleDAL", "CurrencyInfo", ex.ToString() + "\n" + sqlText);
        ...
        public string GetCategoryName(string itemNo, SysDBInfoVMTemp connVM = null)
        {
            ...
            {
                FileLogger.Log("BureauSaleDAL", "GetCategoryName", sqlex.ToString() + "\n" + sqlText);
            ...
            {
                FileLogger.Log("BureauSaleDAL", "GetCategoryName", ex.ToString() + "\n" + sqlText);
        ...
        public DataTable GetProductInfo(SysDBInfoVMTemp connVM = null)
        {
            ...
            {
                FileLogger.Log("BureauSaleDAL", "GetProductInfo", sqlex.ToString() + "\n" + sqlText);
            ...
            {
                FileLogger.Log("BureauSaleDAL", "GetProductInfo", ex.ToString() + "\n" + sqlText);
