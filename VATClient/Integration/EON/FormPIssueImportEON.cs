...
namespace VATClient
{
    public partial class FormPIssueImportEON : Form
    {
        #region Variables
        ...
        {
            FormPIssueImportEON form = new FormPIssueImportEON();
        ...
        private void bgwSaleLoad_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                dtTableResult = eonIntegrationDal.GetPIssueData(param,connVM,null,null,IsProcess);
