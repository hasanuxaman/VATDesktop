    ...
    public partial class FormImportStock : Form
    {
        ...
        private void ProductHeader()
        {
           // string IsPharmaceutical = _cDal.settingsDesktop("Products", "IsPharmaceutical",null,connVM);
            ...
            dataGridView1.Columns[2].Name = "CategoryType";
            dataGridView1.Columns[3].Name = "CategoryName";
            dataGridView1.Columns[4].Name = "ProductCode";
            dataGridView1.Columns[5].Name = "ProductName";
            dataGridView1.Columns[6].Name = "StockQuantity";//s
            dataGridView1.Columns[7].Name = "StockValue";
            dataGridView1.Columns[8].Name = "Comments";
        ...
        private void ProductImport()
        {
            ...
            try
            {
                ...
                if (ds.Tables.Contains("ProductStock"))
                {
                    ...
                    dataGridView1.DataSource = productStock;
                ...
                //    dataGridView1["BranchName", dataGridView1.RowCount - 1].Value =
                //        dt.Rows[i]["BranchName"].ToString();
                //    dataGridView1["CategoryType", dataGridView1.RowCount - 1].Value =
                //        dt.Rows[i]["CategoryType"].ToString();
                //    dataGridView1["CategoryName", dataGridView1.RowCount - 1].Value = dt.Rows[i]["CategoryName"].ToString();
                //    dataGridView1["ProductCode", dataGridView1.RowCount - 1].Value = dt.Rows[i]["ProductCode"].ToString();
                //    dataGridView1["ProductName", dataGridView1.RowCount - 1].Value = dt.Rows[i]["ProductName"].ToString();
                //    //dataGridView1["OpeningQuantity", dataGridView1.RowCount - 1].Value =dt.Rows[i]["OpeningQuantity"].ToString();
                //    dataGridView1["StockQuantity", dataGridView1.RowCount - 1].Value = dt.Rows[i]["StockQuantity"].ToString();
                //    dataGridView1["StockValue", dataGridView1.RowCount - 1].Value = dt.Rows[i]["StockValue"].ToString();
        ...
        private void bgwProduct_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                sqlResults = importDal.ImportProductStock(productStock);               
