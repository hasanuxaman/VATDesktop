...
{
    public partial class FormRptTollStock : Form
    {
        public FormRptTollStock()
        {
            InitializeComponent();
        ...
        private void backgroundWorkerPreview_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                ...
                ReportResult = productDal.TollStockMovement(vm, null, null, connVM);
...
//#endregion
        ...
        private void ExcelPreview()
        {
            try
            {
                ...
                ParamFromDate = dtpFromDate.Checked ? dtpFromDate.Value.ToString("dd-MMM-yyyy").ToString() : "All";

                ParamToDate = dtpToDate.Checked ? dtpToDate.Value.ToString("dd-MMM-yyyy").ToString() : "All";
