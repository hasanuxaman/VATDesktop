...
namespace SymphonySofttech.Reports.Report {
    ...
    public class RptScblTransferDepot : ReportClass {
        
        public RptScblTransferDepot() {
        }
        
        public override string ResourceName {
            get {
                return "RptScblTransferDepot.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymphonySofttech.Reports.Report.RptScblTransferDepot.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptScblTransferDepot : Component, ICachedReport {
        
        public CachedRptScblTransferDepot() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptScblTransferDepot rpt = new RptScblTransferDepot();
            rpt.Site = this.Site;
            return rpt;
        }
