...
namespace VATClient
{
    public partial class FormAdjustmentName : Form
    {
        
        public FormAdjustmentName()
        {
            InitializeComponent();
            #region connVM
        ...
        private int ErrorReturn()
        {
            #region try
                ...
                if (string.IsNullOrEmpty(txtAdjName.Text.Trim()))
                {
                    MessageBox.Show("Please enter Adjust Head Name.");
                    txtAdjName.Focus();
                    return 1;
                }
        ...
        private void backgroundWorkerAdd_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                ...
                //sqlResults = adjustmentDal.InsertAdjustmentName(NextID.ToString(), txtAdjName.Text.Trim(),
                //                                                txtComments.Text.Trim(), activeStatus,
                //                                                Program.CurrentUser.ToString(), DateTime.Now.ToString("yyyy-MMM-dd HH:mm:ss"),
                ...
                vm.AdjId=NextID.ToString();
                vm.AdjName=txtAdjName.Text.Trim();
                ...
                sqlResults = adjustmentDal.InsertAdjustmentName(vm,connVM);
        ...
        private void FormAdjustmentName_Load(object sender, EventArgs e)
        {
        ...
        private void backgroundWorkerUpdate_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                ...
                //sqlResults = adjustmentDal.UpdateAdjustmentName(NextID.ToString(), txtAdjName.Text.Trim(),
                //                                                txtComments.Text.Trim(), activeStatus,
                //                                                Program.CurrentUser.ToString(), DateTime.Now.ToString("yyyy-MMM-dd HH:mm:ss"),
                //                                                Program.CurrentUser, DateTime.Now.ToString("yyyy-MMM-dd HH:mm:ss"));
                ...
                sqlResults = adjustmentDal.UpdateAdjustmentName(vm,connVM);
        ...
        private int DataAlreadyUsed()
        {
            ...
            try
            {
                ...
                if (commonDal.DataAlreadyUsed("AdjustmentHistorys", "AdjId", txtAdjId.Text.Trim(), null, null) != 0)
                {
                    MessageBox.Show(MessageVM.msgDataAlreadyUsed + " Adjustment" + MessageVM.msgDeleteOperationterminated, this.Text);
                    return 1;
                }
        ...
        private void backgroundWorkerDelete_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                //AdjustmentDAL adjustmentDal = new AdjustmentDAL();
                IAdjustment adjustmentDal = OrdinaryVATDesktop.GetObject<AdjustmentDAL, AdjustmentRepo, IAdjustment>(OrdinaryVATDesktop.IsWCF);
                string adjId = OrdinaryVATDesktop.SanitizeInput(txtAdjId.Text.Trim());
                sqlResults = adjustmentDal.DeleteAdjustmentName(adjId, connVM);
        ...
        private void btnVendorGroup_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (selectedRow != null && selectedRow.Selected == true)
                {
                    ...
                    txtAdjName.Text = selectedRow.Cells["AdjName"].Value.ToString();
                    txtComments.Text = selectedRow.Cells["Comments"].Value.ToString();
                    chkActiveStatus.Checked = selectedRow.Cells["ActiveStatus"].Value.ToString() == "" +
                                              "Y" ? true : false;
                }
                ChangeData = false;
            }
        ...
        private void FormAdjustmentName_FormClosing(object sender, FormClosingEventArgs e)
        {
            #region Try
            try
            {
            ...
            {
                FileLogger.Log(this.Name, "FormAdjustmentName_FormClosing", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            catch (SoapHeaderException ex)
            {
                ...
                FileLogger.Log(this.Name, "FormAdjustmentName_FormClosing", exMessage);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
