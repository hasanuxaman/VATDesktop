...
namespace VATClient
{
    public partial class FormImport : Form
    {
        ...
        List<PurchaseTDSsVM> _PurchaseTDSsVMs = new List<PurchaseTDSsVM>();
        ...
        private void ProductHeader()
        {
            ...
            dataGridView1.Columns[17].Name = "CostPrice";
            dataGridView1.Columns[18].Name = "NonStock";
            //dataGridView1.Columns[17].Name = "QuantityInHand";
            dataGridView1.Columns[19].Name = "OpeningDate";
            dataGridView1.Columns[20].Name = "TollCharge";
            dataGridView1.Columns[21].Name = "NBRPrice";
            dataGridView1.Columns[22].Name = "IsConfirmed";
            dataGridView1.Columns[23].Name = "ReportType";
            dataGridView1.Columns[24].Name = "IsFixedVATRebate";

            if (IsPharmaceutical == "Y")
            {
                dataGridView1.Columns[25].Name = "GenericName";
                dataGridView1.Columns[26].Name = "DARNo";
            }
        ...
        private void TradingProductHeader()
        {
            ...
            dataGridView1.Columns[21].Name = "NBRPrice";
            dataGridView1.Columns[22].Name = "IsConfirmed";
            dataGridView1.Columns[23].Name = "TradingSaleVATRate";
            dataGridView1.Columns[24].Name = "TradingSaleSD";
            dataGridView1.Columns[25].Name = "ReportType";


            if (IsPharmaceutical == "Y")
            {
                dataGridView1.Columns[26].Name = "GenericName";
                dataGridView1.Columns[27].Name = "DARNo";
            }
        ...
        public static DataTable EmptyRowCheckAndDeleteX(DataTable table, List<ErrorMessage> msgs)
        {
            bool emptyRow = false;
            bool dataRow = false;
        ...
        private void ProductImport()
        {
            ...
            try
            {
                ...
                dt = ds.Tables[0];
                OrdinaryVATDesktop.EmptyRowCheckAndDelete(dt, errormessage);
                ...
                if (ds.Tables.Contains("ProductDetails"))
                {
                    ...
                    OrdinaryVATDesktop.EmptyRowCheckAndDelete(productDetails, errormessage);
                    if (errormessage.Count > 0)
                    {
                        FormErrorMessage.ShowDetails(errormessage);
                        btnSave.Enabled = false;
                ...
                if (ds.Tables.Contains("ProductStock"))
                {
                    ...
                    OrdinaryVATDesktop.EmptyRowCheckAndDelete(productStock, errormessage);
                    if (errormessage.Count > 0)
                    {
                        FormErrorMessage.ShowDetails(errormessage);
                        btnSave.Enabled = false;
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    dataGridView1["TradingMarkUp", dataGridView1.RowCount - 1].Value =
                        dt.Rows[i]["TradingMarkUp"].ToString();
                    dataGridView1["CostPrice", dataGridView1.RowCount - 1].Value =
                       dt.Rows[i]["CostPrice"].ToString();
                    ...
                    dataGridView1["IsFixedVATRebate", dataGridView1.RowCount - 1].Value = dt.Rows[i]["IsFixedVATRebate"].ToString();
                    ...
                    string reportType = dt.Rows[i]["ReportType"].ToString();

                    if (reportType == "VAT6_1" || reportType == "VAT6_2" || reportType == "VAT6_2_1" || reportType == "VAT6_1_And_6_2")
                    {
                        dataGridView1["ReportType", dataGridView1.RowCount - 1].Value = dt.Rows[i]["ReportType"].ToString();
                    }
                    else
                    {
                        throw new Exception("Incorrect Report Type Product Code : " + dt.Rows[i]["Code"].ToString());
                    }
                ...
                if (IsTracking == "Y")
                {
                    ...
                    OrdinaryVATDesktop.EmptyRowCheckAndDelete(dtTrack, errormessage);
                    if (errormessage.Count > 0)
                    {
                        FormErrorMessage.ShowDetails(errormessage);
                    }
        ...
        private void CustomerImport()
        {
            ...
            try
            {
                ...
                if (ds.Tables.Contains("CustomerAddress"))
                {
                    ...
                    OrdinaryVATDesktop.EmptyRowCheckAndDelete(customerAddress, errormessage);
                    if (errormessage.Count > 0)
                    {
                        FormErrorMessage.ShowDetails(errormessage);
                        btnSave.Enabled = false;
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    dataGridView1["IsTax", dataGridView1.RowCount - 1].Value = dt.Rows[i]["IsTax"].ToString();
                }
                //theConnection.Close();
        ...
        private void CustomerHeader()
        {
            ...
            dataGridView1.Columns[24].Name = "IsTax";
        }
        ...
        private void BranchProfilesImport()
        {
            ...
            try
            {
                ...
                if (ds.Tables.Contains("BranchMapDetails"))
                {
                    ...
                    OrdinaryVATDesktop.EmptyRowCheckAndDelete(BranchDetails, errormessage);
                    if (errormessage.Count > 0)
                    {
                        FormErrorMessage.ShowDetails(errormessage);
                        btnSave.Enabled = false;
        ...
        private void PurchaseTDSHeader()
        {
            ...
            dataGridView1.Columns[0].Name = "Sl";
            dataGridView1.Columns[1].Name = "PurchaseInvoiceNo";
            dataGridView1.Columns[2].Name = "TDSCode";
            dataGridView1.Columns[3].Name = "PurchaseBillAmount";
            dataGridView1.Columns[4].Name = "TDSAmount";

        }


        private void PurchaseTDSImport()
        {
            DataSet ds = new DataSet();
            System.Data.DataTable dt = new System.Data.DataTable();
            #region try
            ...
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    dataGridView1.Rows.Add(NewRow);
                    dataGridView1["Sl", dataGridView1.RowCount - 1].Value = i + 1;
                    dataGridView1["PurchaseInvoiceNo", dataGridView1.RowCount - 1].Value = dt.Rows[i]["PurchaseInvoiceNo"].ToString();
                    dataGridView1["TDSCode", dataGridView1.RowCount - 1].Value = dt.Rows[i]["TDSCode"].ToString();
                    dataGridView1["PurchaseBillAmount", dataGridView1.RowCount - 1].Value = dt.Rows[i]["PurchaseBillAmount"].ToString();
                    dataGridView1["TDSAmount", dataGridView1.RowCount - 1].Value = dt.Rows[i]["TDSAmount"].ToString();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                FileLogger.Log(this.Name, "PurchaseTDSImport", exMessage);
            }
        ...
        private void ProductSave()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < dataGridView1.RowCount; i++)
                {
                    ...
                    product.ProductName = Program.RemoveStringExpresion(dataGridView1.Rows[i].Cells["ProductName"].Value.ToString());
                    product.ProductDescription = dataGridView1.Rows[i].Cells["Description"].Value.ToString();
                    product.CategoryName = dataGridView1.Rows[i].Cells["Group"].Value.ToString();
                    product.UOM = dataGridView1.Rows[i].Cells["UOM"].Value.ToString();

                    string tprice = dataGridView1.Rows[i].Cells["TotalPrice"].Value.ToString();
                    string opbalance = dataGridView1.Rows[i].Cells["OpeningQuantity"].Value.ToString();
                    string nbrPrice = dataGridView1.Rows[i].Cells["NBRPrice"].Value.ToString();
                    ...
                    //else
                    //{
                    //    product.CostPrice =Convert.ToDecimal(tprice)/ Convert.ToDecimal(opbalance);//Convert.ToDecimal(dataGridView1.Rows[i].Cells["TotalPrice"].Value.ToString());
                    //    //product.OpeningBalance = Convert.ToDecimal(opbalance);// Convert.ToDecimal(dataGridView1.Rows[i].Cells["OpeningQuantity"].Value.ToString());
                    //}

                    product.OpeningBalance = Convert.ToDecimal(opbalance);
                    product.OpeningTotalCost = Convert.ToDecimal(tprice);// Convert.ToDecimal(dataGridView1.Rows[i].Cells["OpeningQuantity"].Value.ToString());
                    product.SerialNo = dataGridView1.Rows[i].Cells["RefNo"].Value.ToString();
                    product.HSCodeNo = dataGridView1.Rows[i].Cells["HSCode"].Value.ToString();
                    product.VATRate = Convert.ToDecimal(dataGridView1.Rows[i].Cells["VATRate"].Value.ToString());
                    product.Comments = dataGridView1.Rows[i].Cells["Comments"].Value.ToString();
                    product.ActiveStatus = dataGridView1.Rows[i].Cells["ActiveStatus"].Value.ToString();
                    product.SD = Convert.ToDecimal(dataGridView1.Rows[i].Cells["SDRate"].Value.ToString());
                    product.Packetprice = Convert.ToDecimal(dataGridView1.Rows[i].Cells["PacketPrice"].Value.ToString());
                    product.Trading = dataGridView1.Rows[i].Cells["Trading"].Value.ToString();
                    product.TradingMarkUp = Convert.ToDecimal(dataGridView1.Rows[i].Cells["TradingMarkUp"].Value.ToString());
                    product.CostPrice = Convert.ToDecimal(dataGridView1.Rows[i].Cells["CostPrice"].Value.ToString());
                    product.NonStock = dataGridView1.Rows[i].Cells["NonStock"].Value.ToString();
                    product.OpeningDate = Convert.ToDateTime(dataGridView1.Rows[i].Cells["OpeningDate"].Value.ToString()).ToString("yyyy-MMM-dd HH:mm:ss");
                    product.CreatedBy = Program.CurrentUser;
                    product.CreatedOn = DateTime.Now.ToString("yyyy-MMM-dd HH:mm:ss");
                    product.ProductCode = Program.RemoveStringExpresion(dataGridView1.Rows[i].Cells["Code"].Value.ToString());
                    product.TollCharge = Convert.ToDecimal(dataGridView1.Rows[i].Cells["TollCharge"].Value.ToString());
                    product.IsConfirmed = dataGridView1.Rows[i].Cells["IsConfirmed"].Value.ToString();
                    product.BranchId = Program.BranchId;
                    product.NBRPrice = Convert.ToDecimal(nbrPrice);
                    product.ReportType = dataGridView1.Rows[i].Cells["ReportType"].Value.ToString();
                    product.IsFixedVATRebate = dataGridView1.Rows[i].Cells["IsFixedVATRebate"].Value.ToString();

                    if (IsPharmaceutical == "Y")
                    {
                        product.GenericName = dataGridView1.Rows[i].Cells["GenericName"].Value.ToString();
                        product.DARNo = dataGridView1.Rows[i].Cells["DARNo"].Value.ToString();
                    }
                    else
                    {
                        product.GenericName = "-";
            ...
            {
                FileLogger.Log(this.Name, "ProductSave", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void TradingProductSave()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < dataGridView1.RowCount; i++)
                {
                    ...
                    product.BranchId = Program.BranchId;
                    product.NBRPrice = Convert.ToDecimal(nbrPrice);
                    product.TradingSaleVATRate = Convert.ToDecimal(dataGridView1.Rows[i].Cells["TradingSaleVATRate"].Value.ToString());
                    product.TradingSaleSD = Convert.ToDecimal(dataGridView1.Rows[i].Cells["TradingSaleSD"].Value.ToString());
                    product.ReportType = dataGridView1.Rows[i].Cells["ReportType"].Value.ToString();
            ...
            {
                FileLogger.Log(this.Name, "TradingProductSave", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            catch (SoapHeaderException ex)
            {
                ...
                FileLogger.Log(this.Name, "TradingProductSave", exMessage);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void bgwProduct_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                #region statement
                ...
                sqlResults = importDal.ImportProduct(products, trackings, productDetailsvm, productStock, connVM);
        ...
        private void bgwProduct_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                ...
                if (SAVE_DOWORK_SUCCESS)
                    if (sqlResults.Length > 0)
                    {
                        ...
                        {
                            throw new ArgumentNullException("bgwProduct_RunWorkerCompleted",
                                                            "Unexpected error.");
                        }
        ...
        private void ProductOpeningSave()
        {
            ...
            try
            {
                ...
                {
                    ProductVM product = new ProductVM();
                    product.ItemNo = dataGridView1.Rows[i].Cells["ItemNo"].Value.ToString();
                    product.ProductCode = Program.RemoveStringExpresion(dataGridView1.Rows[i].Cells["ProductCode"].Value.ToString());
                    product.OpeningBalance = Convert.ToDecimal(dataGridView1.Rows[i].Cells["OpeningBalance"].Value.ToString());
                    product.OpeningTotalCost = Convert.ToDecimal(dataGridView1.Rows[i].Cells["OpeningTotalCost"].Value.ToString());
                    product.OpeningDate = Convert.ToDateTime(dataGridView1.Rows[i].Cells["OpeningDate"].Value.ToString()).ToString("yyyy-MMM-dd HH:mm:ss");
                    product.CreatedBy = Program.CurrentUser;
                    product.CreatedOn = DateTime.Now.ToString("yyyy-MMM-dd HH:mm:ss");
                    product.LastModifiedBy = Program.CurrentUser;
                    product.LastModifiedOn = DateTime.Now.ToString("yyyy-MMM-dd HH:mm:ss");
                    product.BranchId = Program.BranchId;
                    products.Add(product);
                ...
                this.btnSave.Enabled = false;
                this.progressBar1.Visible = true;
                bgwProductOpening.RunWorkerAsync();
            ...
            {
                FileLogger.Log(this.Name, "CustomerSave", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            catch (SoapHeaderException ex)
            {
                ...
                FileLogger.Log(this.Name, "CustomerSave", exMessage);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void CustomerSave()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < dataGridView1.RowCount; i++)
                {
                    ...
                    customer.CustomerName = Program.RemoveStringExpresion(dataGridView1.Rows[i].Cells["CustomerName"].Value.ToString());
                    customer.CustomerCode = Program.RemoveStringExpresion(dataGridView1.Rows[i].Cells["Code"].Value.ToString());
                    customer.CustomerGroup = dataGridView1.Rows[i].Cells["CustomerGroup"].Value.ToString();
                    customer.Address1 = dataGridView1.Rows[i].Cells["Address1"].Value.ToString();
                    //customer.Address2 = dataGridView1.Rows[i].Cells["Address2"].Value.ToString();
                    //customer.Address3 = dataGridView1.Rows[i].Cells["Address3"].Value.ToString();
                    customer.City = dataGridView1.Rows[i].Cells["City"].Value.ToString();
                    customer.TelephoneNo = dataGridView1.Rows[i].Cells["TelephoneNo"].Value.ToString();
                    customer.FaxNo = dataGridView1.Rows[i].Cells["FaxNo"].Value.ToString();
                    customer.Email = dataGridView1.Rows[i].Cells["Email"].Value.ToString();
                    customer.StartDateTime = Convert.ToDateTime(dataGridView1.Rows[i].Cells["StartDateTime"].Value.ToString()).ToString("yyyy-MMM-dd HH:mm:ss");
                    customer.ContactPerson = dataGridView1.Rows[i].Cells["ContactPerson"].Value.ToString();
                    customer.ContactPersonDesignation = dataGridView1.Rows[i].Cells["ContactPersonDesignation"].Value.ToString();
                    customer.ContactPersonTelephone = dataGridView1.Rows[i].Cells["ContactPersonTelephone"].Value.ToString();
                    customer.ContactPersonEmail = dataGridView1.Rows[i].Cells["ContactPersonEmail"].Value.ToString();
                    customer.TINNo = dataGridView1.Rows[i].Cells["TIN"].Value.ToString();
                    customer.VATRegistrationNo = dataGridView1.Rows[i].Cells["VATRegistrationNo"].Value.ToString();
                    customer.Comments = dataGridView1.Rows[i].Cells["Comments"].Value.ToString();
                    customer.ActiveStatus = dataGridView1.Rows[i].Cells["ActiveStatus"].Value.ToString();
                    customer.CreatedBy = Program.CurrentUser;
                    customer.CreatedOn = DateTime.Now.ToString("yyyy-MMM-dd HH:mm:ss");
                    customer.Country = dataGridView1.Rows[i].Cells["Country"].Value.ToString();
                    customer.IsVDSWithHolder = dataGridView1.Rows[i].Cells["IsVDSWithHolder"].Value.ToString();
                    customer.BranchId = Program.BranchId;
                    customer.IsInstitution = dataGridView1.Rows[i].Cells["IsInstitution"].Value.ToString();
                    customer.IsTax = dataGridView1.Rows[i].Cells["IsTax"].Value.ToString();
                    if (string.IsNullOrWhiteSpace(dataGridView1.Rows[i].Cells["IsSpecialRate"].Value.ToString()))
                    {
                        customer.IsSpecialRate = "N";
                    }
                    else
                    {
                        customer.IsSpecialRate = dataGridView1.Rows[i].Cells["IsSpecialRate"].Value.ToString();
                    }
                    customers.Add(customer);

                    #region CustomerData
                    //if (CustomerData == string.Empty)
                    //{
                    //    CustomerData =
                    //        "" + FieldDelimeter +

                    //        dataGridView1.Rows[i].Cells["CustomerName"].Value.ToString() + FieldDelimeter +
                    //        dataGridView1.Rows[i].Cells["CustomerGroup"].Value.ToString() + FieldDelimeter +
                    //        dataGridView1.Rows[i].Cells["Address1"].Value.ToString() + FieldDelimeter +
                    //        dataGridView1.Rows[i].Cells["Address2"].Value.ToString() + FieldDelimeter +
                    //        dataGridView1.Rows[i].Cells["Address3"].Value.ToString() + FieldDelimeter +
                    //        dataGridView1.Rows[i].Cells["City"].Value.ToString() + FieldDelimeter +
                    //        dataGridView1.Rows[i].Cells["TelephoneNo"].Value.ToString() + FieldDelimeter +
                    //        dataGridView1.Rows[i].Cells["FaxNo"].Value.ToString() + FieldDelimeter +
                    //        dataGridView1.Rows[i].Cells["Email"].Value.ToString() + FieldDelimeter +
                    //        dataGridView1.Rows[i].Cells["StartDateTime"].Value.ToString() + FieldDelimeter +
                    //        dataGridView1.Rows[i].Cells["ContactPerson"].Value.ToString() + FieldDelimeter +
                    //        dataGridView1.Rows[i].Cells["ContactPersonDesignation"].Value.ToString() + FieldDelimeter +
                    //        dataGridView1.Rows[i].Cells["ContactPersonTelephone"].Value.ToString() + FieldDelimeter +
                    //        dataGridView1.Rows[i].Cells["ContactPersonEmail"].Value.ToString() + FieldDelimeter +
                    //        dataGridView1.Rows[i].Cells["TIN"].Value.ToString() + FieldDelimeter +
                    //        dataGridView1.Rows[i].Cells["VATRegistrationNo"].Value.ToString() + FieldDelimeter +
                    //        dataGridView1.Rows[i].Cells["Comments"].Value.ToString() + FieldDelimeter +
                    //        dataGridView1.Rows[i].Cells["ActiveStatus"].Value.ToString() + FieldDelimeter +
                    //        Program.CurrentUser + FieldDelimeter + DateTime.Now.ToString("yyyy-MMM-dd HH:mm:ss") +
                    //        FieldDelimeter +
                    //        dataGridView1.Rows[i].Cells["Country"].Value.ToString()
                    ...
                    //                   dataGridView1.Rows[i].Cells["StartDateTime"].Value.ToString() + FieldDelimeter +
                    //                   dataGridView1.Rows[i].Cells["ContactPerson"].Value.ToString() + FieldDelimeter +
                    //                   dataGridView1.Rows[i].Cells["ContactPersonDesignation"].Value.ToString() +
                    //                   FieldDelimeter +
                    //                   dataGridView1.Rows[i].Cells["ContactPersonTelephone"].Value.ToString() +
                    //                   FieldDelimeter +
                    //                   dataGridView1.Rows[i].Cells["ContactPersonEmail"].Value.ToString() +
                    //                   FieldDelimeter +
                    //                   dataGridView1.Rows[i].Cells["TIN"].Value.ToString() + FieldDelimeter +
                    //                   dataGridView1.Rows[i].Cells["VATRegistrationNo"].Value.ToString() +
                    //                   FieldDelimeter +
                    //                   dataGridView1.Rows[i].Cells["Comments"].Value.ToString() + FieldDelimeter +
                    //                   dataGridView1.Rows[i].Cells["ActiveStatus"].Value.ToString() + FieldDelimeter +
                    //                   Program.CurrentUser + FieldDelimeter +
                    ...
                    //                   dataGridView1.Rows[i].Cells["Country"].Value.ToString();
                    //}
                    //CustomerData = CustomerData + LineDelimeter;
                ...
                for (int i = 0; i < customerAddress.Rows.Count; i++)
                {
                    CustomerVM customer = new CustomerVM();

                    customer.CustomerName = Program.RemoveStringExpresion(customerAddress.Rows[i]["CustomerName"].ToString());
                    customer.CustomerCode = Program.RemoveStringExpresion(customerAddress.Rows[i]["Code"].ToString());
                    customer.Address1 = customerAddress.Rows[i]["Address"].ToString();
        ...
        private void bgwCustomer_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                //ImportDAL importDal = new ImportDAL();
                IImport importDal = OrdinaryVATDesktop.GetObject<ImportDAL, ImportRepo, IImport>(OrdinaryVATDesktop.IsWCF);
                sqlResults = importDal.ImportCustomer(customers, customeradd, connVM);
        ...
        private void bgwCustomer_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                #region Start
        ...
        private void VendorSave()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < dataGridView1.RowCount; i++)
                {
                    ...
                    vendor.VendorCode = Program.RemoveStringExpresion(dataGridView1.Rows[i].Cells["Code"].Value.ToString());
                    vendor.VendorName = Program.RemoveStringExpresion(dataGridView1.Rows[i].Cells["VendorName"].Value.ToString());
                    vendor.VendorGroup = dataGridView1.Rows[i].Cells["VendorGroup"].Value.ToString();
                    vendor.Address1 = dataGridView1.Rows[i].Cells["Address1"].Value.ToString();
                    vendor.Address2 = dataGridView1.Rows[i].Cells["Address2"].Value.ToString();
                    vendor.Address3 = dataGridView1.Rows[i].Cells["Address3"].Value.ToString();
                    vendor.City = dataGridView1.Rows[i].Cells["City"].Value.ToString();
                    vendor.TelephoneNo = dataGridView1.Rows[i].Cells["TelephoneNo"].Value.ToString();
                    vendor.FaxNo = dataGridView1.Rows[i].Cells["FaxNo"].Value.ToString();
                    vendor.Email = dataGridView1.Rows[i].Cells["Email"].Value.ToString();
                    vendor.StartDateTime = Convert.ToDateTime(dataGridView1.Rows[i].Cells["StartDateTime"].Value.ToString()).ToString("yyyy-MMM-dd HH:mm:ss");
                    vendor.ContactPerson = dataGridView1.Rows[i].Cells["ContactPerson"].Value.ToString();
                    vendor.ContactPersonDesignation = dataGridView1.Rows[i].Cells["ContactPersonDesignation"].Value.ToString();
                    vendor.ContactPersonTelephone = dataGridView1.Rows[i].Cells["ContactPersonTelephone"].Value.ToString();
                    vendor.ContactPersonEmail = dataGridView1.Rows[i].Cells["ContactPersonEmail"].Value.ToString();
                    vendor.VATRegistrationNo = dataGridView1.Rows[i].Cells["VATRegistrationNo"].Value.ToString();
                    vendor.TINNo = dataGridView1.Rows[i].Cells["TIN"].Value.ToString();
                    vendor.Comments = dataGridView1.Rows[i].Cells["Comments"].Value.ToString();
                    vendor.ActiveStatus = dataGridView1.Rows[i].Cells["ActiveStatus"].Value.ToString();
                    vendor.CreatedBy = Program.CurrentUser;
                    vendor.CreatedOn = DateTime.Now.ToString("yyyy-MMM-dd HH:mm:ss");
                    vendor.Country = dataGridView1.Rows[i].Cells["Country"].Value.ToString();
            ...
            {
                FileLogger.Log(this.Name, "VendorSave", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            catch (SoapHeaderException ex)
            {
                ...
                FileLogger.Log(this.Name, "VendorSave", exMessage);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void bgwVendor_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                #region statement
                ...
                //ImportDAL importDal = new ImportDAL();
                IImport importDal = OrdinaryVATDesktop.GetObject<ImportDAL, ImportRepo, IImport>(OrdinaryVATDesktop.IsWCF);
                sqlResults = importDal.ImportVendor(vendors, connVM);
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                FileLogger.Log(this.Name, "bgwVendor_DoWork", exMessage);
            }
            #endregion
        }
        private void bgwVendor_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                #region Start
            ...
            {
                FileLogger.Log(this.Name, "bgwVendor_RunWorkerCompleted", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            catch (SoapHeaderException ex)
            {
                ...
                FileLogger.Log(this.Name, "bgwVendor_RunWorkerCompleted", exMessage);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void VehicleSave()
        {
            try
            {
                ...
                for (int i = 0; i < dataGridView1.RowCount; i++)
                {
                    ...
                    vehicle.VehicleType = dataGridView1.Rows[i].Cells["VehicleType"].Value.ToString();
                    vehicle.Code = Program.RemoveStringExpresion(dataGridView1.Rows[i].Cells["Code"].Value.ToString());
                    vehicle.VehicleType = dataGridView1.Rows[i].Cells["VehicleType"].Value.ToString();
                    vehicle.VehicleNo = Program.RemoveStringExpresion(dataGridView1.Rows[i].Cells["VehicleNo"].Value.ToString());
                    vehicle.Description = dataGridView1.Rows[i].Cells["Description"].Value.ToString();
                    vehicle.Comments = dataGridView1.Rows[i].Cells["Comments"].Value.ToString();
                    vehicle.ActiveStatus = dataGridView1.Rows[i].Cells["ActiveStatus"].Value.ToString();
                    vehicle.CreatedBy = Program.CurrentUser;
                    vehicle.CreatedOn = DateTime.Now.ToString("yyyy-MMM-dd HH:mm:ss");
            ...
            {
                FileLogger.Log(this.Name, "VehicleSave", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            catch (SoapHeaderException ex)
            {
                ...
                FileLogger.Log(this.Name, "VehicleSave", exMessage);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void bgwVehicle_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                #region statement
                ...
                //ImportDAL importDal = new ImportDAL();
                IImport importDal = OrdinaryVATDesktop.GetObject<ImportDAL, ImportRepo, IImport>(OrdinaryVATDesktop.IsWCF);
                sqlResults = importDal.ImportVehicle(vehicles, connVM);
        ...
        private void bgwVehicle_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                #region Start
        ...
        private void BankSave()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < dataGridView1.RowCount; i++)
                {
                    BankInformationVM bank = new BankInformationVM();
                    bank.BankName = Program.RemoveStringExpresion(dataGridView1.Rows[i].Cells["BankName"].Value.ToString());
                    bank.BranchName = Program.RemoveStringExpresion(dataGridView1.Rows[i].Cells["BranchName"].Value.ToString());
                    bank.BankCode = Program.RemoveStringExpresion(dataGridView1.Rows[i].Cells["Code"].Value.ToString());
                    bank.AccountNumber = dataGridView1.Rows[i].Cells["AccountNumber"].Value.ToString();
                    bank.Address1 = dataGridView1.Rows[i].Cells["Address1"].Value.ToString();
                    bank.Address2 = dataGridView1.Rows[i].Cells["Address2"].Value.ToString();
                    bank.Address3 = dataGridView1.Rows[i].Cells["Address3"].Value.ToString();
                    bank.City = dataGridView1.Rows[i].Cells["City"].Value.ToString();
                    bank.TelephoneNo = dataGridView1.Rows[i].Cells["TelephoneNo"].Value.ToString();
                    bank.FaxNo = dataGridView1.Rows[i].Cells["FaxNo"].Value.ToString();
                    bank.Email = dataGridView1.Rows[i].Cells["Email"].Value.ToString();
                    bank.ContactPerson = dataGridView1.Rows[i].Cells["ContactPerson"].Value.ToString();
                    bank.ContactPersonDesignation = dataGridView1.Rows[i].Cells["ContactPersonDesignation"].Value.ToString();
                    bank.ContactPersonTelephone = dataGridView1.Rows[i].Cells["ContactPersonTelephone"].Value.ToString();
                    bank.ContactPersonEmail = dataGridView1.Rows[i].Cells["ContactPersonEmail"].Value.ToString();
                    bank.Comments = dataGridView1.Rows[i].Cells["Comments"].Value.ToString();
                    bank.ActiveStatus = dataGridView1.Rows[i].Cells["ActiveStatus"].Value.ToString();
                    bank.CreatedBy = Program.CurrentUser;
                    bank.CreatedOn = DateTime.Now.ToString("yyyy-MMM-dd HH:mm:ss");
                    bank.BranchId = Program.BranchId;
                    banks.Add(bank);
                }
                this.btnSave.Enabled = false;
                this.progressBar1.Visible = true;
            ...
            {
                FileLogger.Log(this.Name, "BankSave", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            catch (SoapHeaderException ex)
            {
                ...
                FileLogger.Log(this.Name, "BankSave", exMessage);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void bgwBank_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                sqlResults = importDal.ImportBank(banks, connVM);
            ...
            {
                FileLogger.Log(this.Name, "bgwBank_DoWork", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            catch (SoapHeaderException ex)
            {
                ...
                FileLogger.Log(this.Name, "bgwBank_DoWork", exMessage);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void bgwBank_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            {
                FileLogger.Log(this.Name, "bgwBank_RunWorkerCompleted", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            catch (SoapHeaderException ex)
            {
                ...
                FileLogger.Log(this.Name, "bgwBank_RunWorkerCompleted", exMessage);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void cmbLoad()
        {
            ...
            cmbImport.Items.Add("Product"); //1
            cmbImport.Items.Add("Vehicle"); //4
            cmbImport.Items.Add("Vendor"); //3
            cmbImport.Items.Add("Costing"); //6
            cmbImport.Items.Add("UOM"); //7
            cmbImport.Items.Add("BranchProfiles"); //8
            cmbImport.Items.Add("TradingProducts");
            cmbImport.Items.Add("PurchaseTDS");
            //cmbImport.Items.Add("Product Opening"); //8

            //cmbImport.Items.Add("Product Group");
            //cmbImport.Items.Add("Product Type");
            //cmbImport.Items.Add("Customer Group");
            //cmbImport.Items.Add("Vendor Group");
            //cmbImport.Items.Add("Head Name");
        ...
        private void FormImport_Load(object sender, EventArgs e)
        {
            ...
            IsTracking = commonDal.settingsDesktop("TrackingTrace", "Tracking", null, connVM);
        ...
        private void ImportFromExcelFile()
        {
            ...
            try
            {
                if (cmbImport.Text == "Product")
                {
                    ...
                    NotNumericCheck("CostPrice");
                    ActiveCharacterCheck("NonStock");
                    ActiveCharacterCheck("IsConfirmed");
                ...
                else if (cmbImport.Text == "Customer")
                {
                    ...
                    NotDateCheck("StartDateTime");
                    ActiveCharacterCheck("ActiveStatus");
                    ActiveCharacterCheck("IsVDSWithHolder");
                    ActiveCharacterCheck("IsSpecialRate");
                    ActiveCharacterCheck("IsInstitution");
                ...
                else if (cmbImport.Text == "Costing")
                {
                    CostingHeader();
                    CostingImport();

                }
                else if (cmbImport.Text == "UOM") // moded here underneth
                {
                    UOMHeader();
                    UOMImport();

                    ActiveCharacterCheck("Active Status");
                }
                else if (cmbImport.Text == "BranchProfiles") // moded here underneth
                {
                    BranchProfilesHeader();
                    BranchProfilesImport();

                    ActiveCharacterCheck("ActiveStatus");
                    ActiveCharacterCheck("IsCentral");
                }
                ...
                else if (cmbImport.Text == "PurchaseTDS")
                {
                    PurchaseTDSHeader();
                    PurchaseTDSImport();

                    NotNumericCheck("PurchaseBillAmount");
                    NotNumericCheck("TDSAmount");

                }
                //else if (cmbImport.Text == "Product Opening")
                //{
                //    ProductOpeningHeader();
                //    ProductOpeningImport();

                //    NotNumericCheck("OpeningBalance");
                //    NotNumericCheck("OpeningTotalCost");
                //    NotDateCheck("OpeningDate");
                //}

                else
                {
                    MessageBox.Show("Data Import Not Done !");
                }
            }
            #endregion
            ...
            {
                FileLogger.Log(this.Name, "ImportFromExcelFile", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (cmbImport.Text == "UOM")
                {
                    UOMSave();
                }
                else if (cmbImport.Text == "BranchProfiles")
                {
                    BranchProfileSave();
                }
                if (cmbImport.Text == "TradingProducts")
                {
                    TradingProductSave();
                }
                if (cmbImport.Text == "PurchaseTDS")
                {
                    PurchaseTDSSave();
                }
               ...
               //else if (cmbImport.Text == "Product Opening")
                ...
                else if (cmbImport.Text == "Product Type")
                {
                    //ProductTypeSave();
                }
        ...
        private void bgwProductOpening_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                #region statement
                ...
                sqlResults = importDal.ImportProductOpening(products, connVM);
            ...
            {
                FileLogger.Log(this.Name, "bgwProductOpening_DoWork", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            catch (SoapHeaderException ex)
            {
                ...
                FileLogger.Log(this.Name, "bgwProductOpening_DoWork", exMessage);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void bgwProductOpening_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                #region Start
                ...
                if (SAVE_DOWORK_SUCCESS)
                    if (sqlResults.Length > 0)
                    {
                        ...
                        if (string.IsNullOrEmpty(result))
                        {
                            throw new ArgumentNullException("bgwProductOpening_RunWorkerCompleted",
                                                            "Unexpected error.");
                        }
                        else if (result == "Success" || result == "Fail")
                        {
            ...
            {
                FileLogger.Log(this.Name, "bgwProductOpening_RunWorkerCompleted", ex.Message + Environment.NewLine + ex.StackTrace);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            catch (SoapHeaderException ex)
            {
                ...
                FileLogger.Log(this.Name, "bgwProductOpening_RunWorkerCompleted", exMessage);
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void PurchaseTDSSave()
        {

            try
            {

                _PurchaseTDSsVMs.Clear();
                for (int i = 0; i < dataGridView1.RowCount; i++)
                {
                    PurchaseTDSsVM _PurchaseTDSsVM = new PurchaseTDSsVM();

                    _PurchaseTDSsVM.PurchaseInvoiceNo = dataGridView1.Rows[i].Cells["PurchaseInvoiceNo"].Value.ToString();
                    _PurchaseTDSsVM.TDSCode = dataGridView1.Rows[i].Cells["TDSCode"].Value.ToString();
                    _PurchaseTDSsVM.PurchaseBillAmount = Convert.ToDecimal(dataGridView1.Rows[i].Cells["PurchaseBillAmount"].Value.ToString());
                    _PurchaseTDSsVM.TDSAmount = Convert.ToDecimal(dataGridView1.Rows[i].Cells["TDSAmount"].Value.ToString());


                    _PurchaseTDSsVMs.Add(_PurchaseTDSsVM);
                }
                Productresult = string.Empty;

                this.btnSave.Enabled = false;
                this.progressBar1.Visible = true;
                bgwPurchaseTDS.RunWorkerAsync();
            }
            #region catch
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                FileLogger.Log(this.Name, "PurchaseTDSSave", exMessage);
            }
            #endregion

        }

        private void bgwPurchaseTDS_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                sqlResults = purchaseDAL.ImportPurchaseTDS(_PurchaseTDSsVMs, null, null, connVM);
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                FileLogger.Log(this.Name, "bgwPurchaseTDS_DoWork", exMessage);
            }
            #endregion

        }

        private void bgwPurchaseTDS_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                ...
                if (SAVE_DOWORK_SUCCESS)
                    if (sqlResults.Length > 0)
                    {
                        ...
                        if (string.IsNullOrEmpty(result))
                        {
                            throw new ArgumentNullException("bgwBranchProfile_RunWorkerCompleted", "Unexpected error.");
                        }
                        else if (result == "Success" || result == "Fail")
                        {
                            MessageBox.Show(message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                FileLogger.Log(this.Name, "bgwPurchaseTDS_RunWorkerCompleted", exMessage);
            }
