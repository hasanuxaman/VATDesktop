...
namespace SymphonySofttech.Reports.Report {
    ...
    public class RptVDS_TR6_ITL : ReportClass {
        
        public RptVDS_TR6_ITL() {
        }
        
        public override string ResourceName {
            get {
                return "RptVDS-TR6_ITL.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymphonySofttech.Reports.Report.RptVDS-TR6_ITL.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptVDS_TR6_ITL : Component, ICachedReport {
        
        public CachedRptVDS_TR6_ITL() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptVDS_TR6_ITL rpt = new RptVDS_TR6_ITL();
            rpt.Site = this.Site;
            return rpt;
        }
