...
namespace VATClient
{
    public partial class FormSaleImportKCCL : Form
    {
        #region Variables
        ...
        {
            FormSaleImportKCCL form = new FormSaleImportKCCL();
        ...
        private void FormMasterImport_Load(object sender, EventArgs e)
        {
            ...
            //    KhulnaDepot
            //SylhetDepot
            cmbDepoNames.Items.Add("HeadOffice");
            cmbDepoNames.Items.Add("BarisalDepot");
            cmbDepoNames.Items.Add("BograDepot");
            cmbDepoNames.Items.Add("ChittagongDepot");
            cmbDepoNames.Items.Add("KhulnaDepot");
            cmbDepoNames.Items.Add("SylhetDepot");
        ...
        private void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    if (value == "N")
                    {
                        List<SaleMasterVM> sales = saleDal.SelectAllTop1(0, new[] { "sih.ImportIDExcel" }, new[] { invoiceNo }, null, null, null,connVM);
                    ...
                    dtTableResult = importDal.GetSaleKohinoorDbData(invoiceNo, dt,connVM);
                    dgvLoadedTable.DataSource = dtTableResult;
        ...
        private void bgwBigData_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    //    var dt = salesDal.CheckInvoiceNoExist(invoiceIds);
                    ...
                    //sqlResults = chkOldDb.Checked ? salesDal.SaveAndProcessOtherDb(salesData, BulkCallBack, Program.BranchId)
                    //    :
        ...
        private void UpdateOtherDB(SaleDAL salesDal)
        {
            if (sqlResults[0].ToLower() == "success" && selectedType == CONST_DATABASE)
            {
                ...
                var results = salesDal.SaveSalesToKohinoor(table,settingVM.BranchInfoDT,connVM);
