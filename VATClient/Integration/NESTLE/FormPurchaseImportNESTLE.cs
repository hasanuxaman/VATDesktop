...
namespace VATClient
{
    public partial class FormPurchaseImportNESTLE : Form
    {
        #region Variables
        ...
        public FormPurchaseImportNESTLE()
        {
            InitializeComponent();
        ...
        {
            FormPurchaseImportNESTLE form = new FormPurchaseImportNESTLE();
        ...
        private void DataLoad()
        {
            ...
            dtTableResult = _IntegrationDAL.GetSource_PurchaseData_Master(paramVM,connVM);
        ...
        private void UpdateOtherDB(DataTable table)
        {
            if (sqlResults[0].ToLower() == "success")
            {
                ...
                string[] results = importDal.UpdateNestleTransactions(table, settingVM.BranchInfoDT,connVM, "PurchaseInvoices");
