...
namespace SymphonySofttech.Reports.Report {
    ...
    public class RptVAT6_1_TopSheet : ReportClass {
        
        public RptVAT6_1_TopSheet() {
        }
        
        public override string ResourceName {
            get {
                return "RptVAT6_1_TopSheet.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymphonySofttech.Reports.Report.RptVAT6_1_TopSheet.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptVAT6_1_TopSheet : Component, ICachedReport {
        
        public CachedRptVAT6_1_TopSheet() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptVAT6_1_TopSheet rpt = new RptVAT6_1_TopSheet();
            rpt.Site = this.Site;
            return rpt;
        }
