...
namespace SymphonySofttech.Reports.Report {
    ...
    public class RptMonthlySale : ReportClass {
        
        public RptMonthlySale() {
        }
        
        public override string ResourceName {
            get {
                return "RptMonthlySale.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymphonySofttech.Reports.Report.RptMonthlySale.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptMonthlySale : Component, ICachedReport {
        
        public CachedRptMonthlySale() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptMonthlySale rpt = new RptMonthlySale();
            rpt.Site = this.Site;
            return rpt;
        }
