...
{
    public class PurchaseMPLDAL : IPurchaseMPL
    {
...
--------------------------------------------------Current--------------------------------------------------
------------------------------------------------------------------------------------------------------------
select top 1 inv.Id, inv.PurchaseInvoiceNo InvoiceNo from PurchaseInvoiceMPLHeaders inv
where 1=1 
...
";
                ...
                else
                {
                    ...
                    {
                        vm.ButtonName = "First";
                        vm = Purchase_Navigation(vm, currConn, transaction);
            ...
            catch (Exception ex)
            {
                ...
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "Purchase_Navigation", ex.ToString() + "\n" + sqlText, "Purchase");
...
";
            ...
            catch (SqlException sqlex)
            {
                ...
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "SearchPurchaseDutyDTNew", sqlex.ToString() + "\n" + sqlText);
            ...
            catch (Exception ex)
            {
                ...
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "SearchPurchaseDutyDTNew", ex.ToString() + "\n" + sqlText);
                throw new ArgumentNullException("", ex.Message.ToString());
...
,ISNULL(NULLIF(Remarks,''),'NA')Remarks
FROM PurchaseInvoiceDuties PID left outer JOIN
  PurchaseInvoiceMPLHeaders PIH  on PID.PurchaseInvoiceNo=pih.PurchaseInvoiceNo left outer JOIN
Products on isnull(PID.ItemNo,0)=Products.ItemNo                                 
...
";
            ...
            catch (SqlException sqlex)
            {
                ...
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "SearchPurchaseDutyDTDownload", sqlex.ToString() + "\n" + sqlText);
                throw new ArgumentNullException("", sqlex.Message.ToString());
            ...
            catch (Exception ex)
            {
                ...
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "SearchPurchaseDutyDTDownload", ex.ToString() + "\n" + sqlText);
                throw new ArgumentNullException("", ex.Message.ToString());
...
SELECT pu.[PurchaseInvoiceNo]
  ...
  FROM PurchaseInvoiceMPLDetails pu,
Products pr
...
";
            ...
            {
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "SearchProductbyPurchaseInvoice", sqlex.ToString() + "\n" + sqlText);
                throw new ArgumentNullException("", sqlex.Message.ToString());
            ...
            {
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "SearchProductbyPurchaseInvoice", ex.ToString() + "\n" + sqlText);
                throw new ArgumentNullException("", ex.Message.ToString());
...
";
            ...
            {
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "SearchPurchaseInvoiceTracking", sqlex.ToString() + "\n" + sqlText);
                throw new ArgumentNullException("", sqlex.Message.ToString());
            ...
            {
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "SearchPurchaseInvoiceTracking", ex.ToString() + "\n" + sqlText);
                throw new ArgumentNullException("", ex.Message.ToString());
            ...
            , string InvoiceDateFrom, string InvoiceDateTo, string SerialNo, string T1Type, string T2Type, string BENumber, string Post, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                sqlText += " SELECT";
                sqlText += " PurchaseInvoiceMPLHeaders.PurchaseInvoiceNo,   ";
                sqlText += " PurchaseInvoiceMPLHeaders.VendorID,";
                sqlText += " isnull(PurchaseInvoiceMPLHeaders.CustomHouse,'N/A')CustomHouse,";
                sqlText += " isnull(PurchaseInvoiceMPLHeaders.CustomCode,'N/A')CustomCode,";
                ...
                sqlText += " convert (varchar,PurchaseInvoiceMPLHeaders.InvoiceDateTime,120)InvoiceDateTime,";
                sqlText += " isnull(PurchaseInvoiceMPLHeaders.TotalAmount,0)TotalAmount,";
                sqlText += " isnull(PurchaseInvoiceMPLHeaders.TotalVATAmount,0)TotalVATAmount,";
                sqlText += " isnull(PurchaseInvoiceMPLHeaders.SerialNo,'N/A')SerialNo,";
                sqlText += " isnull(PurchaseInvoiceMPLHeaders.LCNumber,'N/A')LCNumber,";
                sqlText += " isnull(PurchaseInvoiceMPLHeaders.Comments,'N/A')Comments,";
                sqlText += " PurchaseInvoiceMPLHeaders.ProductType,PurchaseInvoiceMPLHeaders.Post,";
                sqlText += " PurchaseInvoiceMPLHeaders.PurchaseReturnId,";
                sqlText += " PurchaseInvoiceMPLHeaders.WithVDS,";
                sqlText += " convert (varchar,PurchaseInvoiceMPLHeaders.ReceiveDate,120)ReceiveDate,";
                sqlText += " isnull(PurchaseInvoiceMPLHeaders.BENumber,'N/A')BENumber,";
                sqlText += " isnull(PurchaseInvoiceMPLHeaders.TDSAmount,0)TDSAmount,";

                sqlText += " PurchaseInvoiceMPLHeaders.LCDate,";
                sqlText += " isnull(PurchaseInvoiceMPLHeaders.LandedCost,0)LandedCost";

                sqlText += " FROM PurchaseInvoiceMPLHeaders LEFT OUTER JOIN";
                sqlText += " Vendors ON  PurchaseInvoiceMPLHeaders.VendorID =  Vendors.VendorID LEFT OUTER JOIN";
                sqlText += " VendorGroups ON  Vendors.VendorGroupID =  VendorGroups.VendorGroupID                 ";
                sqlText += " WHERE ";
                sqlText += "     (PurchaseInvoiceMPLHeaders.PurchaseInvoiceNo LIKE '%' +  @PurchaseInvoiceNo + '%' OR @PurchaseInvoiceNo IS NULL) ";
                sqlText += " AND (PurchaseInvoiceMPLHeaders.WithVDS  LIKE '%' + @WithVDS  + '%' OR @WithVDS IS NULL) ";
                ...
                sqlText += " AND (PurchaseInvoiceMPLHeaders.InvoiceDateTime>= @InvoiceDateFrom OR @InvoiceDateFrom IS NULL)";
                sqlText += " AND (PurchaseInvoiceMPLHeaders.InvoiceDateTime<= @InvoiceDateTo OR @InvoiceDateTo IS NULL)";
                sqlText += " AND (PurchaseInvoiceMPLHeaders.SerialNo LIKE '%' + @SerialNo + '%' OR @SerialNo IS NULL) ";
                sqlText += " AND (PurchaseInvoiceMPLHeaders.TransactionType=@T1Type)";
                sqlText += " OR (PurchaseInvoiceMPLHeaders.TransactionType=@T2Type)";
                sqlText += " AND (PurchaseInvoiceMPLHeaders.BENumber LIKE '%' + @BENumber + '%' OR @BENumber IS NULL) ";
                sqlText += " AND (PurchaseInvoiceMPLHeaders.Post LIKE '%' + @Post  + '%' OR @Post IS NULL) ";
            ...
            {
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "SearchPurchaseHeaderDTNew2", sqlex.ToString() + "\n" + sqlText);
                throw new ArgumentNullException("", sqlex.Message.ToString());
            ...
            {
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "SearchPurchaseHeaderDTNew2", ex.ToString() + "\n" + sqlText);
                throw new ArgumentNullException("", ex.Message.ToString());
        ...
        private List<PurchaseDutiesVM> DutyCalculation(DataRow[] ImportRaws, SqlConnection VcurrConn, SqlTransaction Vtransaction, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                foreach (DataRow row in ImportRaws)
                {
                    ...
                    string itemNo = cImport.FindItemId(itemName, itemCode, VcurrConn, Vtransaction);
                    ...
                    if (drDetailsRow.Length > 0)
                    {
                        foreach (DataRow detailItem in drDetailsRow)
                        {
                            ...
                            {
                                dItemNo = cImport.FindItemId(detailItem["Item_Name"].ToString(), detailItem["Item_Code"].ToString(), VcurrConn, Vtransaction);
                            ...
                            else
                            {
                                ...
                                {
                                    vTotalAmt = detailItem["Quantity"].ToString();
                                }
                                else
                                {
                                    vTotalAmt = "0";
            ...
            {
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "DutyCalculation", ex.ToString());
                throw new ArgumentNullException("", ex.Message.ToString());
        ...
        public decimal FormatingNumeric(decimal value, int DecPlace, SysDBInfoVMTemp connVM = null)
        {
            ...
            {
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "FormatingNumeric", ex.ToString());
                throw new ArgumentNullException("", ex.Message.ToString());
...
FROM PurchaseInvoiceMPLDetails pid
...
";
            ...
            catch (SqlException sqlex)
            {
                ...
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "GetLastPurchaseDetail", sqlex.ToString());
                throw new ArgumentNullException("", sqlex.Message.ToString());
            ...
            {
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "GetLastPurchaseDetail", ex.ToString());
                throw new ArgumentNullException("", ex.Message.ToString());
        ...
        public string[] MultipleRebate(List<PurchasePostIds> RebateIds, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                {
                    PurchaseInvoiceMPLHeadersVM master = SelectAllList(Convert.ToInt32(item.Id), null, null, currConn, transaction, null, connVM).FirstOrDefault();

                    List<PurchaseInvoiceMPLDetailVM> Details = SelectPurchaseDetailList(master.PurchaseInvoiceNo, null, null, currConn, transaction, null);
                    ...
                    RebateVM.IsRebateHold = "N";

                    retResults = PurchaseRebate(RebateVM, master, Details, transaction, currConn);
                ...
                //{
                //    PurchaseInvoiceMPLHeadersVM master = SelectAllList(Convert.ToInt32(Ids[i]), null, null, currConn, transaction, null, null).FirstOrDefault();
                //    List<PurchaseInvoiceMPLDetailVM> Details = SelectPurchaseDetailList(master.PurchaseInvoiceNo, null, null, currConn, transaction, null);
        ...
        //currConn to VcurrConn 25-Aug-2020
        public string[] PurchaseRebate(PurchasePostIds RebateVM, PurchaseInvoiceMPLHeadersVM Master, List<PurchaseInvoiceMPLDetailVM> Details, SqlTransaction Vtransaction = null, SqlConnection VcurrConn = null, SysDBInfoVMTemp connVM = null)
        {
            #region Initializ
            ...
            try
            {
                ...
                sqlText = sqlText +
                          "select COUNT(PurchaseInvoiceNo) from PurchaseInvoiceMPLHeaders WHERE PurchaseInvoiceNo=@MasterPurchaseInvoiceNo and IsRebate='Y'";
                ...
                {
                    sqlText = "";
                    sqlText += @" Update  PurchaseInvoiceMPLHeaders     set  IsRebate =@IsRebate,RebatePeriodID=@RebatePeriodID,RebateDate=@RebateDate,IsRebateHold=@IsRebateHold ,LastModifiedBy =@MasterLastModifiedBy,LastModifiedOn =@MasterLastModifiedOn    WHERE PurchaseInvoiceNo=@MasterSalesInvoiceNo ";
                    sqlText += @" Update  PurchaseInvoiceMPLDetails     set  IsRebate =@IsRebate,RebatePeriodID=@RebatePeriodID,IsRebateHold=@IsRebateHold, LastModifiedBy =@MasterLastModifiedBy,LastModifiedOn =@MasterLastModifiedOn    WHERE PurchaseInvoiceNo=@MasterSalesInvoiceNo ";
                    sqlText += @" Update  PurchaseInvoiceHeaders     set  IsRebate =@IsRebate,RebatePeriodID=@RebatePeriodID,RebateDate=@RebateDate,IsRebateHold=@IsRebateHold, LastModifiedBy =@MasterLastModifiedBy,LastModifiedOn =@MasterLastModifiedOn    WHERE PurchaseInvoiceNo=@MasterSalesInvoiceNo ";
                    sqlText += @" Update  PurchaseInvoiceDetails     set  IsRebate =@IsRebate,RebatePeriodID=@RebatePeriodID,IsRebateHold=@IsRebateHold ,LastModifiedBy =@MasterLastModifiedBy,LastModifiedOn =@MasterLastModifiedOn    WHERE PurchaseInvoiceNo=@MasterSalesInvoiceNo ";
                    ...
                    cmdUpdateDetail.Parameters.AddWithValueAndNullHandle("@IsRebateHold", RebateVM.IsRebateHold);
            ...
            catch (Exception ex)
            {
                ...
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "PurchaseRebate", ex.ToString() + "\n" + sqlText);
        ...
        public string[] MultipleRebateData(List<string> IDs, string PeriodName, SqlTransaction Vtransaction = null, SqlConnection VcurrConn = null, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                sqlText += @"
SELECT Id from PurchaseInvoiceMPLHeaders where Post='Y' and IsRebate='N' and Id in ( ";
        ...
        public List<PurchaseInvoiceMPLHeadersVM> SelectAllList(int Id = 0, string[] conditionFields = null, string[] conditionValues = null, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, PurchaseInvoiceMPLHeadersVM likeVM = null, SysDBInfoVMTemp connVM = null, string ItemNo = null, bool IsDisposeRawSearch = false)
        {
            #region Variables
            //SqlConnection currConn = null;
            //SqlTransaction transaction = null;
            string sqlText = "";
            List<PurchaseInvoiceMPLHeadersVM> VMs = new List<PurchaseInvoiceMPLHeadersVM>();
            PurchaseInvoiceMPLHeadersVM vm;
            #endregion
            try
            {
                ...
                DataTable dt = SelectAll(Id, conditionFields, conditionValues, VcurrConn, Vtransaction, null, false, connVM, false, IsDisposeRawSearch, ItemNo);

                foreach (DataRow dr in dt.Rows)
                {
                    try
                    {
                        vm = new PurchaseInvoiceMPLHeadersVM();
                        ...
                        vm.ReceiveDate = Convert.ToDateTime(dr["ReceiveDate"].ToString()).ToString("yyyy-MM-dd HH:mm:ss");
                        ...
                        vm.RegNo = dr["RegNo"].ToString();
                        vm.BondNo = dr["BondNo"].ToString();
                        vm.VesselName = dr["VesselName"].ToString();
                        vm.ProcessingFee = Convert.ToDecimal(dr["ProcessingFee"].ToString());

                        vm.IsRebateHold = dr["IsRebateHold"].ToString();
        ...
        public DataTable SelectAll(int Id = 0, string[] conditionFields = null, string[] conditionValues = null, SqlConnection VcurrConn = null
            , SqlTransaction Vtransaction = null, PurchaseInvoiceMPLHeadersVM likeVM = null, bool Dt = false, SysDBInfoVMTemp connVM = null, bool VDSSearch = false
...
,ISNULL(pih.RegNo,'-') RegNo
,ISNULL(pih.BondNo,'-') BondNo
,ISNULL(pih.VesselName,'-') VesselName
,ISNULL(pih.ProcessingFee,0) ProcessingFee
,ISNULL(pih.IsRebateHold,'Y') IsRebateHold
FROM PurchaseInvoiceMPLHeaders pih left outer join Vendors v on pih.VendorID=v.VendorID 
...
from PurchaseInvoiceMPLDetails
...
FROM PurchaseInvoiceMPLHeaders pih left outer join Vendors v on pih.VendorID=v.VendorID 
left outer join VendorGroups vg on v.VendorGroupID=vg.VendorGroupID
LEFT OUTER JOIN (select distinct PurchaseInvoiceNo,sum(isnull(VDSAmount,0))VDSAmount   from PurchaseInvoiceMPLDetails
group by PurchaseInvoiceNo)VDS ON  pih.PurchaseInvoiceNo =  VDS.PurchaseInvoiceNo
WHERE  1=1";
                ...
                if (IsDisposeRawSearch)
                {
                    if (ItemNo != null)
                    {
                        sqlTextParameter += @"and pih.PurchaseInvoiceNo in(select PurchaseInvoiceNo from PurchaseInvoiceMPLDetails where itemno=@ItemNo)";
                    }
                }
                ...
                sqlTextOrderBy += @" order by  pih.Id desc";
...
";
        ...
        public DataTable PurchaseSearch(int Id = 0, string[] conditionFields = null, string[] conditionValues = null, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, PurchaseInvoiceMPLHeadersVM likeVM = null, bool Dt = false, SysDBInfoVMTemp connVM = null)
        {
            #region Variables
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
...
";
        ...
        public List<PurchaseInvoiceMPLDetailVM> SelectPurchaseDetailList(string PurchaseInvoiceNo, string[] conditionFields = null, string[] conditionValues = null, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, SysDBInfoVMTemp connVM = null)
        {
            #region Variables
            string sqlText = "";
            List<PurchaseInvoiceMPLDetailVM> VMs = new List<PurchaseInvoiceMPLDetailVM>();
            PurchaseInvoiceMPLDetailVM vm;
            #endregion
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    vm = new PurchaseInvoiceMPLDetailVM();
                    vm.Id = dr["Id"].ToString();
                    vm.PurchaseInvoiceNo = dr["PurchaseInvoiceNo"].ToString();
                    vm.TankId = Convert.ToInt32(dr["TankId"].ToString());
                    vm.TankName = dr["TankName"].ToString();
                    ...
                    vm.DIANo = dr["DIANo"].ToString();
                    vm.MT = Convert.ToDecimal(dr["MT"].ToString());
                    ...
                    dtDuty = SearchPurchaseDutyDTNew(vm.PurchaseInvoiceNo, null, vm.ItemNo, VcurrConn, Vtransaction);
...
,ISNULL(pd.TankId,0) TankId
,ISNULL(T.TankCode,'') TankName
,pd.UOMn
...
,isnull(pd.DIANo ,'-')                                                                 AS DIANo
,isnull(pd.MT ,0)                                                                 AS MT

FROM PurchaseInvoiceMPLDetails pd left outer join Products p on pd.ItemNo=p.ItemNo
left outer join TankMPLs T on pd.TankId=T.Id
WHERE  1=1
...
";
        ...
        public List<PurchaseInvoiceMPLHeadersVM> DropDown(SysDBInfoVMTemp connVM = null)
        {
            #region Variables
            SqlConnection currConn = null;
            string sqlText = "";
...
FROM PurchaseInvoiceMPLHeaders af
WHERE  1=1
";
        ...
        public List<PurchaseInvoiceMPLDetailVM> RateCheck(List<PurchaseInvoiceMPLDetailVM> VMs, SysDBInfoVMTemp connVM = null)
        {
            try
            {
                foreach (PurchaseInvoiceMPLDetailVM vm in VMs)
                {
                    string msg = "";
                    string rateChange = "";
        ...
        public string[] ImportExcelFile(PurchaseInvoiceMPLHeadersVM paramVM, SysDBInfoVMTemp connVM = null)
        {
            #region Initializ
            string sqlText = "";
            int Id = 0;
            ...
            try
            {
                ...
                #region Data Insert
                PurchaseMPLDAL puchaseDal = new PurchaseMPLDAL();
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("PurchaseMPLDAL", "ImportExcelFile", ex.ToString() + "\n" + sqlText);
                throw ex;
            }
            finally
            {
        ...
        public List<PurchaseDutiesVM> SelectAllDuties(string PurchaseInvoiceNo, string[] conditionFields = null, string[] conditionValues = null, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                DataTable dt = SelectAllDuties(PurchaseInvoiceNo, conditionFields, conditionValues, currConn, transaction, false);
...
";
        ...
        public string[] BENumberCheck(string VendorID, string BENumber, string CurrentYear, string PurchaseInvoiceNo = "", SqlTransaction Vtransaction = null, SqlConnection VcurrConn = null, int branchId = 0, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                sqlText = @"select COUNT(PurchaseInvoiceNo) from PurchaseInvoiceMPLHeaders WHERE VendorID=@VendorID and BENumber=@BENumber 
and PeriodID in(select PeriodID from FiscalYear where CurrentYear=@CurrentYear) ";
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("PurchaseMPLDAL", "EBNumberCheck", ex.ToString() + "\n" + sqlText);
        ...
        //currConn to VcurrConn 25-Aug-2020
        public string[] PurchaseInsert(PurchaseInvoiceMPLHeadersVM Master, List<PurchaseInvoiceMPLDetailVM> Details, List<PurchaseDutiesVM> Duties, List<TrackingVM> Trackings,
            SqlTransaction Vtransaction, SqlConnection VcurrConn, int branchId = 0, SysDBInfoVMTemp connVM = null, string UserId = "")
        {
            ...
            try
            {
                ...
                PriceDeclarationTradingProduct = Convert.ToBoolean(commonDal.settingValue("PriceDeclaration", "TradingProduct", null, currConn, transaction) == "Y" ? true : false);
                ...
                {
                    bool CheckCPC = commonDal.settings("Sale", "CheckCPC", currConn, transaction) == "Y";
                ...
                bool BECheck = commonDal.settings("Purchase", "DuplicateBECheck", currConn, transaction) == "Y";
                ...
                sqlText = "";
                sqlText = sqlText + "select COUNT(PurchaseInvoiceNo) from PurchaseInvoiceMPLHeaders WHERE PurchaseInvoiceNo=@MasterId";
                ...
                if (string.Equals(Master.TransactionType, "Other", StringComparison.InvariantCultureIgnoreCase))
                {
                    ...
                    newIDCreate1 = commonDal.TransactionCode("Purchase", "Other", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), currConn, transaction);
                ...
                {
                    newIDCreate1 = commonDal.TransactionCode("Purchase", "PurchaseDN", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                ...
                {
                    newIDCreate1 = commonDal.TransactionCode("Purchase", "PurchaseCN", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), currConn, transaction, connVM);
                ...
                {
                    newIDCreate1 = commonDal.TransactionCode("Purchase", "Trading", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), currConn, transaction, connVM);
                ...
                {
                    newIDCreate1 = commonDal.TransactionCode("TollReceive", "TollReceive", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                             "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), currConn, transaction, connVM);
                    ...
                    || string.Equals(Master.TransactionType, "InputServiceImport", StringComparison.InvariantCultureIgnoreCase))
                {
                    ...
                    newIDCreate1 = commonDal.TransactionCode("Purchase", "Import", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), currConn, transaction, connVM);
                ...
                else if (string.Equals(Master.TransactionType, "InputService", StringComparison.InvariantCultureIgnoreCase))
                {
                    ...
                    ////FileLogger.Log("PurchaseMPLDAL", "PurchaseInsert - Get TransactionCode ", "Branch Id" + Master.BranchId.ToString());


                    newIDCreate1 = commonDal.TransactionCode("Purchase", "InputService", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), currConn, transaction, connVM);

                    ////FileLogger.Log("PurchaseMPLDAL", "PurchaseInsert - GetCurrentCode ", "Branch Id" + Master.BranchId.ToString());
                ...
                {
                    newIDCreate1 = commonDal.TransactionCode("Purchase", "PurchaseTollcharge", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), currConn, transaction, connVM);
                ...
                {
                    newIDCreate1 = commonDal.TransactionCode("TollReceiveRaw", "TollReceiveRaw", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), currConn, transaction, connVM);
                ...
                {
                    newIDCreate1 = commonDal.TransactionCode("Purchase", "PurchaseReturn", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), currConn, transaction, connVM);
                ...
                {
                    newIDCreate1 = commonDal.TransactionCode("Purchase", "Service", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), currConn, transaction, connVM);
                ...
                {
                    newIDCreate1 = commonDal.TransactionCode("Purchase", "ServiceNS", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), currConn, transaction, connVM);
                ...
                {
                    newIDCreate1 = commonDal.TransactionCode("Purchase", "CommercialImporter", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), currConn, transaction, connVM);
                ...
                else if (Master.TransactionType == "ClientRawReceive")
                {
                    ...
                    newIDCreate1 = commonDal.TransactionCode("Toll", "RawReceive", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), currConn, transaction, connVM);
                ...
                else if (Master.TransactionType == "ClientFGReceiveWOBOM")
                {
                    ...
                    newIDCreate1 = commonDal.TransactionCode("Toll", "FGReceive", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), currConn, transaction);

                    string resultCode = commonDal.GetCurrentCode("Toll", "FGReceive", Master.ReceiveDate, Master.BranchId.ToString(), currConn, transaction);
...
from PurchaseInvoiceMPLHeaders 
where PurchaseInvoiceNumber = @PurchaseInvoiceNumber and FiscalYear = @FiscalYear and TransactionType = @TransactionType and BranchId=@BranchId";
                ...
                if (count1 > 0)
                {
                    FileLogger.Log("PurchaseMPLDAL", "Insert", "SaleInvoiceNumber " + newIDCreate1 + " Already Exists");
                ...
                sqlText = "select count(PurchaseInvoiceNo) from PurchaseInvoiceMPLHeaders where PurchaseInvoiceNo = @PurchaseInvoiceNo";
                ...
                if (count > 0)
                {
                    FileLogger.Log("PurchaseMPLDAL", "Insert", "Purchase Id " + newIDCreate1 + " Already Exists");
                    throw new Exception("Purchase Id " + newIDCreate1 + " Already Exists");
                }
                ...
                RebateWithGRN = commonDal.settingsDesktop("Purchase", "RebateWithGRN", settingsDt) == "Y";
                ...
                PurchaseInvoiceMPLHeadersVM pmVM = new PurchaseInvoiceMPLHeadersVM();
                ...
                pmVM.RegNo = Master.RegNo;
                pmVM.BondNo = Master.BondNo;
                pmVM.ProcessingFee = Master.ProcessingFee;
                pmVM.VesselName = Master.VesselName;
                ...
                pmVM.IsRebateHold = Master.IsRebateHold;
                #region Rebate Check
                ...
                retResults = PurchaseInsertToMaster(pmVM, currConn, transaction);
                ...
                #region PurchaseInvoiceHeaders bulk Insert
                List<PurchaseInvoiceMPLHeadersVM> PurchaseVMs = new List<PurchaseInvoiceMPLHeadersVM>();

                PurchaseVMs.Add(pmVM);
                var PurchaseHeadersDt = PurchaseVMs.ToDataTable();
                PurchaseHeadersDt = OrdinaryVATDesktop.DtColumnNameChange(PurchaseHeadersDt, "InvoiceDate", "InvoiceDateTime");
                PurchaseHeadersDt = OrdinaryVATDesktop.DtColumnNameChange(PurchaseHeadersDt, "CurrencyId", "CurrencyID");
                PurchaseHeadersDt = OrdinaryVATDesktop.DtColumnNameChange(PurchaseHeadersDt, "RebatePeriodId", "RebatePeriodID");
                if (PurchaseHeadersDt.Rows.Count > 0)
                {
                    string[] DeleteColumnName =
                {
                    "VendorGroup", "Details", "Duties", "Trackings", "Operation", "ProductGroup","CustomHouseCode","IsExpireDate","ExpireDate",
                    "ProductCategoryId", "File", "SearchField", "SearchValue", "IDs", "ExportAll", "SelectTop", "BranchList","VendorAddress",
                    "VesselName", "RegNo", "BondNo", "ProcessingFee", "PeriodDateTime","RebateWithGRN","MultipleItemInsert","TrackingTrace",
                    "CurrentUserId","VATTypeVATAutoChange","IsTotalPrice","IsRebateHolds","IsRebates","CurrentUser","TotalSubTotal","NetBill",
                    "BranchCode","IsImport","InvoiceDateTimeFrom","InvoiceDateTimeTo","Id","TotalVDSAmount","ReturnId","ImportID","VendorName",
                    "Type","InvoiceNumber","ItemNo"
                    ...
                    PurchaseHeadersDt = OrdinaryVATDesktop.DtDeleteColumns(PurchaseHeadersDt, DeleteColumnName);

                }
                retResults = _cDal.BulkInsert("PurchaseInvoiceHeaders", PurchaseHeadersDt, currConn, transaction);
                if (retResults[0] != "Success")
                {
                    throw new ArgumentNullException(MessageVM.PurchasemsgMethodNameInsert, retResults[1]);
                }
                ...
                #region PurchaseInvoiceDetails bulk Insert

                var PurchaseDetailsDt = Details.ToDataTable();
                PurchaseDetailsDt = OrdinaryVATDesktop.DtColumnNameChange(PurchaseDetailsDt, "RebatePeriodId", "RebatePeriodID");
                if (PurchaseDetailsDt.Columns.Contains("PurchaseInvoiceNo"))
                {
                    PurchaseDetailsDt.Columns.Remove("PurchaseInvoiceNo");
                }
                var PurchaseInvoiceNo = new DataColumn("PurchaseInvoiceNo") { DefaultValue = Master.PurchaseInvoiceNo };
                PurchaseDetailsDt.Columns.Add(PurchaseInvoiceNo);
                if (PurchaseDetailsDt.Columns.Contains("BranchId"))
                {
                    PurchaseDetailsDt.Columns.Remove("BranchId");
                }
                var BranchId = new DataColumn("BranchId") { DefaultValue = Master.BranchId };
                PurchaseDetailsDt.Columns.Add(BranchId);


                if (PurchaseDetailsDt.Columns.Contains("InvoiceDateTime"))
                {
                    PurchaseDetailsDt.Columns.Remove("InvoiceDateTime");
                }
                var InvoiceDateTime = new DataColumn("InvoiceDateTime") { DefaultValue = Master.InvoiceDate };

                PurchaseDetailsDt.Columns.Add(InvoiceDateTime);

                if (PurchaseDetailsDt.Columns.Contains("ReceiveDate"))
                {
                    PurchaseDetailsDt.Columns.Remove("ReceiveDate");
                }
                var ReceiveDate = new DataColumn("ReceiveDate") { DefaultValue = Master.ReceiveDate };
                PurchaseDetailsDt.Columns.Add(ReceiveDate);

                 if (PurchaseDetailsDt.Rows.Count > 0)
                {
                    string[] DeleteColumnName =
                {
                  "UnitPrice","VendorID","ProductName","InvoiceDate","ProductCode", "LineNo", "TankId","TankName", "DIANo", "MT","DutyRemarks","ATAmount","ReturnId","retResults","VATRate2","ReturnId","Total","IsExpireDate","Rowtype"
                };


                    PurchaseDetailsDt = OrdinaryVATDesktop.DtDeleteColumns(PurchaseDetailsDt, DeleteColumnName);
                }
                 retResults = _cDal.BulkInsert("PurchaseInvoiceDetails", PurchaseDetailsDt, currConn, transaction);
...
UPDATE PurchaseInvoiceMPLHeaders 
...
UPDATE PurchaseInvoiceMPLDetails 
SET PeriodId=RIGHT('0'+CONVERT(VARCHAR(2),MONTH(ReceiveDate)) +  CONVERT(VARCHAR(4),YEAR(ReceiveDate)),6)
WHERE PurchaseInvoiceNo = @PurchaseInvoiceNo

update PurchaseInvoiceMPLHeaders set WithVDS=d.WithVDS
from (select PurchaseInvoiceNo, case when VDSAmount>0 then 'Y' else 'N' end WithVDS  from PurchaseInvoiceMPLDetails
where VDSAmount>0  
) d 
where d.PurchaseInvoiceNo=PurchaseInvoiceMPLHeaders.PurchaseInvoiceNo
and PurchaseInvoiceMPLHeaders.PurchaseInvoiceNo=@PurchaseInvoiceNo
...
";
                ...
                //PurchasePostAVGPrice(Master, null, new List<PurchaseInvoiceMPLDetailVM>(), currConn, transaction);

                CommonDAL commonDAL = new CommonDAL();
                //commonDAL.settingsUpdateMaster("DayEnd", "DayEndProcess", "N", currConn, transaction);
                commonDAL.UpdateProcessFlag(Master.PurchaseInvoiceNo, Master.ReceiveDate, currConn, transaction);
                #endregion
            ...
            catch (Exception ex)
            {
                ...
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "PurchaseInsert", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        //currConn to VcurrConn 25-Aug-2020
        public string[] PurchaseInsert2(PurchaseInvoiceMPLHeadersVM Master, List<PurchaseInvoiceMPLDetailVM> Details, List<PurchaseDutiesVM> Duties, List<TrackingVM> Trackings,
            SqlTransaction Vtransaction, SqlConnection VcurrConn, SysDBInfoVMTemp connVM = null, string UserId = "")
        {
            ...
            try
            {
                ...
                bool TradingWithSale = Convert.ToBoolean(new CommonDAL().settings("Trading", "TradingWithSale").ToString().ToLower() == "y" ? true : false);
                ...
                {
                    foreach (PurchaseInvoiceMPLDetailVM Item in Details.ToList())
                    {
                        ItemType = productDal.GetProductTypeByItemNo(Item.ItemNo, VcurrConn, Vtransaction);
                ...
                foreach (PurchaseInvoiceMPLDetailVM Item in Details.ToList())
                {
                    ...
                    #region Insert PurchaseInvoiceMPLDetails

                    PurchaseInvoiceMPLDetailVM pDet = new PurchaseInvoiceMPLDetailVM();
                    pDet.BOMId = Item.BOMId;
                    pDet.TankId = Item.TankId;
                    ...
                    pDet.IsRebateHold = Master.IsRebateHold;
                        ...
                        )
                    {
                        ...
                        if (ItemType.ToLower() == "trading")
                        {
                            ...
                            {
                                ProductVM item = productDal.SelectAll(Item.ItemNo, null, null, VcurrConn, Vtransaction).FirstOrDefault();
                    ...
                    //if (false)
                    {
                        ...
                        string BOMId = bdal1.GetBOMIdFromOH(Item.ItemNo, "VAT 4.3 (Toll Receive)", Master.ReceiveDate, VcurrConn, Vtransaction, null);
                    ...
                    if (Master.TransactionType == "TollReceive")
                    {
                        ...
                        if (!string.IsNullOrEmpty(ItemType))
                        {
                            if (ItemType == "Finish")
                            {
                                ...
                                || ItemType == "Trading")
                            {
                                #region Insert only DetailTable PurchaseInvoiceMPLDetails

                                PurchaseInvoiceMPLDetailVM pDetVM = new PurchaseInvoiceMPLDetailVM();
                ...
                if (Master.Post.ToLower() == "y")
                {
                    ...
                    if (TrackingWithSale)
                    {
                        ...
                        sqlText = "";
                        sqlText = @"SELECT    
                                    PurchaseInvoiceMPLDetails.PurchaseInvoiceNo,
                                    PurchaseInvoiceMPLDetails.InvoiceDateTime,
                                    PurchaseInvoiceMPLDetails.ReceiveDate,
                                    PurchaseInvoiceMPLDetails.ItemNo, 
                                    isnull(PurchaseInvoiceMPLDetails.BENumber,'N/A')BENumber ,
                                    isnull(PurchaseInvoiceMPLDetails.Quantity,0)Quantity,
                                    isnull(PurchaseInvoiceMPLDetails.UOM,'N/A')UOM ,
                                    isnull(PurchaseInvoiceMPLDetails.VATRate,0)VATRate,
                                    isnull(PurchaseInvoiceMPLDetails.ReturnTransactionType,'')ReturnTransactionType,
                                    isnull(PurchaseInvoiceMPLDetails.ExpireDate,'2100-01-01')ExpireDate,
                                    isnull(PurchaseInvoiceMPLHeaders.CustomHouse,'')CustomHouse
                                    FROM dbo.PurchaseInvoiceMPLDetails 
                                    left outer join PurchaseInvoiceMPLHeaders on PurchaseInvoiceMPLHeaders.PurchaseInvoiceNo=PurchaseInvoiceMPLDetails.PurchaseInvoiceNo
                                    WHERE ";
                        sqlText += @"   (PurchaseInvoiceMPLDetails.PurchaseInvoiceNo = '" + Master.PurchaseInvoiceNo + "')";
                        sqlText += @"  order by PurchaseInvoiceMPLDetails.ItemNo";
                        SqlCommand cmdRIFB = new SqlCommand(sqlText, VcurrConn);
                        cmdRIFB.Transaction = Vtransaction;
                        SqlDataAdapter reportDataAdapt = new SqlDataAdapter(cmdRIFB);
...
select distinct PurchaseInvoiceNo,TDSCode,sum(SubTotal)SubTotal,0,'N' from PurchaseInvoiceMPLDetails
where PurchaseInvoiceNo=@PurchaseInvoiceNo
...
";
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("PurchaseMPLDAL", "PurchaseInsert2", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        public string[] PurchaseUpdate(PurchaseInvoiceMPLHeadersVM Master, List<PurchaseInvoiceMPLDetailVM> Details, List<PurchaseDutiesVM> Duties, List<TrackingVM> Trackings, SysDBInfoVMTemp connVM = null, string UserId = "")
        {
            #region Initializ
            string[] retResults = new string[4];
            retResults[0] = "Fail";
...
select PurchaseInvoiceNo, Post from PurchaseInvoiceMPLHeaders
where 1=1 
...
";
                ...
                bool purchaseSaleTracking =
                    commonDal.settings("Purchase", "PurchaseSaleTracking", currConn, transaction) == "Y";
...
select ItemNo, PurchaseInvoiceNo from PurchaseInvoiceMPLDetails
where 1=1 
and PurchaseInvoiceNo=@InvoiceNo
...
";
                ...
                sqlText = "";
                sqlText = sqlText +
                          "select COUNT(PurchaseInvoiceNo) from PurchaseInvoiceMPLHeaders WHERE PurchaseInvoiceNo=@MasterId ";
                SqlCommand cmdFindIdUpd = new SqlCommand(sqlText, currConn);
                cmdFindIdUpd.Transaction = transaction;
                ...
                List<PurchaseInvoiceMPLDetailVM> previousDetailVMs = SelectPurchaseDetailList(Master.PurchaseInvoiceNo, null, null, currConn, transaction, connVM);
                ...
                PurchaseInvoiceMPLHeadersVM pmVM = SelectAllList(0, cFields, cvals, currConn, transaction, null, connVM).FirstOrDefault();
                ...
                //commonDAL.settingsUpdateMaster("DayEnd", "DayEndProcess", "N", currConn, transaction);
                commonDAL.UpdateProcessFlag(Master.PurchaseInvoiceNo, receiveDate, currConn, transaction);
                ...
                PurchaseInvoiceMPLHeadersVM preMasterVm = new PurchaseInvoiceMPLHeadersVM();
                ...
                sqlText = "";
                sqlText += @" delete FROM PurchaseInvoiceMPLDetails WHERE PurchaseInvoiceNo=@PurchaseInvoiceNo ";
                ...
                sqlText += @" delete FROM PurchaseInvoiceHeaders WHERE PurchaseInvoiceNo=@PurchaseInvoiceNo ";
                ...
                if (PurchaseDetailsDt.Rows.Count > 0)
                {
                    string[] DeleteColumnName =
                {
                  "UnitPrice","ProductName","InvoiceDate","ProductCode", "LineNo", "TankId","TankName", "DIANo", "MT","DutyRemarks","ATAmount","ReturnId","retResults","VATRate2","ReturnId","Total","IsExpireDate","Rowtype"
                };
...
";
                ...
                if (currentPostStatus == "Y" && dtCurrentItems != null && dtCurrentItems.Rows.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        {
                            rVM = _ProductDAL.Product_Stock_Update(paramVM, currConn, transaction, null, UserId);
                        }
                    }
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("PurchaseMPLDAL", "PurchaseUpdate", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        private void UpdateAveragePrice(PurchaseInvoiceMPLHeadersVM Master, SqlConnection currConn, SqlTransaction transaction, CommonDAL commonDal, List<PurchaseInvoiceMPLDetailVM> previousDetailVMs, PurchaseInvoiceMPLHeadersVM preMasterVm, string removeOnPost = "Y", SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                PurchasePostAVGPrice(Master, preMasterVm, previousDetailVMs, currConn, transaction, removeOnPost);

                #endregion


                string value = commonDal.settings("Issue", "DayEndProcessAVGPrice", currConn, transaction);
        ...
        //currConn to VcurrConn 25-Aug-2020
        public string[] PurchasePost(PurchaseInvoiceMPLHeadersVM Master, List<PurchaseInvoiceMPLDetailVM> Details, List<PurchaseDutiesVM> Duties, List<TrackingVM> Trackings, SqlTransaction Vtransaction = null, SqlConnection VcurrConn = null, SysDBInfoVMTemp connVM = null)
        {
            #region Initializ
            string[] retResults = new string[4];
            retResults[0] = "Fail";
            ...
            try
            {
                ...
                sqlText = sqlText +
                          "select COUNT(PurchaseInvoiceNo) from PurchaseInvoiceMPLHeaders WHERE PurchaseInvoiceNo=@MasterPurchaseInvoiceNo";
                ...
                sqlText += @" Update  PurchaseInvoiceMPLDetails     set  Post ='Y',LastModifiedBy =@MasterLastModifiedBy,LastModifiedOn =@MasterLastModifiedOn    WHERE PurchaseInvoiceNo=@MasterSalesInvoiceNo ";
                sqlText += @" Update  PurchaseInvoiceMPLHeaders     set  Post ='Y',LastModifiedBy =@MasterLastModifiedBy,LastModifiedOn =@MasterLastModifiedOn    WHERE PurchaseInvoiceNo=@MasterSalesInvoiceNo ";
...
isnull(PurchaseInvoiceMPLDetails.VATRate,0)VATRate,
isnull(PurchaseInvoiceMPLDetails.ExpireDate,'2100-01-01')ExpireDate,
isnull(PurchaseInvoiceMPLDetails.USDVAT,0) / isnull(PurchaseInvoiceMPLDetails.Quantity,0) VATAmount,
(isnull(PurchaseInvoiceMPLDetails.AssessableValue,0) 
+ isnull(PurchaseInvoiceMPLDetails.CDAmount,0) 
+ isnull(PurchaseInvoiceMPLDetails.RDAmount,0) 
+ isnull(PurchaseInvoiceMPLDetails.SDAmount,0) 
+ isnull(PurchaseInvoiceMPLDetails.TVBAmount,0) ) / isnull(PurchaseInvoiceMPLDetails.Quantity,0)
VATableValue,
isnull(PurchaseInvoiceMPLDetails.ReturnTransactionType,'')ReturnTransactionType,
isnull(PurchaseInvoiceMPLHeaders.CustomHouse,'')CustomHouse
FROM dbo.PurchaseInvoiceMPLDetails 
                                    left outer join PurchaseInvoiceMPLHeaders on PurchaseInvoiceMPLHeaders.PurchaseInvoiceNo=PurchaseInvoiceMPLDetails.PurchaseInvoiceNo
                                    WHERE ";
                    sqlText += @"   (PurchaseInvoiceMPLDetails.PurchaseInvoiceNo = @MasterPurchaseInvoiceNo )";
                    sqlText += @"  order by PurchaseInvoiceMPLDetails.ItemNo";
                ...
                //UpdateAveragePrice(Master, currConn,transaction,commonDal,new List<PurchaseInvoiceMPLDetailVM>(),Master,"N");
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("PurchaseMPLDAL", "PurchasePost", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        private void PurchaseTracking(PurchaseInvoiceMPLHeadersVM Master, SqlConnection currConn, SqlTransaction transaction)
        {
            PurchaseInvoiceMPLHeadersVM purchaseMaster = SelectAllList(0, new[] { "pih.PurchaseInvoiceNo" },
                new[] { Master.PurchaseInvoiceNo }, currConn,
                transaction).FirstOrDefault();
            DataTable purchaseDetail = SelectPurchaseDetail(Master.PurchaseInvoiceNo, null, null, currConn, transaction);
        ...
        private void IssueDayEndProcess(PurchaseInvoiceMPLHeadersVM Master, SqlConnection currConn, SqlTransaction transaction, SysDBInfoVMTemp connVM = null)
        {
            CommonDAL commonDal = new CommonDAL();
            try
            {
        ...
        private void PurchasePostAVGPrice(PurchaseInvoiceMPLHeadersVM Master, PurchaseInvoiceMPLHeadersVM previousMaster,
            List<PurchaseInvoiceMPLDetailVM> previousVms, SqlConnection currConn, SqlTransaction transaction,
            string remove = "N", SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                List<PurchaseInvoiceMPLDetailVM> purchaseVMs = SelectPurchaseDetailList(Master.PurchaseInvoiceNo, null, null, currConn, transaction);
                ...
                string sdInclude = commonDAl.settings("VAT6_1", "TotalIncludeSD", currConn, transaction);

                #endregion

                #region Loop Purchase Detail

                foreach (PurchaseInvoiceMPLDetailVM vm in purchaseVMs)
                {
                    ...
                    PurchaseInvoiceMPLDetailVM previousVM = previousVms.SingleOrDefault(x => x.ItemNo == vm.ItemNo);
                    ...
                    if (remove == "N")
                    {
                        UpdateProductAVGprice(vm.ItemNo, receiveDate, purchaseQty, subTotal, currConn, transaction,
                            previousPurchaseQty, previousSubTotal, previousDate, vm.PurchaseInvoiceNo);
                    }
                    else
                    {
                        RemoveOnUnpost(vm.ItemNo, vm.PurchaseInvoiceNo, vm.ReceiveDate, currConn, transaction);
            ...
            {
                FileLogger.Log("PurchaseMPLDAL", "PurchasePostAVGPrice", ex.ToString(), "Purchase");
...
select PurchaseInvoiceNo, BranchId, Post from PurchaseInvoiceMPLHeaders
where 1=1 
and PurchaseInvoiceNo=@InvoiceNo
...
select ItemNo, PurchaseInvoiceNo, TransactionType, UOMQty * (@MultiplicationFactor) as Quantity, Post from PurchaseInvoiceMPLDetails
where 1=1 
and PurchaseInvoiceNo=@InvoiceNo
...
";
            ...
            {
                FileLogger.Log("PurchaseMPLDAL", "Purchase_Product_IN_OUT", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        public decimal ReturnQty(string purchaseReturnId, string itemNo, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                sqlText = "select Sum(isnull(PurchaseInvoiceMPLDetails.Quantity,0)) from PurchaseInvoiceMPLDetails ";
            ...
            {
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "ReturnQty", ex.ToString() + "\n" + sqlText, "Purchase");
                throw new ArgumentNullException("", ex.Message.ToString());
...
WHERE 1=1";
            ...
            {
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "FindItemIdFromPurchase", ex.ToString() + "\n" + sqlText, "Purchase");
                throw new ArgumentNullException("", ex.Message.ToString());
        ...
        public string[] PurchaseUpdateDuty(DataTable DtDuty, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < DtDuty.Rows.Count; i++)
                {
                    ...
                    ItemNo = cImport.FindItemId(DtDuty.Rows[i]["Item_Name"].ToString().Trim()
                                               , DtDuty.Rows[i]["Item_Code"].ToString().Trim(), currConn, transaction);
                    if (string.IsNullOrEmpty(ItemNo))
                    {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (ImportRaws != null && ImportRaws.Length > 0)
                            {
                                ...
                                duty = DutyCalculation(ImportRaws, currConn, transaction).FirstOrDefault();
                                ...
                                sqlText = @"     update PurchaseInvoiceMPLHeaders set TotalAmount=
                            ...
                            from PurchaseInvoiceDuties 
                            where PurchaseInvoiceMPLHeaders.PurchaseInvoiceNo=PurchaseInvoiceDuties.PurchaseInvoiceNo";
                                ...
                                sqlText = @"   update PurchaseInvoiceMPLDetails set 
                                ...
                                from PurchaseInvoiceDuties 
                                where PurchaseInvoiceMPLDetails.PurchaseInvoiceNo=PurchaseInvoiceDuties.PurchaseInvoiceNo
                                and PurchaseInvoiceMPLDetails.ItemNo=PurchaseInvoiceDuties.ItemNo";
                                sqlText += " and  PurchaseInvoiceDuties.PurchaseInvoiceNo= '" + importID + "' ";
            ...
            catch (Exception ex)
            {
                ...
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "PurchaseUpdateDuty", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        public string[] UpdateTDSAmount(string PurchaseInvoiceNo, decimal TDSAmount, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                sqlText = "";
                sqlText = "update PurchaseInvoiceMPLHeaders set";
            ...
            catch (Exception ex)
            {
                ...
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "UpdateTDSAmount", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        //currConn to VcurrConn 25-Aug-2020
        private void SetBOMId(PurchaseInvoiceMPLHeadersVM vm, List<PurchaseInvoiceMPLDetailVM> detailVMs, SqlConnection VcurrConn, SqlTransaction Vtransaction, SysDBInfoVMTemp connVM = null)
        {
            #region try
            ...
            try
            {
                ...
                foreach (PurchaseInvoiceMPLDetailVM dVM in detailVMs)
                {
                    dt = new DataTable();
            ...
            {
                FileLogger.Log("PurchaseMPLDAL", "SetBOMId", ex.ToString(), "Purchase");
        ...
        public string[] MultiplePost(string[] Ids, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                {
                    PurchaseInvoiceMPLHeadersVM master = SelectAllList(Convert.ToInt32(Ids[i]), null, null, currConn, transaction, null, connVM).FirstOrDefault();
                    List<PurchaseInvoiceMPLDetailVM> Details = SelectPurchaseDetailList(master.PurchaseInvoiceNo, null, null, currConn, transaction, null);
                    List<PurchaseDutiesVM> Duties = SelectAllDuties(master.PurchaseInvoiceNo, null, null, currConn, transaction, null);
                    if (Duties == null)
                    {
            ...
            catch (Exception ex)
            {
                ...
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "MultiplePost", ex.ToString(), "Purchase");
        ...
        public string[] PurchaseInsertToMaster(PurchaseInvoiceMPLHeadersVM Master, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                sqlText = "";
                sqlText += " insert into PurchaseInvoiceMPLHeaders";
                sqlText += " (";
                sqlText += " PurchaseInvoiceNo,";
                sqlText += " VendorID,";
                sqlText += " CustomHouse,";
                ...
                sqlText += " IsRebate,";
                sqlText += " IsRebateHold,";
                sqlText += " RegNo,";
                sqlText += " BondNo,";
                sqlText += " ProcessingFee,";
                sqlText += " VesselName,";
                ...
                cmdInsert.Parameters.AddWithValueAndNullHandle("@IsRebateHold", Master.IsRebateHold);
                cmdInsert.Parameters.AddWithValueAndNullHandle("@RegNo", Master.RegNo);
                cmdInsert.Parameters.AddWithValueAndNullHandle("@BondNo", Master.BondNo);
                cmdInsert.Parameters.AddWithValueAndNullHandle("@ProcessingFee", Master.ProcessingFee);
                cmdInsert.Parameters.AddWithValueAndNullHandle("@VesselName", Master.VesselName);
            ...
            catch (Exception ex)
            {
                ...
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "PurchaseInsertToMaster", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        public string[] PurchaseInsertToDetail(PurchaseInvoiceMPLDetailVM Detail, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                sqlText = "";
                sqlText += " insert into PurchaseInvoiceMPLDetails(";
                ...
                cmdInsDetail.Parameters.AddWithValueAndNullHandle("@IsRebateHold", Detail.IsRebateHold);
                ...
                cmdInsDetail.Parameters.AddWithValueAndNullHandle("@TankId", Detail.TankId);
                cmdInsDetail.Parameters.AddWithValueAndNullHandle("@DIANo", Detail.DIANo);
                cmdInsDetail.Parameters.AddWithValueAndNullHandle("@MT", Detail.MT);
            ...
            catch (Exception ex)
            {
                ...
                //2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "PurchaseInsertToDetail", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        public string[] PurchaseUpdateToMaster(PurchaseInvoiceMPLHeadersVM Master, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                sqlText += " ,IsRebateHold     =@IsRebateHold";
                ...
                sqlText += " ,RegNo       =@RegNo";
                sqlText += " ,BondNo       =@BondNo";
                sqlText += " ,VesselName       =@VesselName";
                sqlText += " ,ProcessingFee       =@ProcessingFee";
                ...
                cmdUpdate.Parameters.AddWithValueAndNullHandle("@IsRebateHold", Master.IsRebateHold);
                ...
                cmdUpdate.Parameters.AddWithValueAndNullHandle("@RegNo", Master.RegNo);
                cmdUpdate.Parameters.AddWithValueAndNullHandle("@BondNo", Master.BondNo);
                cmdUpdate.Parameters.AddWithValueAndNullHandle("@VesselName", Master.VesselName);
                cmdUpdate.Parameters.AddWithValueAndNullHandle("@ProcessingFee", Master.ProcessingFee);
            ...
            catch (Exception ex)
            {
                ...
                //////2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "PurchaseUpdateToMaster", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        public string[] PurchaseInsertToDuties(PurchaseDutiesVM Duty, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, SysDBInfoVMTemp connVM = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                ////2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "PurchaseInsertToDuties", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        public string[] PurchaseAllPost(PostVM Master, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, SysDBInfoVMTemp connVM = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                ////2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "PurchaseAllPost", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        public string[] ImportData(DataTable dtPurchaseM, DataTable dtPurchaseD, DataTable dtPurchaseI, DataTable dtPurchaseT, int branchId = 0, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, Action callBack = null, SysDBInfoVMTemp connVM = null, string UserId = "")
        {
            ...
            PurchaseInvoiceMPLHeadersVM purchaseMaster;
            List<PurchaseDutiesVM> purchaseDuties = new List<PurchaseDutiesVM>();
            List<PurchaseInvoiceMPLDetailVM> purchaseDetails = new List<PurchaseInvoiceMPLDetailVM>();
            ...
            try
            {
                ...
                bool uomDefault = commonDal.settings("Purchase", "AutoUOM", currConn, transaction) == "Y";
                ...
                string dayEnd = commonDal.settings("Issue", "DayEndProcessAVGPrice", currConn, transaction);
                ...
                for (int i = 0; i < rowCount; i++)
                {
                    ...
                    cImport.FindVendorId(dtPurchaseM.Rows[i]["Vendor_Name"].ToString().Trim(),
                                           dtPurchaseM.Rows[i]["Vendor_Code"].ToString().Trim(), currConn, transaction, VendorAutoSave);
                ...
                for (int j = 0; j < DRowCount; j++)
                {
                    ...
                    ItemNo = cImport.FindItemId(dtPurchaseD.Rows[j]["Item_Name"].ToString().Trim()
                                 , dtPurchaseD.Rows[j]["Item_Code"].ToString().Trim(), currConn, transaction, ItemAutoSave, dtPurchaseD.Rows[j]["UOM"].ToString().Trim(), 1, 0, 0, null, dtPurchaseD.Rows[j]["Product_Group"].ToString().Trim());
                    #endregion FindItemId
                    ...
                    if (DatabaseInfoVM.DatabaseName.ToString() != "Sanofi_DB")
                    {
                        if (!uomDefault)
                        {
                            cImport.FindUOMc(UOMn, dtPurchaseD.Rows[j]["UOM"].ToString().Trim(), currConn, transaction, null, ItemNo, dtPurchaseD.Rows[j]["Item_Name"].ToString().Trim(), dtPurchaseD.Rows[j]["Item_Code"].ToString().Trim());
                        }
                    }
                     ...
                     || dtPurchaseM.Rows[0]["Transection_Type"].ToString() == "ServiceNSImport")
                {
                    ...
                    for (int e = 0; e < IRowCount; e++)
                    {
                        ...
                        ItemNo = cImport.FindItemId(dtPurchaseI.Rows[e]["Item_Name"].ToString().Trim()
                                                            , dtPurchaseI.Rows[e]["Item_Code"].ToString().Trim(), currConn, transaction, ItemAutoSave);
                        #endregion FindItemId
                ...
                for (int i = 0; i < rowCount; i++)
                {
                    ...
                    {
                        vendorId = cImport.FindVendorId(vendorName, vendorCode, currConn, transaction, VendorAutoSave, null, branchId);
                    }
                    #endregion FindVendorId
                    ...
                    #region Master Purchase
                    purchaseMaster = new PurchaseInvoiceMPLHeadersVM();
                    ...
                    // 
                    purchaseDetails = new List<PurchaseInvoiceMPLDetailVM>();
                    ...
                    foreach (DataRow item in dtDistinctItem.Rows)
                    {
                        ...
                        {
                            itemNo = cImport.FindItemId(itemName, itemCode, currConn, transaction, ProductAutoSave, item["UOM"].ToString().Trim());
                        ...
                        PurchaseInvoiceMPLDetailVM PurchaseInvoiceMPLDetailVM = new PurchaseInvoiceMPLDetailVM();

                        PurchaseInvoiceMPLDetailVM.LineNo = Dcounter.ToString();
                        PurchaseInvoiceMPLDetailVM.ItemNo = itemNo.ToString();
                        PurchaseInvoiceMPLDetailVM.Quantity = Convert.ToDecimal(quantity.ToString());

                        PurchaseInvoiceMPLDetailVM.UOM = uOM.ToString();
                        PurchaseInvoiceMPLDetailVM.Comments = "NA";
                        PurchaseInvoiceMPLDetailVM.BENumber = bENumber.ToString();
                        PurchaseInvoiceMPLDetailVM.Type = type.ToString();
                        PurchaseInvoiceMPLDetailVM.HSCode = HSCode.ToString();
                        PurchaseInvoiceMPLDetailVM.BEItemNo = BEItemNo.ToString();
                        PurchaseInvoiceMPLDetailVM.CPCName = CPCName.ToString();
                        PurchaseInvoiceMPLDetailVM.ProductType = "NA";
                        PurchaseInvoiceMPLDetailVM.FixedVATRebate = FixedVATRebate;
                        PurchaseInvoiceMPLDetailVM.UOMn = uOMn.ToString();
                        PurchaseInvoiceMPLDetailVM.UOMc = Convert.ToDecimal(uOMc.ToString());
                        PurchaseInvoiceMPLDetailVM.SubTotal = Convert.ToDecimal(totalPrice);
                        decimal unitPrice = Convert.ToDecimal(Convert.ToDecimal(totalPrice.ToString()) / Convert.ToDecimal(quantity.ToString()));
                        PurchaseInvoiceMPLDetailVM.UnitPrice = unitPrice;
                        PurchaseInvoiceMPLDetailVM.NBRPrice = unitPrice;
                        PurchaseInvoiceMPLDetailVM.UOMPrice = Convert.ToDecimal(unitPrice) / Convert.ToDecimal(uOMc);
                        PurchaseInvoiceMPLDetailVM.UOMQty = Convert.ToDecimal(quantity) * Convert.ToDecimal(uOMc);
                        PurchaseInvoiceMPLDetailVM.VATAmount = Convert.ToDecimal(vATAmount);
                        PurchaseInvoiceMPLDetailVM.FixedVATAmount = Convert.ToDecimal(vATAmount);
                        PurchaseInvoiceMPLDetailVM.SDAmount = Convert.ToDecimal(sDAmount);
                        PurchaseInvoiceMPLDetailVM.RebateRate = Convert.ToDecimal(rebateRate.ToString());
                        PurchaseInvoiceMPLDetailVM.RebateAmount =
                            Convert.ToDecimal(Convert.ToDecimal(vATAmount) * Convert.ToDecimal(rebateRate.ToString()) / 100);
                        if (Productype == "P")
                        {
                            PurchaseInvoiceMPLDetailVM.VATRate = 0;
                            PurchaseInvoiceMPLDetailVM.SD = 0;
                        }
                        else
                        {
                            PurchaseInvoiceMPLDetailVM.VATRate = Convert.ToDecimal(Convert.ToDecimal(vATAmount) * 100 / Convert.ToDecimal(totalPrice));
                            PurchaseInvoiceMPLDetailVM.SD = Convert.ToDecimal(Convert.ToDecimal(sDAmount) * 100 / Convert.ToDecimal(totalPrice));
                        }
                        PurchaseInvoiceMPLDetailVM.BOMId = !string.IsNullOrEmpty(item["BomId"].ToString())
                            ? Convert.ToInt32(item["BomId"].ToString())
                            : 0;

                        PurchaseInvoiceMPLDetailVM.USDValue = USDValue;
                        if (Productype == "R" || Productype == "P")
                        {
                            PurchaseInvoiceMPLDetailVM.ProductType = Productype;
                        }
                        else
                        {
                            PurchaseInvoiceMPLDetailVM.ProductType = productType;
                        }
                        PurchaseInvoiceMPLDetailVM.Post = purchaseMaster.Post;

                        if (purchaseMaster.WithVDS.ToLower() == "y")
                        {
                            PurchaseInvoiceMPLDetailVM.VDSAmount = PurchaseInvoiceMPLDetailVM.VATAmount;
                        }
                        ...
                        if (dtPurchaseI.Rows.Count > 0)
                        {
                            ...
                            if (ImportRaws != null && ImportRaws.Length > 0)
                            {
                                ...
                                {
                                    List<PurchaseDutiesVM> calculatedDuties = DutyCalculation(ImportRaws, currConn, transaction);
                        ...
                        if (purchaseDuties.Count > 0)
                        {
                            ...
                            for (int dutyRow = 0; dutyRow < purchaseDuties.Count; dutyRow++)
                            {
                                ...
                                {
                                    PurchaseInvoiceMPLDetailVM.CnFAmount = purchaseDuties[dutyRow].CnFAmount;
                                    PurchaseInvoiceMPLDetailVM.InsuranceAmount = purchaseDuties[dutyRow].InsuranceAmount;
                                    PurchaseInvoiceMPLDetailVM.AssessableValue = purchaseDuties[dutyRow].AssessableValue;
                                    PurchaseInvoiceMPLDetailVM.CDAmount = purchaseDuties[dutyRow].CDAmount;
                                    PurchaseInvoiceMPLDetailVM.RDAmount = purchaseDuties[dutyRow].RDAmount;
                                    PurchaseInvoiceMPLDetailVM.TVBAmount = purchaseDuties[dutyRow].TVBAmount;
                                    PurchaseInvoiceMPLDetailVM.TVAAmount = purchaseDuties[dutyRow].TVAAmount;
                                    PurchaseInvoiceMPLDetailVM.ATVAmount = purchaseDuties[dutyRow].ATVAmount;
                                    PurchaseInvoiceMPLDetailVM.OthersAmount = purchaseDuties[dutyRow].OthersAmount;
                                    PurchaseInvoiceMPLDetailVM.AITAmount = purchaseDuties[dutyRow].AITAmount;
                        ...
                        else
                        {
                            ...
                            PurchaseInvoiceMPLDetailVM.CnFAmount = Convert.ToDecimal(0);
                            PurchaseInvoiceMPLDetailVM.InsuranceAmount = Convert.ToDecimal(0);
                            PurchaseInvoiceMPLDetailVM.AssessableValue = Convert.ToDecimal(0);
                            PurchaseInvoiceMPLDetailVM.CDAmount = Convert.ToDecimal(0);
                            PurchaseInvoiceMPLDetailVM.RDAmount = Convert.ToDecimal(0);
                            PurchaseInvoiceMPLDetailVM.TVBAmount = Convert.ToDecimal(0);
                            PurchaseInvoiceMPLDetailVM.TVAAmount = Convert.ToDecimal(0);
                            PurchaseInvoiceMPLDetailVM.ATVAmount = Convert.ToDecimal(0);
                            PurchaseInvoiceMPLDetailVM.OthersAmount = Convert.ToDecimal(0);
                        }

                        #endregion details
                        PurchaseInvoiceMPLDetailVM.BranchId = branchId;
                        PurchaseInvoiceMPLDetailVM.OtherRef = OtherRef;

                        purchaseDetails.Add(PurchaseInvoiceMPLDetailVM);
                    ...
                    if (TrackingRaws != null && TrackingRaws.Length > 0)
                    {
                        ...
                        foreach (DataRow row in TrackingRaws)
                        {
                            ...
                            string itemName = row["Item_Name"].ToString().Trim();
                            bool ProductAutoSave = Convert.ToBoolean(commonDal.settingValue("AutoSave", "PurchaseProduct") == "Y" ? true : false);
                            string itemNo = cImport.FindItemId(itemName, itemCode, currConn, transaction, ProductAutoSave);
                            ...
                            foreach (DataRow row1 in DetailRaws)
                            {
                                ...
                                string itemNo1 = cImport.FindItemId(itemName1, itemCode1, currConn, transaction, ProductAutoSave);
            ...
            catch (Exception ex)
            {
                ...
                ////2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "ImportData", ex.ToString(), "Purchase");
        ...
        public int GetUnProcessedCount(SysDBInfoVMTemp connVM = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                ////2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "GetUnProcessedCount", ex.ToString(), "Purchase");
                throw new ArgumentNullException("", ex.Message.ToString());
...
update PurchasesTempData set VendorID=Vendors.VendorID from Vendors where Vendors.VendorName =PurchasesTempData.Vendor_Name;";
                ...
                retResults = commonDal.BulkInsert("PurchasesTempData", PurchaseData, currConn, transaction);
                ...
                foreach (DataRow row in defaultData.Rows)
                {
                    if (row["VendorID"].ToString().Trim() == "0")
                    {
                        ...
                        commonImportDal.FindVendorId(vendorName, vendorCode, currConn, transaction, true);
                    }
                    ...
                    if (row["ItemNo"].ToString().Trim() == "0")
                    {
                        ...
                        commonImportDal.FindItemId(itemName, itemCode, currConn, transaction, true);
                    }
                }
            ...
            catch (Exception ex)
            {
                ...
                ////2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "ImportBigData", ex.ToString(), "Purchase");
                throw new ArgumentNullException("", ex.Message.ToString());
...
TempPurchaseData 
join PurchaseInvoiceMPLHeaders on TempPurchaseData.ID = PurchaseInvoiceMPLHeaders.ImportIDExcel";

                string selectDuplicate = @"select distinct TempPurchaseData.ID,PurchaseInvoiceMPLHeaders.PurchaseInvoiceNO from 
TempPurchaseData join PurchaseInvoiceMPLHeaders on TempPurchaseData.ID = PurchaseInvoiceMPLHeaders.ImportIDExcel";
                ...
                if (!IsExcel)
                {
                    if (CompanyCode == "CP" || OrdinaryVATDesktop.IsACICompany(CompanyCode) || OrdinaryVATDesktop.IsUnileverCompany(CompanyCode) || CompanyCode.ToLower() == "nestle" || CompanyCode.ToLower() == "smc"
                        ...
                        || OrdinaryVATDesktop.IsNourishCompany(CompanyCode))
                    {
...
";
            ...
            catch (Exception ex)
            {
                ...
                ////2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "SaveTempPurchase", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        public string[] SaveToPurchaseTemp(DataTable data, string UserId, int branchId, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                string[] bulkRes = commonDal.BulkInsert("TempPurchaseData", data, currConn, transaction);
...
and BOMRaws.effectdate<= cast(TempPurchaseData.Invoice_Date as datetime) and BOMRaws.post='Y';";
        ...
        private string[] SavePurchase(DataTable dtTableResult, string BranchCode, string transactionType, string CurrentUser, int branchId, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, Action callBack = null, SysDBInfoVMTemp connVM = null, string UserId = "")
        {
            ...
            catch (Exception ex)
            {
                ...
                retResults[1] = ex.Message;
                ////2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "SavePurchase", ex.ToString(), "Purchase");
...
FROM [PurchaseInvoiceMPLHeaders] pih left outer join PurchaseInvoiceMPLDetails pid
...
left outer join ProductCategories pdc on pdc.CategoryID = pd.CategoryID 
  ...
  where pih.PurchaseInvoiceNo in ('";
            ...
            catch (Exception ex)
            {
                ...
                ////2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "GetExcelData", ex.ToString() + "\n" + sqlText, "Purchase");
...
left outer join ProductCategories pdc on pdc.CategoryID = pd.CategoryID 
  ...
  where pih.Id in (";
            ...
            catch (Exception ex)
            {
                ...
                ////2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "GetExcelDataWeb", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        public string[] PurchaseUpdateToDetail(PurchaseInvoiceMPLDetailVM Detail, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                cmdUpdate.Parameters.AddWithValueAndNullHandle("@TankId", Detail.TankId);
            ...
            catch (Exception ex)
            {
                ...
                ////2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "PurchaseUpdateToDetail", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        public string[] PurchaseUpdateToDuties(PurchaseDutiesVM Duty, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, SysDBInfoVMTemp connVM = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                ////2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "PurchaseUpdateToDuties", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        public string[] PurchaseUpdateX(PurchaseInvoiceMPLHeadersVM Master, List<PurchaseInvoiceMPLDetailVM> Details, List<PurchaseDutiesVM> Duties, List<TrackingVM> Trackings, SysDBInfoVMTemp connVM = null)
        {
            #region Initializ
            string vProductType = "";
            string[] retResults = new string[4];
            ...
            try
            {
                ...
                foreach (PurchaseInvoiceMPLDetailVM Item in Details.ToList())
                {
                    ...
                    PurchaseInvoiceMPLDetailVM pdVm = new PurchaseInvoiceMPLDetailVM();
                    ...
                    if (Master.TransactionType == "TollReceive")
                    {
                        ...
                        if (!string.IsNullOrEmpty(ItemType))
                        {
                           ...
                           || ItemType == "Trading")
                            {
                                #region Insert only DetailTable PurchaseInvoiceMPLDetails
                                pdVm = new PurchaseInvoiceMPLDetailVM();
        ...
        //currConn to VcurrConn 25-Aug-2020
        public string[] PurchaseInsertX(PurchaseInvoiceMPLHeadersVM Master, List<PurchaseInvoiceMPLDetailVM> Details, List<PurchaseDutiesVM> Duties, List<TrackingVM> Trackings,
            SqlTransaction Vtransaction, SqlConnection VcurrConn, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                {
                    newIDCreate = commonDal.TransactionCode("Purchase", "Other", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), VcurrConn, Vtransaction);
                }

                else if (Master.TransactionType == "PurchaseDN")
                {
                    newIDCreate = commonDal.TransactionCode("Purchase", "PurchaseDN", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), VcurrConn, Vtransaction);
                }
                else if (Master.TransactionType == "PurchaseCN")
                {
                    newIDCreate = commonDal.TransactionCode("Purchase", "PurchaseCN", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), VcurrConn, Vtransaction);
                }

                else if (Master.TransactionType == "Trading") //s
                {
                    newIDCreate = commonDal.TransactionCode("Purchase", "Trading", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), VcurrConn, Vtransaction);
                }

                else if (Master.TransactionType == "TollReceive")
                {
                    newIDCreate = commonDal.TransactionCode("TollReceive", "TollReceive", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                             "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), VcurrConn, Vtransaction);
                }
                    ...
                    || Master.TransactionType == "InputServiceImport")
                {
                    newIDCreate = commonDal.TransactionCode("Purchase", "Import", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), VcurrConn, Vtransaction);
                }
                else if (Master.TransactionType == "InputService")
                {
                    newIDCreate = commonDal.TransactionCode("Purchase", "InputService", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), VcurrConn, Vtransaction);
                }
                else if (Master.TransactionType == "TollReceiveRaw")
                {
                    newIDCreate = commonDal.TransactionCode("TollReceiveRaw", "TollReceiveRaw", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), VcurrConn, Vtransaction);
                }
                else if (Master.TransactionType == "PurchaseReturn")
                {
                    newIDCreate = commonDal.TransactionCode("Purchase", "PurchaseReturn", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), VcurrConn, Vtransaction);
                }
                else if (Master.TransactionType == "Service")
                {
                    newIDCreate = commonDal.TransactionCode("Purchase", "Service", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), VcurrConn, Vtransaction);
                }
                else if (Master.TransactionType == "ServiceNS")
                {
                    newIDCreate = commonDal.TransactionCode("Purchase", "ServiceNS", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), VcurrConn, Vtransaction);
                }
                else if (Master.TransactionType == "CommercialImporter")
                {
                    newIDCreate = commonDal.TransactionCode("Purchase", "CommercialImporter", "PurchaseInvoiceMPLHeaders", "PurchaseInvoiceNo",
                                              "ReceiveDate", Master.ReceiveDate, Master.BranchId.ToString(), VcurrConn, Vtransaction);
                }
                ...
                foreach (PurchaseInvoiceMPLDetailVM Item in Details.ToList())
                {
                    ...
                    sqlText = "";
                    sqlText +=
                        "select COUNT(PurchaseInvoiceNo) from PurchaseInvoiceMPLDetails WHERE PurchaseInvoiceNo='" +
        ...
        //currConn to VcurrConn 25-Aug-2020
        public string[] PurchasePostX(PurchaseInvoiceMPLHeadersVM Master, List<PurchaseInvoiceMPLDetailVM> Details, List<PurchaseDutiesVM> Duties, List<TrackingVM> Trackings,
            SqlTransaction Vtransaction = null, SqlConnection VcurrConn = null, SysDBInfoVMTemp connVM = null)
        {
            ...
            || Master.TransactionType == "InputServiceImport")
                ...
                foreach (PurchaseInvoiceMPLDetailVM Item in Details.ToList())
                {
                    ...
                    sqlText +=
                        "select COUNT(PurchaseInvoiceNo) from PurchaseInvoiceMPLDetails WHERE PurchaseInvoiceNo=@MasterPurchaseInvoiceNo";
                    ...
                    else
                    {
                        ...
                        sqlText = "";
                        sqlText += "select isnull(Quantity ,0) from PurchaseInvoiceMPLDetails ";
...
FROM dbo.PurchaseInvoiceMPLDetails 
                ...
                sqlText = sqlText + " select distinct Post from PurchaseInvoiceMPLHeaders WHERE PurchaseInvoiceNo=@MasterPurchaseInvoiceNo";
...
delete from VAT_Source_Purchase where ID in (
                select pr.ID from VAT_Source_Purchase pr inner join PurchaseInvoiceMPLHeaders ph
...
where isnull(IsProcessed,'N') = 'N'";
  ...
  FROM VAT_Source_Purchase where ID in (select ID from #tempIds)";
            ...
            catch (Exception ex)
            {
                ...
                ////2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "SavePurchase_Split", ex.ToString() + "\n" + sqlText, "Purchase");
...
where ItemNo in (Select distinct ItemNo from ProductAvgPrice)";
            ...
            catch (Exception ex)
            {
                ...
                ////2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "UpdateIntialAvgPrice", ex.ToString() + "\n" + sqlText, "Purchase");
...
";
            ...
            catch (Exception ex)
            {
                ...
                ////2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "UpdateProductAVGprice", ex.ToString() + "\n" + sqlText, "Purchase");
            ...
            SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, SysDBInfoVMTemp connVM = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                ////2020-12-13
                FileLogger.Log("PurchaseMPLDAL", "RemoveOnUnpost", ex.ToString() + "\n" + sqlText, "Purchase");
...
";
            ...
            catch (Exception ex)
            {
                ...
                ////2020-12-14
                FileLogger.Log("PurchaseMPLDAL", "GetAvgPrice", ex.ToString() + "\n" + sqlText, "Purchase");
...
";
        ...
        public TDSCalcVM TDSCalculation(TDSCalcVM paramVM, SysDBInfoVMTemp connVM = null)
        {
            ...
            {
                FileLogger.Log("PurchaseMPLDAL", "TDSCalculation", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        public DataTable SelectAll_Specific(PurchaseInvoiceMPLHeadersVM vm, string[] conditionFields = null, string[] conditionValues = null, string[] specificColumns = null
            , SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, SysDBInfoVMTemp connVM = null)
        {
            ...
            {
                FileLogger.Log("PurchaseMPLDAL", "SelectAll_Specific", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        public ResultVM MultipleUpdate(PurchaseInvoiceMPLHeadersVM paramVM, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, SysDBInfoVMTemp connVM = null)
        {
            #region Declarations
            ...
            try
            {
                ...
                if (paramVM != null && paramVM.IDs != null && paramVM.IDs.Count > 0)
                {
                    ...
                    {
                        PurchaseInvoiceMPLHeadersVM MasterVM = new PurchaseInvoiceMPLHeadersVM();
                        List<PurchaseInvoiceMPLDetailVM> DetailVMs = new List<PurchaseInvoiceMPLDetailVM>();
                        List<PurchaseDutiesVM> purchaseDuties = new List<PurchaseDutiesVM>();

                        MasterVM = SelectAllList(0, new[] { "pih.PurchaseInvoiceNo" }, new[] { ID }, currConn, transaction).FirstOrDefault();
                        DetailVMs = SelectPurchaseDetailList(ID, null, null, currConn, transaction);
                        purchaseDuties = GetDutyList(SearchPurchaseDutyDTNew(ID), paramVM.BranchId, DetailVMs);  // Change 04
                        List<TrackingVM> purchaseTrackings = GetTrackings(DetailVMs, ID);

                        string[] result = new string[] { };

                        result = PurchaseUpdate(MasterVM, DetailVMs, purchaseDuties, purchaseTrackings, null, paramVM.CurrentUserId);
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("PurchaseMPLDAL", "MultipleUpdate", ex.ToString(), "Purchase");
        ...
        private List<TrackingVM> GetTrackings(List<PurchaseInvoiceMPLDetailVM> DetailVMs, string ID, SysDBInfoVMTemp connVM = null)
        {
            List<TrackingVM> purchaseTrackings = new List<TrackingVM>();

            foreach (PurchaseInvoiceMPLDetailVM PurchaseInvoiceMPLDetailVM in DetailVMs)
            {
                DataTable trackingInfoDt = SearchPurchaseInvoiceTracking(ID, PurchaseInvoiceMPLDetailVM.ItemNo);
        ...
        public List<TrackingVM> GetTrackingsWeb(List<PurchaseInvoiceMPLDetailVM> DetailVMs, string ID, SysDBInfoVMTemp connVM = null)
        {
            List<TrackingVM> purchaseTrackings = new List<TrackingVM>();
        ...
        private List<PurchaseDutiesVM> GetDutyList(DataTable table, int branchId, List<PurchaseInvoiceMPLDetailVM> vms, SysDBInfoVMTemp connVM = null)
        {
            ...
            foreach (DataRow tableRow in table.Rows)
            {
                ...
                PurchaseInvoiceMPLDetailVM vm = vms.SingleOrDefault(x => x.ItemNo == strItemNo);
        ...
        public ResultVM MultiplePost(PurchaseInvoiceMPLHeadersVM paramVM, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, SysDBInfoVMTemp connVM = null, string UserId = "")
        {
            #region Declarations
            ...
            try
            {
                ...
                if (paramVM != null && paramVM.IDs != null && paramVM.IDs.Count > 0)
                {
                    foreach (string ID in paramVM.IDs)
                    {
                        ...
                        result = PurchasePost(MasterVM, null, null, null, transaction, currConn);
        ...
        public ExcelPackage SaveExcel(DataSet ds, string ReportType = "", SysDBInfoVMTemp connVM = null, string InvoiceDateFrom = "", string InvoiceDateTo = "")
        {
            ...
            dt = dataView.ToTable(true, "PurchaseInvoiceNo", "LCNumber", "LCDate", "BENumber", "InvoiceDateTime", "VendorName", "Address1", "VATRegistrationNo", "ProductCode", "ProductName", "Quantity", "UOM", "AssessableValue", "CDAmount", "RDAmount", "SDAmount", "VATAmount", "Total");
        ...
        public string[] SaveSMCPurchase(DataTable data, Action callBack = null, int branchId = 1, string app = "", SysDBInfoVMTemp connVM = null, IntegrationParam paramVM = null, SqlConnection vConnection = null, SqlTransaction vTransaction = null, string UserId = "")
        {
            ...
            try
            {
                ...
                cmd.ExecuteNonQuery();
                result = commonDal.BulkInsert("SMC_PurchaseData", data, connection, transaction);
...
union all
 ...
 SELECT 
  ...
  ";
                ...
                PurchaseMPLDAL PurchaseMPLDAL = new PurchaseMPLDAL();
                paramVM.TransactionType = "other";
                string[] results = PurchaseMPLDAL.SaveTempPurchase(table, paramVM.BranchCode, paramVM.TransactionType,
                    paramVM.CurrentUser,
                    branchId, () => { }, connection, transaction, null, UserId, true);
            ...
            catch (Exception e)
            {
                ...
                FileLogger.Log("PurchaseMPLDAL", "SaveAndProcess", e.ToString(), "Purchase");
        ...
        private void CheckHSCodeValidity(PurchaseInvoiceMPLHeadersVM Master, List<PurchaseInvoiceMPLDetailVM> Details, SqlConnection currConn,
            SqlTransaction transaction)
        {
            ...
            foreach (PurchaseInvoiceMPLDetailVM PurchaseInvoiceMPLDetailVM in Details)
            {
                ...
                hsCodeCommand.Parameters.AddWithValueAndParamCheck("@vat", PurchaseInvoiceMPLDetailVM.VATRate);
                hsCodeCommand.Parameters.AddWithValueAndParamCheck("@hscode", PurchaseInvoiceMPLDetailVM.HSCode);
                hsCodeCommand.Parameters.AddWithValueAndParamCheck("@sd", PurchaseInvoiceMPLDetailVM.SD);

                var count = Convert.ToInt32(hsCodeCommand.ExecuteScalar());

                if (count == 0)
                {
                    throw new Exception("Item Name: " + PurchaseInvoiceMPLDetailVM.ProductName + "\n HS Code:" +
                                        PurchaseInvoiceMPLDetailVM.HSCode +
...
left outer join PurchaseInvoiceMPLHeaders h on r.PurchaseInvoiceNo=h.PurchaseInvoiceNo
...
where 1=1
  ...
  ";
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("PurchaseMPLDAL", "GetPurchaseTrakingExcelData", ex.ToString() + "\n" + sqlText, "Purchase");
...
from PurchaseTrackingRecord pr
   left outer join PurchaseInvoiceMPLHeaders pur on  pr.PurchaseHeaderId=pur.Id
   left outer join PurchaseInvoiceMPLDetails pd on  pr.PurchaseInvoiceNo=pd.PurchaseInvoiceNo
...
order by pr.PurchaseInvoiceNo,pr.ReceiveDate,pr.ItemNo
  ";
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("PurchaseMPLDAL", "MISStockReport", ex.ToString() + "\n" + sqlText, "Purchase");
  ...
  where PurchaseInvoiceNo in ('";
        ...
        public string[] ImportPurchaseTDS(List<PurchaseTDSsVM> Details, SqlTransaction Vtransaction, SqlConnection VcurrConn, SysDBInfoVMTemp connVM = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("PurchaseMPLDAL", "ImportPurchaseTDS", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        public string[] InsertToPurchaseTDS(PurchaseTDSsVM TDSvm, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, SysDBInfoVMTemp connVM = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("PurchaseMPLDAL", "InsertToPurchaseTDS", ex.ToString() + "\n" + sqlText, "Purchase");
        ...
        public string[] UpdateToPurchaseTDS(PurchaseTDSsVM TDSvm, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, SysDBInfoVMTemp connVM = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("PurchaseMPLDAL", "UpdateToPurchaseTDS", ex.ToString() + "\n" + sqlText, "Purchase");
            }
            finally
            {
                if (VcurrConn == null)
        ...
        public string[] HSCodeUpdatePurchase(string PeriodName, SysDBInfoVMTemp connVM = null)
        {
            ...
            try
            {
                ...
                var updateHSCode = @"update PurchaseInvoiceMPLDetails  set HSCode=Products.HSCodeNo from PurchaseInvoiceMPLDetails 
                                      inner join Products on Products.ItemNo =PurchaseInvoiceMPLDetails.ItemNo 
                                      and (PurchaseInvoiceMPLDetails.HSCode is null or LEN(PurchaseInvoiceMPLDetails.HSCode)<5) and PeriodID=@PeriodName";
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("PurchaseMPLDAL", "HSCodeUpdatePurchase", ex.ToString(), "Purchase");
                throw new ArgumentNullException("", ex.Message.ToString());
...
FROM PurchaseInvoiceMPLHeaders pih 
...
";
            ...
            catch (Exception ex)
            {
                ...
                FileLogger.Log("PurchaseMPLDAL", "SelectAllForAPI", ex.ToString() + "\n" + sqlText, "Purchase");
                throw new ArgumentNullException("", ex.Message.ToString());
